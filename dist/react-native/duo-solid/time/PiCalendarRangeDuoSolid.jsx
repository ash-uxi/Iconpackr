...
/**
 * Picalendarrangeduosolid icon component for React Native
...
const Picalendarrangeduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M20.96 10H3.04m3.97 4H7m9.01 4H16m1-4h-6m1 4H8M8 2v4m8-4v4" />
  </Svg>
);

export default Picalendarrangeduosolid;
