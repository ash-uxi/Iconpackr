...
/**
 * PiFileTextStroke icon from the stroke style in files-&-folders category.
 */
interface PiFileTextStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileTextStroke({
  size = 24,
  color,
  className,
