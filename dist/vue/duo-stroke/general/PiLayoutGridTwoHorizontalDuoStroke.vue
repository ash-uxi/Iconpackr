 ...
 */
export default {
  name: 'PiLayoutGridTwoHorizontalDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'layout-grid-two-horizontal icon'
    }
  }
}
</script>
