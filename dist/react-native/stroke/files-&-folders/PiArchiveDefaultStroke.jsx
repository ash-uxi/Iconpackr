...
/**
 * Piarchivedefaultstroke icon component for React Native
...
const Piarchivedefaultstroke = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M10 12H14" stroke={color} strokeWidth="2" fill="none" />
    <path
...
export default Piarchivedefaultstroke;
