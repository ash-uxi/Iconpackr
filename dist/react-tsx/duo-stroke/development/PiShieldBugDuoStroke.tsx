...
/**
 * PiShieldBugDuoStroke icon from the duo-stroke style in development category.
 */
interface PiShieldBugDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiShieldBugDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'shield-bug icon',
  ...props
}: PiShieldBugDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
