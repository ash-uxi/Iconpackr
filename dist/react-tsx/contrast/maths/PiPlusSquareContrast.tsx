...
/**
 * PiPlusSquareContrast icon from the contrast style in maths category.
 */
interface PiPlusSquareContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlusSquareContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'plus-square icon',
  ...props
}: PiPlusSquareContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
