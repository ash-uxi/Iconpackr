 ...
 */
interface PiMapLocationStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMapLocationStroke({
  ...
  ...props
}: PiMapLocationStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
