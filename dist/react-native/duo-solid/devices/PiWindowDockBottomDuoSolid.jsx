...
/**
 * Piwindowdockbottomduosolid icon component for React Native
 ...
 */
const Piwindowdockbottomduosolid = ({
  color = "#000",
  size = 24,
...
export default Piwindowdockbottomduosolid;
