 ...
 */
interface PiWindowPictureInPictureContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWindowPictureInPictureContrast({
  ...
  ...props
}: PiWindowPictureInPictureContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
