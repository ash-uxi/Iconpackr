...
/**
 * Pinotificationbellremoveduosolid icon component for React Native
 ...
 */
const Pinotificationbellremoveduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    ...
    />{" "}
    <path
      d="M9 10C8.44772 10 8 10.4477 8 11C8 11.5523 8.44772 12 9 12L15 12C15.5523 12 16 11.5523 16 11C16 10.4477 15.5523 10 15 10H9Z"
      fill={color || "#000"}
    />{" "}
    <path
...
export default Pinotificationbellremoveduosolid;
