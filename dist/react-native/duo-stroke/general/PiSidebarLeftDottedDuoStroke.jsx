...
/**
 * Pisidebarleftdottedduostroke icon component for React Native
 ...
 */
const Pisidebarleftdottedduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "sidebar left dotted icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    ...
    />
    <path
      d="M9 3.01172V4.00067M9 8.00067V10.0007M9 14.0007V16.0007M9 20.0007V20.9896"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pisidebarleftdottedduostroke;
