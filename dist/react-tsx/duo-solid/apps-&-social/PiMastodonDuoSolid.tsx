...
/**
 * PiMastodonDuoSolid icon from the duo-solid style in apps-&-social category.
 */
interface PiMastodonDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMastodonDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'mastodon icon',
  ...props
}: PiMastodonDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
