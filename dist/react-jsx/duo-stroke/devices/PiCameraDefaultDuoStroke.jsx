...
export default function PiCameraDefaultDuoStroke({ 
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 16C13.6569 16 15 14.6569 15 13C15 11.3431 13.6569 10 12 10C10.3431 10 9 11.3431 9 13C9 14.6569 10.3431 16 12 16Z" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
  ...
  <path d="M17 10V10.01" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
