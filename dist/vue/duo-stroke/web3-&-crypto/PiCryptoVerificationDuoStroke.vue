 ...
 */
export default {
  name: 'PiCryptoVerificationDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'crypto-verification icon'
    }
  }
}
</script>
