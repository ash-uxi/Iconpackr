...
/**
 * PiClipboardCheckStroke icon from the stroke style in files-&-folders category.
 */
interface PiClipboardCheckStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardCheckStroke({
  size = 24,
  color,
  className,
