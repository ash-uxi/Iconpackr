...
/**
 * PiClipboardArrowRightStroke icon from the stroke style in files-&-folders category.
 */
interface PiClipboardArrowRightStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardArrowRightStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'clipboard-arrow-right icon',
  ...props
}: PiClipboardArrowRightStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
