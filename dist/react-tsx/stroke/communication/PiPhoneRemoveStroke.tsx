...
/**
 * PiPhoneRemoveStroke icon from the stroke style in communication category.
 */
interface PiPhoneRemoveStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhoneRemoveStroke({
  size = 24,
  color,
  className,
