...
/**
 * PiFolderCancelStroke icon from the stroke style in files-&-folders category.
 */
interface PiFolderCancelStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderCancelStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-cancel icon',
  ...props
}: PiFolderCancelStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
