...
export default function PiArrowBigDownRightSolid({
  ...
  ...props
}: PiArrowBigDownRightSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
