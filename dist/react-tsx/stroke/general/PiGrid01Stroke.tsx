...
/**
 * PiGrid01Stroke icon from the stroke style in general category.
 */
interface PiGrid01StrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiGrid01Stroke({
  size = 24,
  color,
  className,
