...
/**
 * Pidice5duosolid icon component for React Native
...
const Pidice5duosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M12 12h.01M16 8h.01M8 8h.01M8 16h.01M16 16h.01" />
  </Svg>
);

export default Pidice5duosolid;
