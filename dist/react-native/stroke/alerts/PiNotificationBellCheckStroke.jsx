...
/**
 * Pinotificationbellcheckstroke icon component for React Native
 ...
 */
const Pinotificationbellcheckstroke = ({
  color = "#000",
  size = 24,
...
export default Pinotificationbellcheckstroke;
