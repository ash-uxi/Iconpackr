...
/**
 * PiMessageCheckDuoSolid icon from the duo-solid style in communication category.
 */
interface PiMessageCheckDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageCheckDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'message-check icon',
  ...props
}: PiMessageCheckDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
