...
/**
 * PiCalendarCancelStroke icon from the stroke style in time category.
 */
interface PiCalendarCancelStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarCancelStroke({
  size = 24,
  color,
  className,
