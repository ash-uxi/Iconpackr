...
/**
 * PiFolderArrowUpStroke icon from the stroke style in files-&-folders category.
 */
interface PiFolderArrowUpStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowUpStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-up icon',
  ...props
}: PiFolderArrowUpStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
