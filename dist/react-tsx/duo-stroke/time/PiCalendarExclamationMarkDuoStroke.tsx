 ...
 */
interface PiCalendarExclamationMarkDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarExclamationMarkDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'calendar-exclamation-mark icon',
  ...props
}: PiCalendarExclamationMarkDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M8 2V6M16 2V6M12 14.0001V10.0001M12 17.3751V17.3762" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
