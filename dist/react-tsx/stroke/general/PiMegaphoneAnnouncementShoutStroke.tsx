...
/**
 * PiMegaphoneAnnouncementShoutStroke icon from the stroke style in general category.
 */
interface PiMegaphoneAnnouncementShoutStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMegaphoneAnnouncementShoutStroke({
  size = 24,
  color,
  className,
