 ...
 */
interface PiFileArrowLeftDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowLeftDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-left icon',
  ...props
}: PiFileArrowLeftDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
