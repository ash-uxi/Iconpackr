...
/**
 * Pimessagearrowleftduostroke icon component for React Native
 ...
 */
const Pimessagearrowleftduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "message arrow left icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      d="M11.8017 7.01074C10.8147 7.75099 9.9234 8.60974 9.14757 9.56717C9.04264 9.69666 8.99018 9.8537 8.99018 10.0107M11.8017 13.0107C10.8147 12.2705 9.9234 11.4117 9.14757 10.4543C9.04264 10.3248 8.99018 10.1678 8.99018 10.0107M8.99018 10.0107H15.0098"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pimessagearrowleftduostroke;
