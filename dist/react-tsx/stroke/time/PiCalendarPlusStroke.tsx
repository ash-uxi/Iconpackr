...
/**
 * PiCalendarPlusStroke icon from the stroke style in time category.
 */
interface PiCalendarPlusStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarPlusStroke({
  size = 24,
  color,
  className,
