<template>
  <svg
    ...
    v-bind="$attrs"
  >
    <path d="M12.0049 16.0061V15.9961M12.0049 12.0061V11.9961M12.0049 8.00609V7.99609" :stroke="color || 'currentColor'" stroke-width="2" fill="none"/>
 ...
 */
export default {
  name: 'PiThreeDotsMenuVerticalSquareDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'three-dots-menu-vertical-square icon'
    }
  }
}
</script>
