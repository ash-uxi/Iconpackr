...
/**
 * Pimusicbeamnoteoffsolid icon component for React Native
...
const Pimusicbeamnoteoffsolid = ({
  ...
  >
    ...
    />
    <path
      d="M21 7.8615V12.6765C20.4117 12.3408 19.7286 12.1486 19 12.1486C16.7909 12.1486 15 13.9153 15 16.0946C15 18.2739 16.7909 20.0405 19 20.0405C21.2091 20.0405 23 18.2739 23 16.0946V7.8615C23 7.31667 22.5523 6.875 22 6.875C21.4477 6.875 21 7.31667 21 7.8615Z"
      fill={color}
      stroke="none"
    />
  </Svg>
...
export default Pimusicbeamnoteoffsolid;
