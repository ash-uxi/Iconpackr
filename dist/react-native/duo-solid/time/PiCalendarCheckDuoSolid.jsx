...
/**
 * Picalendarcheckduosolid icon component for React Native
...
const Picalendarcheckduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M8 2v4m8-4v4m-7.25 7.922 2.174 2.172c1.066-1.865 2.555-3.439 4.326-4.648" />
  </Svg>
);

export default Picalendarcheckduosolid;
