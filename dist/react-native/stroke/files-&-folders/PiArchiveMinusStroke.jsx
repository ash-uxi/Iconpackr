...
/**
 * Piarchiveminusstroke icon component for React Native
...
const Piarchiveminusstroke = ({
  ...
  >
    <path
      ...
      fill="none"
    />
    <path d="M9 14.5H15" stroke={color} strokeWidth="2" fill="none" />
  </Svg>
);

export default Piarchiveminusstroke;
