...
/**
 * Piearthglobetimezonecontrast icon component for React Native
 ...
 */
const Piearthglobetimezonecontrast = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      fill={color}
      d="M12 21.15A9.15 9.15 0 1 1 21.15 12c0 .854-.123 1.685-.353 2.475l.012.01a4.5 4.5 0 1 1-6.325 6.325l-.009-.012c-.79.229-1.621.352-2.475.352"
      opacity={0.28}
    />
...
export default Piearthglobetimezonecontrast;
