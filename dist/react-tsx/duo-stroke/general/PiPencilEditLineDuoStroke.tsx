...
/**
 * PiPencilEditLineDuoStroke icon from the duo-stroke style in general category.
 */
interface PiPencilEditLineDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPencilEditLineDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'pencil-edit-line icon',
  ...props
}: PiPencilEditLineDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
