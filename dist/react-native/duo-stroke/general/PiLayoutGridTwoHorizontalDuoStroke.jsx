...
/**
 * Pilayoutgridtwohorizontalduostroke icon component for React Native
 ...
 */
const Pilayoutgridtwohorizontalduostroke = ({
  color = "#000",
  size = 24,
...
export default Pilayoutgridtwohorizontalduostroke;
