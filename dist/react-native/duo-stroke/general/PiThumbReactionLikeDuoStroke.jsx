...
/**
 * Pithumbreactionlikeduostroke icon component for React Native
 ...
 */
const Pithumbreactionlikeduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    ...
    />
    <path
      d="M3 11.5C3 10.1193 4.11929 9 5.5 9C6.88071 9 8 10.1193 8 11.5V17.5C8 18.8807 6.88071 20 5.5 20C4.11929 20 3 18.8807 3 17.5V11.5Z"
      stroke={color || "#000"}
      strokeWidth="2"
      opacity={0.28}
      fill="none"
...
export default Pithumbreactionlikeduostroke;
