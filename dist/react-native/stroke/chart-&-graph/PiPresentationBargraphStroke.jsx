...
/**
 * Pipresentationbargraphstroke icon component for React Native
 ...
 */
const Pipresentationbargraphstroke = ({
  color = "#000",
  size = 24,
...
export default Pipresentationbargraphstroke;
