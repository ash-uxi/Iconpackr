...
/**
 * Picameraminusduostroke icon component for React Native
 ...
 */
const Picameraminusduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "camera minus icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      ...
      fill="none"
    />
    <path d="M9 13H15" stroke={color || "#000"} strokeWidth="2" fill="none" />
  </Svg>
);

export default Picameraminusduostroke;
