...
/**
 * PiFolderRemoveDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFolderRemoveDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderRemoveDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-remove icon',
  ...props
}: PiFolderRemoveDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
