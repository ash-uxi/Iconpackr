...
/**
 * Pialignhorizontalcentersolid icon component for React Native
 ...
 */
const Pialignhorizontalcentersolid = ({
  color = "#000",
  size = 24,
...
export default Pialignhorizontalcentersolid;
