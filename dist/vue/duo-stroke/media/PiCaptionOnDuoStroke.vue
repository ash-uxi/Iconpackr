<template>
  <svg
    ...
    v-bind="$attrs"
  >
    <path d="M10.25 15.5C8.59315 15.5 7.25 14.1569 7.25 12.5V12C7.25 10.3431 8.59315 9 10.25 9M16.75 15.5C15.0931 15.5 13.75 14.1569 13.75 12.5V12C13.75 10.3431 15.0931 9 16.75 9" :stroke="color || 'currentColor'" stroke-width="2" fill="none"/>
