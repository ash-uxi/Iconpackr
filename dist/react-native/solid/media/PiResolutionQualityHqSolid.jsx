...
/**
 * Piresolutionqualityhqsolid icon component for React Native
 ...
 */
const Piresolutionqualityhqsolid = ({
  color = "#000",
  size = 24,
...
export default Piresolutionqualityhqsolid;
