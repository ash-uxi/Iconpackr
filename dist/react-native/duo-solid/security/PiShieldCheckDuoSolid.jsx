...
/**
 * Pishieldcheckduosolid icon component for React Native
...
const Pishieldcheckduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="m9.133 12.02 2.007 2.004a13.06 13.06 0 0 1 3.993-4.29" />
  </Svg>
);

export default Pishieldcheckduosolid;
