 ...
 */
interface PiFile02AiDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02AiDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-ai icon',
  ...props
}: PiFile02AiDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
