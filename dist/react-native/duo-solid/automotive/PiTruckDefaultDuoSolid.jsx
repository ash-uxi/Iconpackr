...
/**
 * Pitruckdefaultduosolid icon component for React Native
...
const Pitruckdefaultduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M15 18.5v-10h2.834c.782 0 1.173 0 1.511.126a2 2 0 0 1 .781.529c.243.267.388.63.679 1.357L22 13.5v1.8c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874c-.564.287-1.298.216-1.908.218m-4 0a2 2 0 1 0 4 0m-4 0a2 2 0 1 1 4 0m-4 0H9m0 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0" />{" "}
    <path
      fill={color || "#000"}
...
export default Pitruckdefaultduosolid;
