...
/**
 * Picommandcmdcirclestroke icon component for React Native
 ...
 */
const Picommandcmdcirclestroke = ({
  color = "#000",
  size = 24,
...
export default Picommandcmdcirclestroke;
