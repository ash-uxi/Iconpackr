 ...
 */
export default {
  name: 'PiPluginAddonPuzzleDuoSolid',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'plugin-addon-puzzle icon'
    }
  }
}
</script>
