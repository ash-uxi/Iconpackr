...
/**
 * PiBatteryThreeCellDuoSolid icon from the duo-solid style in devices category.
 */
interface PiBatteryThreeCellDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBatteryThreeCellDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'battery-three-cell icon',
  ...props
}: PiBatteryThreeCellDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
