 ...
 */
interface PiGitFork02StrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiGitFork02Stroke({
  ...
  ...props
}: PiGitFork02StrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
