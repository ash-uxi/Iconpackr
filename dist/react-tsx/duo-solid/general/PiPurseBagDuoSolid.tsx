...
/**
 * PiPurseBagDuoSolid icon from the duo-solid style in general category.
 */
interface PiPurseBagDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPurseBagDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'purse-bag icon',
  ...props
}: PiPurseBagDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
