...
/**
 * PiMessageCancelDuoSolid icon from the duo-solid style in communication category.
 */
interface PiMessageCancelDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageCancelDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'message-cancel icon',
  ...props
}: PiMessageCancelDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
