...
/**
 * PiBatteryOneCellDuoSolid icon from the duo-solid style in devices category.
 */
interface PiBatteryOneCellDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBatteryOneCellDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'battery-one-cell icon',
  ...props
}: PiBatteryOneCellDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
