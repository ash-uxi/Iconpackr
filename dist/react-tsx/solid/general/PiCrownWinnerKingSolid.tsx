...
/**
 * PiCrownWinnerKingSolid icon from the solid style in general category.
 */
interface PiCrownWinnerKingSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCrownWinnerKingSolid({
  size = 24,
  color,
  className,
