...
/**
 * PiChatRemoveDuoSolid icon from the duo-solid style in communication category.
 */
interface PiChatRemoveDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiChatRemoveDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'chat-remove icon',
  ...props
}: PiChatRemoveDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
