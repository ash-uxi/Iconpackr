...
/**
 * Piwalletarrowdownduosolid icon component for React Native
 ...
 */
const Piwalletarrowdownduosolid = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "wallet arrow down icon",
  style,
  ...props
}) => (
  <Svg
    ...
    {...props}
  >
    <path d="M14 12h3m.428 7.592c.635.846 1.371 1.61 2.192 2.275.11.09.245.135.38.135m2.571-2.41a12.9 12.9 0 0 1-2.19 2.275.6.6 0 0 1-.381.135m0 0v-6" />{" "}
    <path
      fill={color || "#000"}
...
export default Piwalletarrowdownduosolid;
