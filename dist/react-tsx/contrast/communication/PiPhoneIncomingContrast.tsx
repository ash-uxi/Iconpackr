...
/**
 * PiPhoneIncomingContrast icon from the contrast style in communication category.
 */
interface PiPhoneIncomingContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhoneIncomingContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'phone-incoming icon',
  ...props
}: PiPhoneIncomingContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
