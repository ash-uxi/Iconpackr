...
/**
 * Pispatialcurvedscreensolid icon component for React Native
 ...
 */
const Pispatialcurvedscreensolid = ({
  color = "#000",
  size = 24,
...
export default Pispatialcurvedscreensolid;
