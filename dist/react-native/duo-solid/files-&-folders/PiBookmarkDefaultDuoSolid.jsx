...
/**
 * Pibookmarkdefaultduosolid icon component for React Native
 ...
 */
const Pibookmarkdefaultduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="m19 22-1.794-1.537c-1.848-1.584-2.771-2.376-3.808-2.678a5 5 0 0 0-2.796 0c-1.037.302-1.96 1.094-3.808 2.678L5 22" />
  </Svg>
);

export default Pibookmarkdefaultduosolid;
