 ...
 */
interface PiSmartContractStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSmartContractStroke({
  ...
  ...props
}: PiSmartContractStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
