...
/**
 * PiVideoCallRemoveSolid icon from the solid style in devices category.
 */
interface PiVideoCallRemoveSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiVideoCallRemoveSolid({
  size = 24,
  color,
  className,
