...
/**
 * PiFolderArrowRightDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFolderArrowRightDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowRightDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-right icon',
  ...props
}: PiFolderArrowRightDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
