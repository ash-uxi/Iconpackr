...
/**
 * PiWalletPlusDuoSolid icon from the duo-solid style in web3-&-crypto category.
 */
interface PiWalletPlusDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletPlusDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'wallet-plus icon',
  ...props
}: PiWalletPlusDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
