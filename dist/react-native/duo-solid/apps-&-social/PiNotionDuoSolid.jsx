...
/**
 * Pinotionduosolid icon component for React Native
...
const Pinotionduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M10.885 17.4v-6.794c0-.125 0-.187.023-.213a.09.09 0 0 1 .08-.029c.035.006.074.054.153.15l5.338 6.571c.079.097.118.145.152.15a.09.09 0 0 0 .08-.028c.024-.026.024-.088.024-.213V10.2" />{" "}
    <path
      fill={color || "#000"}
      fillRule="evenodd"
...
export default Pinotionduosolid;
