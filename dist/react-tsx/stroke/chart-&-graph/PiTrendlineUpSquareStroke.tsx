 ...
 */
interface PiTrendlineUpSquareStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiTrendlineUpSquareStroke({
  ...
  ...props
}: PiTrendlineUpSquareStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
