...
/**
 * Piannotationexclamationduosolid icon component for React Native
 ...
 */
const Piannotationexclamationduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M12 11.5v-4m-.007 7.5h.01" />{" "}
    <path
      fill={color || "#000"}
...
export default Piannotationexclamationduosolid;
