<template>
  <svg
    ...
    v-bind="$attrs"
  >
    <path d="M15 21H6C4.89543 21 4 20.1046 4 19C4 16.7909 5.79086 15 8 15H12.4297" :stroke="color || 'currentColor'" stroke-width="2" opacity="0.28" fill="none"/>
