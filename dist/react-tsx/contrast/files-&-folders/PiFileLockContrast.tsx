...
/**
 * PiFileLockContrast icon from the contrast style in files-&-folders category.
 */
interface PiFileLockContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileLockContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'file-lock icon',
  ...props
}: PiFileLockContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
