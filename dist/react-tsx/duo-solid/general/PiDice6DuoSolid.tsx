...
/**
 * PiDice6DuoSolid icon from the duo-solid style in general category.
 */
interface PiDice6DuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiDice6DuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'dice-6 icon',
  ...props
}: PiDice6DuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
