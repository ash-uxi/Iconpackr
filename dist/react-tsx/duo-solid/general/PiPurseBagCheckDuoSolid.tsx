...
/**
 * PiPurseBagCheckDuoSolid icon from the duo-solid style in general category.
 */
interface PiPurseBagCheckDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPurseBagCheckDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'purse-bag-check icon',
  ...props
}: PiPurseBagCheckDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
