...
/**
 * Picalendaroffduosolid icon component for React Native
 ...
 */
const Picalendaroffduosolid = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "calendar off icon",
  style,
  ...props
}) => (
  <Svg
