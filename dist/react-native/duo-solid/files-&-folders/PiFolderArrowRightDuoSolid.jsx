...
/**
 * Pifolderarrowrightduosolid icon component for React Native
 ...
 */
const Pifolderarrowrightduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M9 14h6m0 0c0 .105-.035.21-.105.296A10 10 0 0 1 13.125 16M15 14a.47.47 0 0 0-.105-.296A10 10 0 0 0 13.125 12" />{" "}
    <path
      fill={color || "#000"}
...
export default Pifolderarrowrightduosolid;
