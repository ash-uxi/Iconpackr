...
/**
 * Pimessagecancelduostroke icon component for React Native
 ...
 */
const Pimessagecancelduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "message cancel icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    ...
    />
    <path
      d="M9.52515 12.4527L12 9.9778M12 9.9778L14.4749 7.50293M12 9.9778L9.52515 7.50293M12 9.9778L14.4749 12.4527"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pimessagecancelduostroke;
