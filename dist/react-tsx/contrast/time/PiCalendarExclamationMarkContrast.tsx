...
/**
 * PiCalendarExclamationMarkContrast icon from the contrast style in time category.
 */
interface PiCalendarExclamationMarkContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarExclamationMarkContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'calendar-exclamation-mark icon',
  ...props
}: PiCalendarExclamationMarkContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
