...
/**
 * PiDice2Solid icon from the solid style in general category.
 */
interface PiDice2SolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiDice2Solid({
  size = 24,
  color,
  className,
  ariaLabel = 'dice-2 icon',
  ...props
}: PiDice2SolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
