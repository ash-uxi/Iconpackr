<template>
  ...
  <path d="M3 7C3 4.79086 4.79086 3 7 3H17C19.2091 3 21 4.79086 21 7V13C21 17.4183 17.4183 21 13 21H7C4.79086 21 3 19.2091 3 17V7Z" stroke="currentColor" stroke-width="2" fill="none"/>
  </svg>
</template>
 ...
 */
export default {
  name: 'PiStickerCornerFoldedStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'sticker-corner-folded icon'
    }
  }
}
</script>
