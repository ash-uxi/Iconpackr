...
/**
 * PiCameraCheckStroke icon from the stroke style in devices category.
 */
interface PiCameraCheckStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCameraCheckStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'camera-check icon',
  ...props
}: PiCameraCheckStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M9 13.3133L11.3412 15.652C12.4672 13.6831 14.0256 11.9954 15.8987 10.7163" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
