<template>
  ...
  <path fill="currentColor" d="M4.9 7.4c2.411-4.178 7.704-5.637 11.822-3.26 4.117 2.378 5.5 7.69 3.088 11.868q-.22.383-.473.735l-.266-.303a6.8 6.8 0 0 0-3.79-2.188l-.395-.079-1.292-1.26a6.8 6.8 0 0 0-2.906-1.678l-1.737-.488-.266-.304a6.8 6.8 0 0 0-3.79-2.187L4.5 8.177q.178-.394.4-.778" opacity=".28"/>
  </svg>
</template>
