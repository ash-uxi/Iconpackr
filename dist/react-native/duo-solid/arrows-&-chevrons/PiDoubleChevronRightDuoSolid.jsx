...
/**
 * Pidoublechevronrightduosolid icon component for React Native
 ...
 */
const Pidoublechevronrightduosolid = ({
  color = "#000",
  size = 24,
...
export default Pidoublechevronrightduosolid;
