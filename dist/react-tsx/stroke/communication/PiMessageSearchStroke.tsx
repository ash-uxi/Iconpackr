...
/**
 * PiMessageSearchStroke icon from the stroke style in communication category.
 */
interface PiMessageSearchStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageSearchStroke({
  size = 24,
  color,
  className,
