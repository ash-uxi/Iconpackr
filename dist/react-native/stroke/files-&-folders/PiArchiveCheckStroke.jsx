...
/**
 * Piarchivecheckstroke icon component for React Native
 ...
 */
const Piarchivecheckstroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "archive check icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    ...
    />
    <path
      d="M8.55005 14.597L10.892 16.936C12.0179 14.967 13.5761 13.2793 15.449 12"
      stroke={color}
      strokeWidth="2"
      fill="none"
    />
...
export default Piarchivecheckstroke;
