 ...
 */
export default {
  name: 'PiPencilScaleCrossDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'pencil-scale-cross icon'
    }
  }
}
</script>
