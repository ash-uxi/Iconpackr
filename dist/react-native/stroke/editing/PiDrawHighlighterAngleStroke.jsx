...
/**
 * Pidrawhighlighteranglestroke icon component for React Native
 ...
 */
const Pidrawhighlighteranglestroke = ({
  color = "#000",
  size = 24,
...
export default Pidrawhighlighteranglestroke;
