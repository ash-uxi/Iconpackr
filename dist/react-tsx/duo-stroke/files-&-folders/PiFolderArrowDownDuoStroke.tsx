 ...
 */
interface PiFolderArrowDownDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowDownDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-down icon',
  ...props
}: PiFolderArrowDownDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12 11V17M12 17C11.8953 17 11.7906 16.965 11.7043 16.8951C11.066 16.3779 10.4935 15.7836 10 15.1256M12 17C12.1047 17 12.2094 16.965 12.2957 16.8951C12.934 16.3779 13.5065 15.7836 14 15.1256" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
