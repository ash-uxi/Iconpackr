...
/**
 * Picalendarsettingsstroke icon component for React Native
 ...
 */
const Picalendarsettingsstroke = ({
  color = "#000",
  size = 24,
...
export default Picalendarsettingsstroke;
