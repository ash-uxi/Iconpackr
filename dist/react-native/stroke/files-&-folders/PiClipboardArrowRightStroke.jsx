...
/**
 * Piclipboardarrowrightstroke icon component for React Native
 ...
 */
const Piclipboardarrowrightstroke = ({
  color = "#000",
  size = 24,
...
export default Piclipboardarrowrightstroke;
