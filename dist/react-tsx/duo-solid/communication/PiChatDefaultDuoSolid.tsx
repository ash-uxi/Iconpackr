...
/**
 * PiChatDefaultDuoSolid icon from the duo-solid style in communication category.
 */
interface PiChatDefaultDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiChatDefaultDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'chat-default icon',
  ...props
}: PiChatDefaultDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
