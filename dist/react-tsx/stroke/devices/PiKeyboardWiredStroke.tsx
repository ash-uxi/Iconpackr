 ...
 */
interface PiKeyboardWiredStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiKeyboardWiredStroke({
  ...
  ...props
}: PiKeyboardWiredStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
