...
/**
 * Pihomedefaultduostroke icon component for React Native
 ...
 */
const Pihomedefaultduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "home default icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pihomedefaultduostroke;
