...
export default function PiFitnessWeightLiftingStroke({
  ...
  <path d="M12 7V11M12 7H11.3188C10.5187 7 9.79566 7.47679 9.4805 8.21216L7 14M12 7H12.6812C13.4813 7 14.2043 7.47679 14.5195 8.21216L17 14" stroke="currentColor" strokeWidth="2" fill="none"/>
  <path d="M15 17L16 19L17 22" stroke="currentColor" strokeWidth="2" fill="none"/>
  <path d="M3 14H4M4 14H20M4 14V12M4 14V16M20 14H21M20 14V12M20 14V16" stroke="currentColor" strokeWidth="2" fill="none"/>
  <path d="M9 17L8 19L7 22" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
