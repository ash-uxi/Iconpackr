 ...
 */
interface PiPlaylistCheckDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistCheckDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'playlist-check icon',
  ...props
}: PiPlaylistCheckDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M8.5 16.1408L10.8412 18.4795C11.9893 16.4718 13.5934 14.7771 15.5 13.4746" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
