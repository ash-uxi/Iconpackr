...
/**
 * Piappleintelligencecontrast icon component for React Native
 ...
 */
const Piappleintelligencecontrast = ({
  color = "#000",
  size = 24,
  ...
  >
    ...
    <path
      fill={color}
      d="M12.004 2.253c-2.5 0-3.11 3.67-3.11 3.67s-3.256-1.808-4.81.14c-1.555 1.95.934 4.722.934 4.722s-3.447 1.403-2.891 3.846c.555 2.443 4.274 2.217 4.274 2.217s-1.042 3.577 1.21 4.662 4.393-1.964 4.393-1.964 2.124 3.049 4.38 1.97c2.255-1.077 1.222-4.668 1.222-4.668s3.709.224 4.267-2.213-2.883-3.85-2.883-3.85 2.486-2.773.926-4.726c-1.559-1.952-4.803-.135-4.803-.135s-.609-3.671-3.109-3.671"
      opacity={0.28}
    />
  </Svg>
);

export default Piappleintelligencecontrast;
