 ...
 */
export default {
  name: 'PiNotificationBellCancelStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'notification-bell-cancel icon'
    }
  }
}
</script>
