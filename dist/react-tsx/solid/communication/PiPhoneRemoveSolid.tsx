...
/**
 * PiPhoneRemoveSolid icon from the solid style in communication category.
 */
interface PiPhoneRemoveSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhoneRemoveSolid({
  size = 24,
  color,
  className,
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M13.9999 6C13.4476 6 12.9999 6.44772 12.9999 7C12.9999 7.55228 13.4476 8 13.9999 8H19.9999C20.5522 8 20.9999 7.55228 20.9999 7C20.9999 6.44772 20.5522 6 19.9999 6H13.9999Z" fill="currentColor" stroke="none"/>
