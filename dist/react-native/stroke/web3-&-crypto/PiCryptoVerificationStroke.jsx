...
/**
 * Picryptoverificationstroke icon component for React Native
 ...
 */
const Picryptoverificationstroke = ({
  color = "#000",
  size = 24,
...
export default Picryptoverificationstroke;
