...
/**
 * Pifoldergitcontrast icon component for React Native
 ...
 */
const Pifoldergitcontrast = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "folder git icon",
  style,
  ...props
}) => (
  <Svg
