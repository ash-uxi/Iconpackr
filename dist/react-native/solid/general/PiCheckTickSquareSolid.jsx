...
/**
 * Picheckticksquaresolid icon component for React Native
 ...
 */
const Picheckticksquaresolid = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "check tick square icon",
  style,
  ...props
}) => (
  <Svg
...
export default Picheckticksquaresolid;
