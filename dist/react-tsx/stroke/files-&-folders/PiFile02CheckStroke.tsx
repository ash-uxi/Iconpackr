...
/**
 * PiFile02CheckStroke icon from the stroke style in files-&-folders category.
 */
interface PiFile02CheckStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02CheckStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-check icon',
  ...props
}: PiFile02CheckStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
