...
/**
 * Pideletedustbin01duosolid icon component for React Native
 ...
 */
const Pideletedustbin01duosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="m16 6-1.106-2.211a3.236 3.236 0 0 0-5.788 0L8 6m8 0H4m12 0h4" />{" "}
    <path
      fill={color || "#000"}
...
export default Pideletedustbin01duosolid;
