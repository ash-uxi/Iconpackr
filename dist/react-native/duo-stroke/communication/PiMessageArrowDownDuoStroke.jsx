...
/**
 * Pimessagearrowdownduostroke icon component for React Native
 ...
 */
const Pimessagearrowdownduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "message arrow down icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      d="M15 10.2091C14.2598 11.196 13.401 12.0874 12.4436 12.8632C12.3141 12.9681 12.157 13.0206 12 13.0206M9 10.2091C9.74024 11.196 10.599 12.0874 11.5564 12.8632C11.6859 12.9681 11.843 13.0206 12 13.0206M12 13.0206V7.00098"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pimessagearrowdownduostroke;
