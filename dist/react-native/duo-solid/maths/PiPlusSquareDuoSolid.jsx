...
/**
 * Piplussquareduosolid icon component for React Native
...
const Piplussquareduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M12 15.1V12m0 0V8.9m0 3.1H8.9m3.1 0h3.1" />
  </Svg>
);

export default Piplussquareduosolid;
