...
export default function PiMessageArrowRightStroke({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12.1983 7.01074C13.1852 7.75099 14.0766 8.60974 14.8524 9.56717C14.9573 9.69666 15.0098 9.8537 15.0098 10.0107M12.1983 13.0107C13.1852 12.2705 14.0766 11.4117 14.8524 10.4543C14.9573 10.3248 15.0098 10.1678 15.0098 10.0107M15.0098 10.0107H8.99017" stroke="currentColor" strokeWidth="2" fill="none"/>
