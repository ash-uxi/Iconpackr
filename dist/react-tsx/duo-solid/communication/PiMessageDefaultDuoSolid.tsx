...
/**
 * PiMessageDefaultDuoSolid icon from the duo-solid style in communication category.
 */
interface PiMessageDefaultDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageDefaultDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'message-default icon',
  ...props
}: PiMessageDefaultDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
