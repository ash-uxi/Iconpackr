...
/**
 * Pimultiplecrosscancelsquarecontrast icon component for React Native
 ...
 */
const Pimultiplecrosscancelsquarecontrast = ({
  color = "#000",
  size = 24,
