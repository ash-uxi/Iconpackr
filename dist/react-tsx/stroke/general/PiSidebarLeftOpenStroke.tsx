...
/**
 * PiSidebarLeftOpenStroke icon from the stroke style in general category.
 */
interface PiSidebarLeftOpenStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSidebarLeftOpenStroke({
  size = 24,
  color,
  className,
