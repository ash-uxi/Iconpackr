...
/**
 * Pifolderquestionmarkduosolid icon component for React Native
 ...
 */
const Pifolderquestionmarkduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M9.85 11.502a2.249 2.249 0 0 1 4.37.75c0 1.499-2.249 2.248-2.249 2.248m.03 3h.01" />{" "}
    <path
      fill={color || "#000"}
...
export default Pifolderquestionmarkduosolid;
