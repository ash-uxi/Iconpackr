 ...
 */
interface PiArchiveHeartStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiArchiveHeartStroke({
  ...
  ...props
}: PiArchiveHeartStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12 17.5628C12.35 17.5628 15.5 15.8608 15.5 13.4788C15.5 12.2888 14.45 11.4528 13.4 11.4378C12.875 11.4298 12.35 11.6078 12 12.1178C11.65 11.6078 11.116 11.4378 10.6 11.4378C9.55 11.4378 8.5 12.2878 8.5 13.4788C8.5 15.8608 11.65 17.5628 12 17.5628Z" stroke="currentColor" strokeWidth="2" fill="none"/>
