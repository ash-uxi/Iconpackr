...
/**
 * PiPhoneDefaultContrast icon from the contrast style in communication category.
 */
interface PiPhoneDefaultContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhoneDefaultContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'phone-default icon',
  ...props
}: PiPhoneDefaultContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
