...
/**
 * PiFileDefaultStroke icon from the stroke style in files-&-folders category.
 */
interface PiFileDefaultStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileDefaultStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-default icon',
  ...props
}: PiFileDefaultStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
