...
/**
 * PiFolderArrowLeftDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFolderArrowLeftDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowLeftDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-left icon',
  ...props
}: PiFolderArrowLeftDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
