...
/**
 * PiFolderArrowDownContrast icon from the contrast style in files-&-folders category.
 */
interface PiFolderArrowDownContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowDownContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-down icon',
  ...props
}: PiFolderArrowDownContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
