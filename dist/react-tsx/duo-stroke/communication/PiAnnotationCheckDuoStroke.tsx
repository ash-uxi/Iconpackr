...
/**
 * PiAnnotationCheckDuoStroke icon from the duo-stroke style in communication category.
 */
interface PiAnnotationCheckDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationCheckDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'annotation-check icon',
  ...props
}: PiAnnotationCheckDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M8.5 11.5124L10.8412 13.8511C11.9672 11.8821 13.5255 10.1945 15.3987 8.91536L15.5 8.84619" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
