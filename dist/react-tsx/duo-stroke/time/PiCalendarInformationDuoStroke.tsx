 ...
 */
interface PiCalendarInformationDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarInformationDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'calendar-information icon',
  ...props
}: PiCalendarInformationDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M16 2V6M8 2V6M12 13.3761V17.3761M12 10.0011V10" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
