...
/**
 * PiClipboardArrowLeftStroke icon from the stroke style in files-&-folders category.
 */
interface PiClipboardArrowLeftStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardArrowLeftStroke({
  size = 24,
  color,
  className,
