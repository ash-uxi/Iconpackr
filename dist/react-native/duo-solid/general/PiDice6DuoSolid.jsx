...
/**
 * Pidice6duosolid icon component for React Native
...
const Pidice6duosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M16 8h.01M8 8h.01M8 16h.01M16 16h.01M8 12h.01M16 12h.01" />
  </Svg>
);

export default Pidice6duosolid;
