...
/**
 * PiCopyCopiedContrast icon from the contrast style in general category.
 */
interface PiCopyCopiedContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCopyCopiedContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'copy-copied icon',
  ...props
}: PiCopyCopiedContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
