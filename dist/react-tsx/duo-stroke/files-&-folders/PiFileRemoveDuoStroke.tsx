 ...
 */
interface PiFileRemoveDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileRemoveDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-remove icon',
  ...props
}: PiFileRemoveDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
