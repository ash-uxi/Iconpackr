...
/**
 * Piinformationtrianglesolid icon component for React Native
 ...
 */
const Piinformationtrianglesolid = ({
  color = "#000",
  size = 24,
...
export default Piinformationtrianglesolid;
