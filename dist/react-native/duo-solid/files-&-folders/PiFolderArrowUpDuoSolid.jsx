...
/**
 * Pifolderarrowupduosolid icon component for React Native
...
const Pifolderarrowupduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M12 17v-6m0 0a.47.47 0 0 0-.296.105A10 10 0 0 0 10 12.875M12 11c.105 0 .21.035.296.105A10 10 0 0 1 14 12.875" />{" "}
    <path
      fill={color || "#000"}
...
export default Pifolderarrowupduosolid;
