 ...
 */
interface PiTwitterDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiTwitterDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'twitter icon',
  ...props
}: PiTwitterDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
