...
/**
 * Piannotationcancelduostroke icon component for React Native
 ...
 */
const Piannotationcancelduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "annotation cancel icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    ...
    />
    <path
      d="M9.5 13.5L12 11M12 11L14.5 8.5M12 11L9.5 8.5M12 11L14.5 13.5"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Piannotationcancelduostroke;
