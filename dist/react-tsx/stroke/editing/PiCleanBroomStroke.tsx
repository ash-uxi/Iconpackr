...
/**
 * PiCleanBroomStroke icon from the stroke style in editing category.
 */
interface PiCleanBroomStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCleanBroomStroke({
  size = 24,
  color,
  className,
