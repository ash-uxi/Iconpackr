...
export default function PiArrowBigLeftSolid({
  ...
  ...props
}: PiArrowBigLeftSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
