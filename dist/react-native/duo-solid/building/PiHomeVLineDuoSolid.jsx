...
/**
 * Pihomevlineduosolid icon component for React Native
...
const Pihomevlineduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M12 17v-4m8.881-2.243a4 4 0 0 0-.513-1.19c-.265-.414-.634-.763-1.374-1.461l-2.6-2.456c-1.546-1.46-2.32-2.19-3.201-2.466a4 4 0 0 0-2.386 0c-.882.275-1.655 1.006-3.201 2.466l-2.6 2.456c-.74.698-1.11 1.047-1.374 1.46a4 4 0 0 0-.513 1.191" />{" "}
    <path
      fill={color || "#000"}
...
export default Pihomevlineduosolid;
