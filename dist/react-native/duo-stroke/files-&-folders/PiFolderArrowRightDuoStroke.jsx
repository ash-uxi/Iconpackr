...
/**
 * Pifolderarrowrightduostroke icon component for React Native
 ...
 */
const Pifolderarrowrightduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    ...
    />
    <path
      d="M9 14H15M15 14C15 14.1047 14.965 14.2094 14.8951 14.2957C14.3779 14.934 13.7836 15.5065 13.1256 16M15 14C15 13.8953 14.965 13.7906 14.8951 13.7043C14.3779 13.066 13.7836 12.4935 13.1256 12"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pifolderarrowrightduostroke;
