 ...
 */
interface PiFileArrowRightDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowRightDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-right icon',
  ...props
}: PiFileArrowRightDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
