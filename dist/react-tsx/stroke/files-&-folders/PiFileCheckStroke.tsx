...
/**
 * PiFileCheckStroke icon from the stroke style in files-&-folders category.
 */
interface PiFileCheckStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileCheckStroke({
  size = 24,
  color,
  className,
