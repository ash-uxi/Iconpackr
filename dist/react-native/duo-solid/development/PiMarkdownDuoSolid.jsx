...
/**
 * Pimarkdownduosolid icon component for React Native
...
const Pimarkdownduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M6 15V9l2.5 3L11 9v6m3-1.874a10 10 0 0 0 1.704 1.77c.087.069.191.104.296.104m2-1.874a10 10 0 0 1-1.704 1.77A.47.47 0 0 1 16 15m0 0V9" />{" "}
    <path
      fill={color || "#000"}
...
export default Pimarkdownduosolid;
