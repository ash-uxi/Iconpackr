...
export default function PiLinkHorizontalDuoStroke({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M15 12H9" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
  <path d="M15 7H16C18.7614 7 21 9.23858 21 12C21 14.7614 18.7614 17 16 17H15M9 7H8C5.23858 7 3 9.23858 3 12C3 14.7614 5.23858 17 8 17H9" stroke={color || "currentColor"} strokeWidth="2" opacity="0.28" fill="none"/>
    </svg>
  );
}
