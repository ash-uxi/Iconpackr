...
/**
 * PiMedicalCrossStroke icon from the stroke style in medical category.
 */
interface PiMedicalCrossStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMedicalCrossStroke({
  size = 24,
  color,
  className,
