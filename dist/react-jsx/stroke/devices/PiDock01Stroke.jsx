...
/**
 * PiDock01Stroke icon from the stroke style in devices category.
 ...
 */
export default function PiDock01Stroke({ 
  size = 24, 
  color,
  className,
