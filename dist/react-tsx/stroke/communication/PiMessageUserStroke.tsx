 ...
 */
interface PiMessageUserStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageUserStroke({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M13 7.69727C13 8.24955 12.5523 8.69727 12 8.69727C11.4477 8.69727 11 8.24955 11 7.69727C11 7.14498 11.4477 6.69727 12 6.69727C12.5523 6.69727 13 7.14498 13 7.69727Z" stroke="currentColor" strokeWidth="2" fill="none"/>
  <path d="M13.25 11.126H10.75C10.0596 11.126 9.5 11.6856 9.5 12.376C9.5 12.7212 9.77982 13.001 10.125 13.001H13.875C14.2202 13.001 14.5 12.7212 14.5 12.376C14.5 11.6856 13.9404 11.126 13.25 11.126Z" stroke="currentColor" strokeWidth="2" fill="none"/>
