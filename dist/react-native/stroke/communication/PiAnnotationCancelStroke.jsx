...
/**
 * Piannotationcancelstroke icon component for React Native
 ...
 */
const Piannotationcancelstroke = ({
  color = "#000",
  size = 24,
...
export default Piannotationcancelstroke;
