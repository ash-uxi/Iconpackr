...
/**
 * Piframercontrast icon component for React Native
 ...
 */
const Piframercontrast = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "framer icon",
  style,
  ...props
}) => (
  <Svg
...
export default Piframercontrast;
