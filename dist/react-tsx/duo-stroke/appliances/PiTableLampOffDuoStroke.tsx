...
export default function PiTableLampOffDuoStroke({
  ...
  <path d="M6.72712 4.32998C7.01062 3.53262 7.76529 3 8.61155 3H15.3885C16.2347 3 16.9894 3.53262 17.2729 4.32998L20 12H4L6.72712 4.32998Z" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
