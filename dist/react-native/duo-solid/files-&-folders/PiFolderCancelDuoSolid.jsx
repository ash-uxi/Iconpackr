...
/**
 * Pifoldercancelduosolid icon component for React Native
...
const Pifoldercancelduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="m9.475 16.424 2.475-2.474m0 0 2.474-2.475M11.95 13.95l-2.475-2.475m2.475 2.475 2.474 2.474" />{" "}
    <path
      fill={color || "#000"}
...
export default Pifoldercancelduosolid;
