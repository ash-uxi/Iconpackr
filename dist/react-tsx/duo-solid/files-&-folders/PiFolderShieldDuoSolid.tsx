...
/**
 * PiFolderShieldDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFolderShieldDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderShieldDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-shield icon',
  ...props
}: PiFolderShieldDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
