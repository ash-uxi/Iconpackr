...
/**
 * Piwalletarrowleftduosolid icon component for React Native
 ...
 */
const Piwalletarrowleftduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M14 12h3m1.41 10.573a12.9 12.9 0 0 1-2.275-2.191.6.6 0 0 1-.135-.38m2.41-2.572c-.846.634-1.61 1.37-2.275 2.191a.6.6 0 0 0-.135.38m0 0h6" />{" "}
    <path
      fill={color || "#000"}
...
export default Piwalletarrowleftduosolid;
