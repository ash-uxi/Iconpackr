...
/**
 * PiCloudArrowDownloadStroke icon from the stroke style in development category.
 */
interface PiCloudArrowDownloadStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCloudArrowDownloadStroke({
  size = 24,
  color,
  className,
