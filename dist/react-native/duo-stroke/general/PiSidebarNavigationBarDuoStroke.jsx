...
/**
 * Pisidebarnavigationbarduostroke icon component for React Native
 ...
 */
const Pisidebarnavigationbarduostroke = ({
  color = "#000",
  size = 24,
...
export default Pisidebarnavigationbarduostroke;
