...
/**
 * Picalendarinformationduosolid icon component for React Native
 ...
 */
const Picalendarinformationduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M8 2v4m8-4v4m-4 7.376v4m0-7.375z" />
  </Svg>
);

export default Picalendarinformationduosolid;
