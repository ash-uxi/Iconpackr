...
/**
 * Piphoneremoveduostroke icon component for React Native
 ...
 */
const Piphoneremoveduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "phone remove icon",
  style,
  ...props
}) => (
  <Svg
...
export default Piphoneremoveduostroke;
