...
/**
 * Piarchivearrowleftduostroke icon component for React Native
 ...
 */
const Piarchivearrowleftduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      d="M11.41 17.0707C10.5646 16.4369 9.80048 15.7014 9.135 14.8807C9.04751 14.773 8.99983 14.6385 9 14.4997M9 14.4997C8.99983 14.361 9.04751 14.2264 9.135 14.1187C9.8 13.2987 10.564 12.5627 11.41 11.9287M9 14.4997H15"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Piarchivearrowleftduostroke;
