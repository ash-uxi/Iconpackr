...
/**
 * PiBookmarkRemoveSolid icon from the solid style in files-&-folders category.
 */
interface PiBookmarkRemoveSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBookmarkRemoveSolid({
  size = 24,
  color,
  className,
