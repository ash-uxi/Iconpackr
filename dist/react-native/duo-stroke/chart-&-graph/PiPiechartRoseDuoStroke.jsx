...
/**
 * Pipiechartroseduostroke icon component for React Native
...
const Pipiechartroseduostroke = ({
  ...
  >
    ...
    />
    <path
      d="M21.1319 13.0008C21.1319 7.40227 16.5934 2.86377 10.9949 2.86377V13.0008H21.1319Z"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pipiechartroseduostroke;
