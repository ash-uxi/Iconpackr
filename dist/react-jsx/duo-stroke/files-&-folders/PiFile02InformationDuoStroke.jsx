...
export default function PiFile02InformationDuoStroke({ 
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 14V17M12 11V11.01M20 11C20 9.3431 18.6569 8 17 8H16.4C16.0284 8 15.8426 8 15.6871 7.9754C14.8313 7.8398 14.1602 7.1687 14.0246 6.3129C14 6.1574 14 5.9716 14 5.6V5C14 3.3431 12.6569 2 11 2H12C16.4183 2 20 5.5817 20 10V11Z" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
