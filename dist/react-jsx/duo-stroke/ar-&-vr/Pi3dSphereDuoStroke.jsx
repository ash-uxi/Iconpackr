...
export default function Pi3dSphereDuoStroke({ 
  ...
  <path d="M21.1418 12.3901C17.3391 13.8819 13.1086 14.2743 9.0596 13.8512M9.0596 13.8512C6.78735 13.6138 4.68379 13.1063 2.85815 12.3901M9.0596 13.8512C9.23111 16.4977 9.76585 18.9476 10.5729 21.0394M9.0596 13.8512C8.82175 10.1808 9.24471 6.40314 10.5729 2.96069" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
