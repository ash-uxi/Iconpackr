...
/**
 * Piwalletarrowrightduostroke icon component for React Native
 ...
 */
const Piwalletarrowrightduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "wallet arrow right icon",
  style,
  ...props
}) => (
  <Svg
...
export default Piwalletarrowrightduostroke;
