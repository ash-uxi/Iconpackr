 ...
 */
interface PiFolderArrowUpDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowUpDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-up icon',
  ...props
}: PiFolderArrowUpDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12 17V11M12 11C11.8953 11 11.7906 11.035 11.7043 11.1049C11.066 11.6221 10.4935 12.2164 10 12.8744M12 11C12.1047 11 12.2094 11.035 12.2957 11.1049C12.934 11.6221 13.5065 12.2164 14 12.8744" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
