...
/**
 * PiArchiveAddStroke icon from the stroke style in files-&-folders category.
 */
interface PiArchiveAddStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiArchiveAddStroke({
  size = 24,
  color,
  className,
  ...
  <path d="M9 14.5H12M12 14.5H15M12 14.5V11.5M12 14.5V17.5" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
