...
/**
 * Picloudarrowuploadduosolid icon component for React Native
 ...
 */
const Picloudarrowuploadduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M16 15.63a19 19 0 0 0-3.445-3.232.94.94 0 0 0-1.11 0A19 19 0 0 0 8 15.63M12 21v-8.773" />
  </Svg>
);

export default Picloudarrowuploadduosolid;
