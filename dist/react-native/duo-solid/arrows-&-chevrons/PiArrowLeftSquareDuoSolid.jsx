...
/**
 * Piarrowleftsquareduosolid icon component for React Native
 ...
 */
const Piarrowleftsquareduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M11.949 8a20.3 20.3 0 0 0-3.807 3.604A.63.63 0 0 0 8 12m3.949 4a20.3 20.3 0 0 1-3.807-3.604A.63.63 0 0 1 8 12m0 0h8" />{" "}
    <path
      fill={color || "#000"}
...
export default Piarrowleftsquareduosolid;
