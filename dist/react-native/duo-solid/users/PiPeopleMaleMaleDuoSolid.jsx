...
/**
 * Pipeoplemalemaleduosolid icon component for React Native
 ...
 */
const Pipeoplemalemaleduosolid = ({
  color = "#000",
  size = 24,
...
export default Pipeoplemalemaleduosolid;
