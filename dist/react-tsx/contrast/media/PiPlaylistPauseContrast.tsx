...
/**
 * PiPlaylistPauseContrast icon from the contrast style in media category.
 */
interface PiPlaylistPauseContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistPauseContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'playlist-pause icon',
  ...props
}: PiPlaylistPauseContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
