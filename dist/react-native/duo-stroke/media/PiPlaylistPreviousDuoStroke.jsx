...
/**
 * Piplaylistpreviousduostroke icon component for React Native
 ...
 */
const Piplaylistpreviousduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "playlist previous icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      d="M11.8017 13.0098C10.8147 13.75 9.92337 14.6088 9.14754 15.5662C9.04261 15.6957 8.99015 15.8527 8.99015 16.0098M11.8017 19.0098C10.8147 18.2695 9.92337 17.4108 9.14754 16.4533C9.04261 16.3238 8.99015 16.1668 8.99015 16.0098M8.99015 16.0098H15.0098"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Piplaylistpreviousduostroke;
