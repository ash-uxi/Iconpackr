...
/**
 * PiClipboardDefaultStroke icon from the stroke style in files-&-folders category.
 */
interface PiClipboardDefaultStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardDefaultStroke({
  size = 24,
  color,
  className,
