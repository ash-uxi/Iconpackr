...
/**
 * Pipointercursorclickstroke icon component for React Native
 ...
 */
const Pipointercursorclickstroke = ({
  color = "#000",
  size = 24,
...
export default Pipointercursorclickstroke;
