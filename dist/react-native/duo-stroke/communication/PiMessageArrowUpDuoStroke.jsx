...
/**
 * Pimessagearrowupduostroke icon component for React Native
 ...
 */
const Pimessagearrowupduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "message arrow up icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      d="M15 9.81243C14.2598 8.82544 13.401 7.93411 12.4436 7.15828C12.3141 7.05335 12.157 7.00089 12 7.00089M9 9.81243C9.74024 8.82544 10.599 7.93411 11.5564 7.15829C11.6859 7.05336 11.843 7.00089 12 7.00089M12 7.00089V13.0205"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pimessagearrowupduostroke;
