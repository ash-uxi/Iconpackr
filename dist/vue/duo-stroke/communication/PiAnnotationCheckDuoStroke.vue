<template>
  ...
  <path d="M8.5 11.5124L10.8412 13.8511C11.9672 11.8821 13.5255 10.1945 15.3987 8.91536L15.5 8.84619" :stroke="color || 'currentColor'" stroke-width="2" fill="none"/>
  </svg>
</template>
 ...
 */
export default {
  name: 'PiAnnotationCheckDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
