 ...
 */
interface PiMessageAiDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageAiDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'message-ai icon',
  ...props
}: PiMessageAiDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M8.5 13.6748H8.501M12.5 6.6748C11.8625 8.29127 11.1609 9.01977 9.5 9.6748C11.1609 10.3298 11.8625 11.0583 12.5 12.6748C13.1375 11.0583 13.8391 10.3298 15.5 9.6748C13.8391 9.01976 13.1375 8.29127 12.5 6.6748Z" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
