<template>
  ...
  <path fill="currentColor" d="M9.287 17.342c.9-1.44 1.35-2.16 1.925-2.407a2 2 0 0 1 1.576 0c.576.247 1.026.967 1.926 2.407l.756 1.21c.5.799.75 1.198.723 1.528a1 1 0 0 1-.4.723c-.266.197-.737.197-1.68.197H9.887c-.942 0-1.413 0-1.679-.197a1 1 0 0 1-.4-.723c-.027-.33.223-.729.722-1.528z" opacity=".28"/>
  </svg>
</template>
