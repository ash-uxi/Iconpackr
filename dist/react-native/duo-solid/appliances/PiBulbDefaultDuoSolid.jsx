...
/**
 * Pibulbdefaultduosolid icon component for React Native
...
const Pibulbdefaultduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M12 12v4m0-4h1m-1 0h-1m-1 10h4" />{" "}
    <path
      fill={color || "#000"}
...
export default Pibulbdefaultduosolid;
