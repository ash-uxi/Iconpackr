...
/**
 * Picameraaicontrast icon component for React Native
...
const Picameraaicontrast = ({
  ...
  >
    ...
    <path
      fill={color}
      fillRule="evenodd"
      d="M18.96 6.574c-.468-.157-1.046-.157-2.203-.157-.216 0-.324 0-.424-.021a1 1 0 0 1-.5-.268c-.073-.072-.133-.161-.253-.341l-1.105-1.658c-.174-.26-.26-.39-.375-.485a1 1 0 0 0-.345-.184c-.142-.043-.298-.043-.611-.043h-2.288c-.313 0-.47 0-.611.043a1 1 0 0 0-.345.184c-.114.095-.201.225-.375.485L8.419 5.79c-.119.178-.178.266-.25.338a1 1 0 0 1-.504.27c-.1.02-.206.02-.42.02-1.144 0-1.717 0-2.179.154A3 3 0 0 0 3.17 8.467c-.154.462-.154 1.035-.154 2.18v4.97c0 1.68 0 2.52.327 3.162a3 3 0 0 0 1.31 1.31c.642.328 1.482.328 3.163.328H16.2c1.68 0 2.52 0 3.162-.327a3 3 0 0 0 1.311-1.311c.327-.642.327-1.482.327-3.162V10.66c0-1.157 0-1.736-.157-2.203a3 3 0 0 0-1.884-1.883"
      clipRule="evenodd"
      opacity={0.28}
    />
...
export default Picameraaicontrast;
