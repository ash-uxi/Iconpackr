...
/**
 * Picalendarexclamationmarkcontrast icon component for React Native
 ...
 */
const Picalendarexclamationmarkcontrast = ({
  color = "#000",
  size = 24,
...
export default Picalendarexclamationmarkcontrast;
