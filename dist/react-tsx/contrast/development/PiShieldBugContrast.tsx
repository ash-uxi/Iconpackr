 ...
 */
interface PiShieldBugContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiShieldBugContrast({
  ...
  ...props
}: PiShieldBugContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path fill="currentColor" d="m5.496 4.313 5.388-1.945a3 3 0 0 1 2.038 0l5.465 1.973a3 3 0 0 1 1.972 2.592l.227 2.95A11 11 0 0 1 14.858 20.4l-1.49.807a3 3 0 0 1-2.914-.032l-1.52-.867a11 11 0 0 1-5.544-9.979l.127-3.308a3 3 0 0 1 1.98-2.707" opacity=".28"/>
    </svg>
  );
}
