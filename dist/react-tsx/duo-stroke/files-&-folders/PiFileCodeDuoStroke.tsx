 ...
 */
interface PiFileCodeDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileCodeDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-code icon',
  ...props
}: PiFileCodeDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
