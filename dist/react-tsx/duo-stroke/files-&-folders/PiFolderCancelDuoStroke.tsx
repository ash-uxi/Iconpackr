 ...
 */
interface PiFolderCancelDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderCancelDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-cancel icon',
  ...props
}: PiFolderCancelDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M9.47461 16.4244L11.9495 13.9495M11.9495 13.9495L14.4244 11.4746M11.9495 13.9495L9.47461 11.4746M11.9495 13.9495L14.4244 16.4244" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
