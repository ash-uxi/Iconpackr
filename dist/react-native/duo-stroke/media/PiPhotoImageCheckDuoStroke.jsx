...
/**
 * Piphotoimagecheckduostroke icon component for React Native
 ...
 */
const Piphotoimagecheckduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    ...
    <path
      fillRule="evenodd"
      d="M22.826 15.936a1 1 0 0 1-.262 1.39 12.7 12.7 0 0 0-3.851 4.17 1 1 0 0 1-1.575.212l-2.135-2.133a1 1 0 1 1 1.414-1.415l1.25 1.25a14.7 14.7 0 0 1 3.769-3.736 1 1 0 0 1 1.39.262M5.5 8.5a2 2 0 1 1 4 0 2 2 0 0 1-4 0"
      clipRule="evenodd"
      fill="none"
    />
    <path
...
export default Piphotoimagecheckduostroke;
