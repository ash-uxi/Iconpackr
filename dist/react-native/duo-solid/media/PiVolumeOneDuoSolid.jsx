...
/**
 * Pivolumeoneduosolid icon component for React Native
...
const Pivolumeoneduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M18 14c.317-.263.569-.574.74-.918.172-.343.26-.71.26-1.082 0-.371-.088-.74-.26-1.082A2.9 2.9 0 0 0 18 10" />
  </Svg>
);

export default Pivolumeoneduosolid;
