...
/**
 * PiGrid02Stroke icon from the stroke style in general category.
 */
interface PiGrid02StrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiGrid02Stroke({
  size = 24,
  color,
  className,
  ariaLabel = 'grid-02 icon',
  ...props
}: PiGrid02StrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
