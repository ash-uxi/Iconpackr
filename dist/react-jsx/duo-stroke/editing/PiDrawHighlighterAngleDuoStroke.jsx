...
export default function PiDrawHighlighterAngleDuoStroke({ 
  ...
  <path d="M7.0707 12.9297L3.58579 16.4146C3.21071 16.7897 3 17.2984 3 17.8288L3 19.0004C3 19.5527 3.44772 20.0004 4 20.0004H11.5858C11.851 20.0004 12.1054 19.895 12.2929 19.7075L13.0707 18.9297" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
