...
/**
 * PiBusFrontViewBoltDuoStroke icon from the duo-stroke style in automotive category.
 */
interface PiBusFrontViewBoltDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBusFrontViewBoltDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'bus-front-view-bolt icon',
  ...props
}: PiBusFrontViewBoltDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
