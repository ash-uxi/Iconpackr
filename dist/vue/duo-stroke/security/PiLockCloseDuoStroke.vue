<template>
  <svg
    ...
    v-bind="$attrs"
  >
    <path  fill-rule="evenodd" d="M10.071 14c0-1.034.795-2 1.929-2s1.929.966 1.929 2a2.04 2.04 0 0 1-.93 1.714V17a1 1 0 1 1-2 0v-1.286A2.04 2.04 0 0 1 10.072 14" clip-rule="evenodd" fill="none"/>
