<script>
  ...
  export let ariaLabel = 'playlist-play icon';
</script>
...
>
  ...
  <path d="M9.48486 15.8393C9.48486 14.4075 9.48486 13.6915 9.78409 13.2919C10.0449 12.9435 10.444 12.7256 10.878 12.6946C11.376 12.6591 11.9782 13.0462 13.1827 13.8205L13.3445 13.9245C14.3896 14.5964 14.9122 14.9323 15.0927 15.3595C15.2504 15.7327 15.2504 16.1539 15.0927 16.5271C14.9122 16.9543 14.3896 17.2903 13.3445 17.9621L13.1827 18.0662C11.9782 18.8404 11.376 19.2276 10.878 19.192C10.444 19.161 10.0449 18.9431 9.78409 18.5948C9.48486 18.1951 9.48486 17.4792 9.48486 16.0473V15.8393Z" stroke={color || "currentColor"} stroke-width="2" fill="none"/>
</svg>
