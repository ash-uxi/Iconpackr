...
/**
 * PiFileStarContrast icon from the contrast style in files-&-folders category.
 */
interface PiFileStarContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileStarContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'file-star icon',
  ...props
}: PiFileStarContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
