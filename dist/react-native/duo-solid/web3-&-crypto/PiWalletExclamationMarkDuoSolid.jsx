...
/**
 * Piwalletexclamationmarkduosolid icon component for React Native
 ...
 */
const Piwalletexclamationmarkduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M20 19v-4m0 7.01V22m-6-10h3" />
  </Svg>
);

export default Piwalletexclamationmarkduosolid;
