...
/**
 * Pifolderarrowupstroke icon component for React Native
 ...
 */
const Pifolderarrowupstroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "folder arrow up icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pifolderarrowupstroke;
