...
/**
 * Picalendarfilledduosolid icon component for React Native
 ...
 */
const Picalendarfilledduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M20.96 10H3.041m4.97 4H8m.01 4H8m4.01-4H12m.01 4H12m4.01-4H16m.01 4H16M8 2v4m8-4v4" />
  </Svg>
);

export default Picalendarfilledduosolid;
