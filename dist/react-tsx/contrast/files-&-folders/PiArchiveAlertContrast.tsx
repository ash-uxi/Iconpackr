 ...
 */
interface PiArchiveAlertContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiArchiveAlertContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'archive-alert icon',
  ...props
}: PiArchiveAlertContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
