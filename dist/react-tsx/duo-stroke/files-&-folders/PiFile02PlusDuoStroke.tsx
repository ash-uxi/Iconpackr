 ...
 */
interface PiFile02PlusDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02PlusDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-plus icon',
  ...props
}: PiFile02PlusDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
