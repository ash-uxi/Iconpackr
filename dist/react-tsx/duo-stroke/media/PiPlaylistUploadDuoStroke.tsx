 ...
 */
interface PiPlaylistUploadDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistUploadDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'playlist-upload icon',
  ...props
}: PiPlaylistUploadDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M15 15.8115C14.2598 14.8245 13.401 13.9331 12.4436 13.1573C12.3141 13.0524 12.157 12.9999 12 12.9999M9 15.8115C9.74024 14.8245 10.599 13.9331 11.5564 13.1573C11.6859 13.0524 11.843 12.9999 12 12.9999M12 12.9999V19.0195" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
