...
/**
 * PiFolderCheckStroke icon from the stroke style in files-&-folders category.
 */
interface PiFolderCheckStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderCheckStroke({
  size = 24,
  color,
  className,
