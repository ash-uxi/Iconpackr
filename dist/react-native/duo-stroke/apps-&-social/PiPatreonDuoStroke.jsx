...
/**
 * Pipatreonduostroke icon component for React Native
...
const Pipatreonduostroke = ({
  ...
  >
    <path
      d="M2.87158 11.6164C2.91075 8.15888 3.96408 4.69222 7.31825 3.10972C10.0849 1.80472 13.9066 1.66888 16.8049 2.60638C19.1383 3.36138 21.1274 5.45472 21.1307 8.00805C21.1349 10.9497 19.2166 13.1706 16.4032 13.8672"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pipatreonduostroke;
