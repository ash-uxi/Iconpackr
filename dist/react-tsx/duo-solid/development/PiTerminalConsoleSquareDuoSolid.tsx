...
/**
 * PiTerminalConsoleSquareDuoSolid icon from the duo-solid style in development category.
 */
interface PiTerminalConsoleSquareDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiTerminalConsoleSquareDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'terminal-console-square icon',
  ...props
}: PiTerminalConsoleSquareDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
