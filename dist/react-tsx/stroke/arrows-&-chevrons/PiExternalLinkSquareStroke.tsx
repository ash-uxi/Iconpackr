...
/**
 * PiExternalLinkSquareStroke icon from the stroke style in arrows-&-chevrons category.
 */
interface PiExternalLinkSquareStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiExternalLinkSquareStroke({
  size = 24,
  color,
  className,
