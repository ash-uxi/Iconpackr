...
/**
 * PiBookmarkCancelDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiBookmarkCancelDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBookmarkCancelDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'bookmark-cancel icon',
  ...props
}: PiBookmarkCancelDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
