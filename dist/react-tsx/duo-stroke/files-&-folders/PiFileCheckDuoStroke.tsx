 ...
 */
interface PiFileCheckDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileCheckDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-check icon',
  ...props
}: PiFileCheckDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
