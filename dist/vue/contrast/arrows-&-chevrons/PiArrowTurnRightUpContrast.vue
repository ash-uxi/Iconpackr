<template>
  ...
  <path fill="currentColor" d="M20 8.859a25.2 25.2 0 0 0-4.505-4.684.79.79 0 0 0-.99 0A25.2 25.2 0 0 0 10 8.859c.935-.16 1.402-.241 1.87-.303a24 24 0 0 1 6.26 0c.468.062.935.142 1.87.303" opacity=".28"/>
  </svg>
</template>
 ...
 */
export default {
  name: 'PiArrowTurnRightUpContrast',
  props: {
    size: {
      type: Number,
      default: 24
