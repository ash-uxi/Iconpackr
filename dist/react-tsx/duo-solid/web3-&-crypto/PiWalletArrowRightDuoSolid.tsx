...
/**
 * PiWalletArrowRightDuoSolid icon from the duo-solid style in web3-&-crypto category.
 */
interface PiWalletArrowRightDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletArrowRightDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'wallet-arrow-right icon',
  ...props
}: PiWalletArrowRightDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
