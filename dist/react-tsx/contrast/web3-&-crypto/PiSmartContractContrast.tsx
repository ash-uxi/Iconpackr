...
/**
 * PiSmartContractContrast icon from the contrast style in web3-&-crypto category.
 */
interface PiSmartContractContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSmartContractContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'smart-contract icon',
  ...props
}: PiSmartContractContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
