...
/**
 * Piannotationremoveduostroke icon component for React Native
 ...
 */
const Piannotationremoveduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      fill="none"
    />
    <path d="M9 11H15" stroke={color || "#000"} strokeWidth="2" fill="none" />
  </Svg>
);

export default Piannotationremoveduostroke;
