...
export default function PiExchange02Solid({
  ...
  ...props
}: PiExchange02SolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
