...
/**
 * PiPencilEditDuoStroke icon from the duo-stroke style in general category.
 */
interface PiPencilEditDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPencilEditDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'pencil-edit icon',
  ...props
}: PiPencilEditDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M5.72665 21L3 20.9956L3.06616 18.3152M20.5014 7.22177C20.5328 7.19021 20.5485 7.17439 20.5621 7.16005C21.0615 6.63294 21.1426 5.83327 20.7594 5.21582C20.2733 4.43287 19.6 3.75099 18.8266 3.25131C18.2039 2.84896 17.3861 2.93708 16.8625 3.46297" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
