...
/**
 * Piycombinatorhackernewsstroke icon component for React Native
 ...
 */
const Piycombinatorhackernewsstroke = ({
  color = "#000",
  size = 24,
...
export default Piycombinatorhackernewsstroke;
