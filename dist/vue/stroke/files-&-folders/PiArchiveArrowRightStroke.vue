<template>
  <svg
    ...
    v-bind="$attrs"
  >
    <path d="M12.59 17.0707C13.4354 16.4369 14.1995 15.7014 14.865 14.8807C14.9525 14.773 15.0002 14.6385 15 14.4997M15 14.4997C15 14.3647 14.955 14.2307 14.865 14.1187C14.2 13.2987 13.436 12.5627 12.59 11.9287M15 14.4997H9" stroke="currentColor" stroke-width="2" fill="none"/>
 ...
 */
export default {
  name: 'PiArchiveArrowRightStroke',
  props: {
    size: {
      type: Number,
      default: 24
