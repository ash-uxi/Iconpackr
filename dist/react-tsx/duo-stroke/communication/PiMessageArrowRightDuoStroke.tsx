 ...
 */
interface PiMessageArrowRightDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageArrowRightDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'message-arrow-right icon',
  ...props
}: PiMessageArrowRightDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
