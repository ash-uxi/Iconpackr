...
/**
 * PiPhonePlusDuoSolid icon from the duo-solid style in communication category.
 */
interface PiPhonePlusDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhonePlusDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'phone-plus icon',
  ...props
}: PiPhonePlusDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
