...
/**
 * PiWalletCheckDuoSolid icon from the duo-solid style in web3-&-crypto category.
 */
interface PiWalletCheckDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletCheckDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'wallet-check icon',
  ...props
}: PiWalletCheckDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
