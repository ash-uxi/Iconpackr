...
/**
 * PiCameraRemoveStroke icon from the stroke style in devices category.
 */
interface PiCameraRemoveStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCameraRemoveStroke({
  size = 24,
  color,
  className,
  ...
  <path d="M9.5 15.5098L12 13.0098M12 13.0098L14.5 10.5098M12 13.0098L9.5 10.5098M12 13.0098L14.5 15.5098" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
