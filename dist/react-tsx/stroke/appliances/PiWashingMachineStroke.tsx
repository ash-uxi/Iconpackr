...
/**
 * PiWashingMachineStroke icon from the stroke style in appliances category.
 */
interface PiWashingMachineStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWashingMachineStroke({
  size = 24,
  color,
  className,
