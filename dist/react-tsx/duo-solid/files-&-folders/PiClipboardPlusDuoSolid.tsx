...
/**
 * PiClipboardPlusDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiClipboardPlusDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardPlusDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'clipboard-plus icon',
  ...props
}: PiClipboardPlusDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
