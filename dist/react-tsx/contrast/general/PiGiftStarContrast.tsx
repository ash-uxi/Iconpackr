...
/**
 * PiGiftStarContrast icon from the contrast style in general category.
 */
interface PiGiftStarContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiGiftStarContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'gift-star icon',
  ...props
}: PiGiftStarContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
