...
/**
 * Pifilepngformatstroke icon component for React Native
 ...
 */
const Pifilepngformatstroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "file png format icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pifilepngformatstroke;
