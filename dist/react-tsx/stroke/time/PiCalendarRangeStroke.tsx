...
/**
 * PiCalendarRangeStroke icon from the stroke style in time category.
 */
interface PiCalendarRangeStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarRangeStroke({
  size = 24,
  color,
  className,
