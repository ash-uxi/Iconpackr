...
/**
 * Piinformationtriangleduosolid icon component for React Native
 ...
 */
const Piinformationtriangleduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M12 12.376v4m0-7.375z" />
  </Svg>
);

export default Piinformationtriangleduosolid;
