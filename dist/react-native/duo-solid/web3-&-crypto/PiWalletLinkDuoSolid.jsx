...
/**
 * Piwalletlinkduosolid icon component for React Native
...
const Piwalletlinkduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M18.965 17h.037A3 3 0 0 1 22 20c0 1.657-1.342 3-2.998 3h-.037m-3.93-6h-.037A3 3 0 0 0 12 20c0 1.657 1.342 3 2.998 3h.037m.962-3h1.999M14 12h3" />{" "}
    <path
      fill={color || "#000"}
...
export default Piwalletlinkduosolid;
