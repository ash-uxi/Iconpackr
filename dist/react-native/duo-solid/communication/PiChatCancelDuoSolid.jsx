...
/**
 * Pichatcancelduosolid icon component for React Native
...
const Pichatcancelduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M9.5 14.5 12 12m0 0 2.5-2.5M12 12 9.5 9.5M12 12l2.5 2.5" />
  </Svg>
);

export default Pichatcancelduosolid;
