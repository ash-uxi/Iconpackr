 ...
 */
interface PiFolderRemoveDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderRemoveDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-remove icon',
  ...props
}: PiFolderRemoveDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
