 ...
 */
interface PiFolderArrowRightDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowRightDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-right icon',
  ...props
}: PiFolderArrowRightDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M9 14H15M15 14C15 14.1047 14.965 14.2094 14.8951 14.2957C14.3779 14.934 13.7836 15.5065 13.1256 16M15 14C15 13.8953 14.965 13.7906 14.8951 13.7043C14.3779 13.066 13.7836 12.4935 13.1256 12" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
