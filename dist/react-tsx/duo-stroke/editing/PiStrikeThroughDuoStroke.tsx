...
export default function PiStrikeThroughDuoStroke({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 12C14.2712 12 17 12.4351 17 15.8679C17 20.9381 8.33063 21.3742 7.14564 17M7 8.13207C7 3.06192 15.6694 2.62579 16.8544 7" stroke={color || "currentColor"} strokeWidth="2" opacity="0.28" fill="none"/>
  <path d="M21 12H3" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
