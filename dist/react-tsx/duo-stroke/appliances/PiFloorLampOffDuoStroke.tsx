...
export default function PiFloorLampOffDuoStroke({
  ...
  <path d="M7.93668 4.35135C8.21384 3.54297 8.974 3 9.82857 3H14.1714C15.026 3 15.7862 3.54297 16.0633 4.35135L18 10H6L7.93668 4.35135Z" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
