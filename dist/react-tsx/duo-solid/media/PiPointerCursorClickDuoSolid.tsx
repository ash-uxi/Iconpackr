...
/**
 * PiPointerCursorClickDuoSolid icon from the duo-solid style in media category.
 */
interface PiPointerCursorClickDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPointerCursorClickDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'pointer-cursor-click icon',
  ...props
}: PiPointerCursorClickDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
