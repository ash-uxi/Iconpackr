...
/**
 * Pimultiplecrosscancelsquareduosolid icon component for React Native
 ...
 */
const Pimultiplecrosscancelsquareduosolid = ({
  color = "#000",
  size = 24,
...
export default Pimultiplecrosscancelsquareduosolid;
