...
/**
 * PiCalendarPlusContrast icon from the contrast style in time category.
 */
interface PiCalendarPlusContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarPlusContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'calendar-plus icon',
  ...props
}: PiCalendarPlusContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
