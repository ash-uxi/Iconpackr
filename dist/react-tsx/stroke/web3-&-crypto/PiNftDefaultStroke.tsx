...
/**
 * PiNftDefaultStroke icon from the stroke style in web3-&-crypto category.
 */
interface PiNftDefaultStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiNftDefaultStroke({
  size = 24,
  color,
  className,
