...
/**
 * PiCopyCopiedStroke icon from the stroke style in general category.
 */
interface PiCopyCopiedStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCopyCopiedStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'copy-copied icon',
  ...props
}: PiCopyCopiedStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
