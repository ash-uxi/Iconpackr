...
/**
 * Pimultiplecrosscancelcirclesolid icon component for React Native
 ...
 */
const Pimultiplecrosscancelcirclesolid = ({
  color = "#000",
  size = 24,
...
export default Pimultiplecrosscancelcirclesolid;
