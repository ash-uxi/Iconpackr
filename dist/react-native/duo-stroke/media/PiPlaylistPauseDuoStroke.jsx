...
/**
 * Piplaylistpauseduostroke icon component for React Native
 ...
 */
const Piplaylistpauseduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "playlist pause icon",
  style,
  ...props
}) => (
  <Svg
...
export default Piplaylistpauseduostroke;
