 ...
 */
export default {
  name: 'PiLightningThunderElectricOnDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'lightning-thunder-electric-on icon'
    }
  }
}
</script>
