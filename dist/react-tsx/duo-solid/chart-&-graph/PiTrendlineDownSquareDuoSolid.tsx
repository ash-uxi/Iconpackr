...
/**
 * PiTrendlineDownSquareDuoSolid icon from the duo-solid style in chart-&-graph category.
 */
interface PiTrendlineDownSquareDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiTrendlineDownSquareDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'trendline-down-square icon',
  ...props
}: PiTrendlineDownSquareDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
