...
/**
 * Piuserspeakingduostroke icon component for React Native
...
const Piuserspeakingduostroke = ({
  ...
  >
    <path
      d="M15 15H7C4.79086 15 3 16.7909 3 19C3 20.1046 3.89543 21 5 21H17C18.1046 21 19 20.1046 19 19C19 16.7909 17.2091 15 15 15Z"
      stroke={color || "#000"}
      strokeWidth="2"
      opacity={0.28}
      fill="none"
...
export default Piuserspeakingduostroke;
