...
/**
 * Pifolderquestionmarkduostroke icon component for React Native
 ...
 */
const Pifolderquestionmarkduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "folder question mark icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    ...
    />
    <path
      d="M9.8501 11.5022C10.0263 11.0014 10.3741 10.579 10.8318 10.31C11.2896 10.0409 11.8278 9.9426 12.3511 10.0324C12.8744 10.1221 13.3491 10.3942 13.691 10.8004C14.033 11.2066 14.2201 11.7207 14.2193 12.2517C14.2193 13.7506 11.971 14.5 11.971 14.5M12.0001 17.5H12.0101"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pifolderquestionmarkduostroke;
