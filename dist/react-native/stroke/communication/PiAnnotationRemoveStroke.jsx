...
/**
 * Piannotationremovestroke icon component for React Native
 ...
 */
const Piannotationremovestroke = ({
  color = "#000",
  size = 24,
...
export default Piannotationremovestroke;
