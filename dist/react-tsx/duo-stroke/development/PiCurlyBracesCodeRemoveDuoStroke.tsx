 ...
 */
interface PiCurlyBracesCodeRemoveDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCurlyBracesCodeRemoveDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'curly-braces-code-remove icon',
  ...props
}: PiCurlyBracesCodeRemoveDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
