...
/**
 * PiMessageArrowUpStroke icon from the stroke style in communication category.
 */
interface PiMessageArrowUpStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageArrowUpStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'message-arrow-up icon',
  ...props
}: PiMessageArrowUpStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M15 9.81243C14.2598 8.82544 13.401 7.93411 12.4436 7.15828C12.3141 7.05335 12.157 7.00089 12 7.00089M9 9.81243C9.74024 8.82544 10.599 7.93411 11.5564 7.15829C11.6859 7.05336 11.843 7.00089 12 7.00089M12 7.00089V13.0205" stroke="currentColor" strokeWidth="2" fill="none"/>
