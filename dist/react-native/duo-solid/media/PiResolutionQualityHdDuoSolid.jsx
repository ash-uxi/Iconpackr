...
/**
 * Piresolutionqualityhdduosolid icon component for React Native
 ...
 */
const Piresolutionqualityhdduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M6.754 8.75v3.5m0 0h3.5m-3.5 0v3m3.5-3v-3.5m0 3.5v3m3.5-6.5h.3c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874c.218.428.218.988.218 2.108v.1c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874c-.428.218-.988.218-2.108.218h-.3z" />{" "}
    <path
      fill={color || "#000"}
...
export default Piresolutionqualityhdduosolid;
