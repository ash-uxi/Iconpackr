...
export default function PiPlaylistUserStroke({ 
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M13 13.6895C13 14.2417 12.5523 14.6895 12 14.6895C11.4477 14.6895 11 14.2417 11 13.6895C11 13.1372 11.4477 12.6895 12 12.6895C12.5523 12.6895 13 13.1372 13 13.6895Z" stroke="currentColor" strokeWidth="2" fill="none"/>
  <path d="M13.25 17.1182H10.75C10.0596 17.1182 9.5 17.6778 9.5 18.3682C9.5 18.7133 9.77982 18.9932 10.125 18.9932H13.875C14.2202 18.9932 14.5 18.7133 14.5 18.3682C14.5 17.6778 13.9404 17.1182 13.25 17.1182Z" stroke="currentColor" strokeWidth="2" fill="none"/>
