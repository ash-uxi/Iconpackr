...
/**
 * Piusercircledottedstroke icon component for React Native
 ...
 */
const Piusercircledottedstroke = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M12 2H12.01" stroke={color} strokeWidth="2" fill="none" />
    <path
    ...
    <path
      ...
      fill="none"
    />
    <path d="M2 12H2.01" stroke={color} strokeWidth="2" fill="none" />
    <path
    ...
    <path
      ...
      fill="none"
    />
    <path d="M22 12H22.01" stroke={color} strokeWidth="2" fill="none" />
    <path
...
export default Piusercircledottedstroke;
