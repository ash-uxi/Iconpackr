...
/**
 * PiCalendarRemoveContrast icon from the contrast style in time category.
 */
interface PiCalendarRemoveContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarRemoveContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'calendar-remove icon',
  ...props
}: PiCalendarRemoveContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
