...
/**
 * PiPlaylistAddStroke icon from the stroke style in media category.
 */
interface PiPlaylistAddStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistAddStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'playlist-add icon',
  ...props
}: PiPlaylistAddStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12 19V16M12 16V13M12 16H9M12 16H15" stroke="currentColor" strokeWidth="2" fill="none"/>
