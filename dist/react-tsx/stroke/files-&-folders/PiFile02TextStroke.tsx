...
/**
 * PiFile02TextStroke icon from the stroke style in files-&-folders category.
 */
interface PiFile02TextStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02TextStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-text icon',
  ...props
}: PiFile02TextStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
