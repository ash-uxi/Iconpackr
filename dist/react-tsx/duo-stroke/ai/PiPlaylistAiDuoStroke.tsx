...
export default function PiPlaylistAiDuoStroke({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12.2998 12.9844C12.9373 14.6008 13.6389 15.3293 15.2998 15.9844C13.6389 16.6394 12.9373 17.3679 12.2998 18.9844C11.6623 17.3679 10.9607 16.6394 9.2998 15.9844C10.9607 15.3293 11.6623 14.6008 12.2998 12.9844Z" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
  ...
  <path d="M8.7002 19.3232H8.7012" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
