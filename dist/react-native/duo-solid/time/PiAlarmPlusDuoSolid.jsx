...
/**
 * Pialarmplusduosolid icon component for React Native
...
const Pialarmplusduosolid = ({
  ...
  >
    ...
    />{" "}
    <path
      d="M12.9999 9.90002C12.9999 9.34774 12.5522 8.90002 11.9999 8.90002C11.4476 8.90002 10.9999 9.34774 10.9999 9.90002V12H8.8999C8.34762 12 7.8999 12.4477 7.8999 13C7.8999 13.5523 8.34762 14 8.8999 14H10.9999V16.1C10.9999 16.6523 11.4476 17.1 11.9999 17.1C12.5522 17.1 12.9999 16.6523 12.9999 16.1V14H15.0999C15.6522 14 16.0999 13.5523 16.0999 13C16.0999 12.4477 15.6522 12 15.0999 12H12.9999V9.90002Z"
      fill={color || "#000"}
    />{" "}
    <path
...
export default Pialarmplusduosolid;
