...
/**
 * PiBatteryTwoCellDuoSolid icon from the duo-solid style in devices category.
 */
interface PiBatteryTwoCellDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBatteryTwoCellDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'battery-two-cell icon',
  ...props
}: PiBatteryTwoCellDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
