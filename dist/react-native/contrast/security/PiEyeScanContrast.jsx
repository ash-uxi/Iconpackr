...
/**
 * Pieyescancontrast icon component for React Native
...
const Pieyescancontrast = ({
  ...
  >
    ...
    <path
      fill={color}
      d="M18 12c0 1.143-2.333 4-6 4s-6-2.857-6-4 2.333-4 6-4 6 2.857 6 4"
      opacity={0.28}
    />
  </Svg>
);

export default Pieyescancontrast;
