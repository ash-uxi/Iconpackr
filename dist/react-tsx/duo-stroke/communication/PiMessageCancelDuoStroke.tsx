 ...
 */
interface PiMessageCancelDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageCancelDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'message-cancel icon',
  ...props
}: PiMessageCancelDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M9.52515 12.4527L12 9.9778M12 9.9778L14.4749 7.50293M12 9.9778L9.52515 7.50293M12 9.9778L14.4749 12.4527" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
