 ...
 */
interface PiRssSquareDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiRssSquareDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'rss-square icon',
  ...props
}: PiRssSquareDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
