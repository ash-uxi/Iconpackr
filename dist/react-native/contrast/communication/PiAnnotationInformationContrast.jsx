...
/**
 * Piannotationinformationcontrast icon component for React Native
 ...
 */
const Piannotationinformationcontrast = ({
  color = "#000",
  size = 24,
...
export default Piannotationinformationcontrast;
