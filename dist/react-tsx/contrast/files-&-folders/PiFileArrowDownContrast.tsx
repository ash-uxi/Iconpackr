...
/**
 * PiFileArrowDownContrast icon from the contrast style in files-&-folders category.
 */
interface PiFileArrowDownContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowDownContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-down icon',
  ...props
}: PiFileArrowDownContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
