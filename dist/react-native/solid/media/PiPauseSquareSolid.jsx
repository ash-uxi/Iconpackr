...
/**
 * Pipausesquaresolid icon component for React Native
 ...
 */
const Pipausesquaresolid = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "pause square icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pipausesquaresolid;
