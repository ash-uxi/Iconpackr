...
/**
 * Piminimizefourlinearrowduosolid icon component for React Native
 ...
 */
const Piminimizefourlinearrowduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      fill={color || "#000"}
      d="M14.254 3.835a18.3 18.3 0 0 0-.177 4.713 1.52 1.52 0 0 0 1.375 1.375c1.563.145 3.147.085 4.713-.177a1 1 0 0 0 .476-1.754l-.948-.793A23 23 0 0 1 16.8 4.307l-.793-.948a1 1 0 0 0-1.754.476"
    />{" "}
    <path
