...
/**
 * Pipencilscalecrossduostroke icon component for React Native
 ...
 */
const Pipencilscalecrossduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "pencil scale cross icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pipencilscalecrossduostroke;
