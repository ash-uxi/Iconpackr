 ...
 */
interface PiUserGraduationHatStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiUserGraduationHatStroke({
  ...
  ...props
}: PiUserGraduationHatStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
