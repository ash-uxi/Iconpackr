...
/**
 * Pithreedotsmenuverticalstroke icon component for React Native
 ...
 */
const Pithreedotsmenuverticalstroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "three dots menu vertical icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pithreedotsmenuverticalstroke;
