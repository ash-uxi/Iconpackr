 ...
 */
interface PiQuestionMarkSquareDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiQuestionMarkSquareDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'question-mark-square icon',
  ...props
}: PiQuestionMarkSquareDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12 11.6881V15.6881M12 8.31314V8.31201" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
