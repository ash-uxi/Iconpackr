...
/**
 * PiCalendarExclamationMarkStroke icon from the stroke style in time category.
 */
interface PiCalendarExclamationMarkStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarExclamationMarkStroke({
  size = 24,
  color,
  className,
