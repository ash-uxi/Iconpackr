<template>
  ...
  <path d="M6.75391 8.75V12.25H10.2539M10.2539 12.25V8.75M10.2539 12.25V15.25M13.7538 11.75V8.75M13.7538 11.75V15.25M13.7538 11.75L17.2537 8.75M13.7538 11.75L17.2537 15.25" :stroke="color || 'currentColor'" stroke-width="2" fill="none"/>
  </svg>
</template>
 ...
 */
export default {
  name: 'PiResolutionQuality4kDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'resolution-quality-4k icon'
    }
  }
}
</script>
