...
export default function PiNoteOutlineAiDuoStroke({
  ...
  <path d="M21 11.53V8.8C21 8.50929 21 8.24373 20.9983 8M11.9947 20H7.8C6.11984 20 5.27976 20 4.63803 19.673C4.07354 19.3854 3.6146 18.9265 3.32698 18.362C3 17.7202 3 16.8802 3 15.2V8.8C3 8.50929 3 8.24373 3.00169 8" stroke={color || "currentColor"} strokeWidth="2" opacity="0.28" fill="none"/>
    </svg>
  );
}
