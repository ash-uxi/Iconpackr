...
/**
 * PiRssSquareDuoSolid icon from the duo-solid style in apps-&-social category.
 */
interface PiRssSquareDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiRssSquareDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'rss-square icon',
  ...props
}: PiRssSquareDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
