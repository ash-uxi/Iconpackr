...
/**
 * Pipresentationbargraphduostroke icon component for React Native
 ...
 */
const Pipresentationbargraphduostroke = ({
  color = "#000",
  size = 24,
...
export default Pipresentationbargraphduostroke;
