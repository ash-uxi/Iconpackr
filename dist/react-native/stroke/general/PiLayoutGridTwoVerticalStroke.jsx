...
/**
 * Pilayoutgridtwoverticalstroke icon component for React Native
 ...
 */
const Pilayoutgridtwoverticalstroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "layout grid two vertical icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pilayoutgridtwoverticalstroke;
