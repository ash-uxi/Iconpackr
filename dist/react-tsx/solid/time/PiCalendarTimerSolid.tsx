...
/**
 * PiCalendarTimerSolid icon from the solid style in time category.
 */
interface PiCalendarTimerSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarTimerSolid({
  size = 24,
  color,
  className,
