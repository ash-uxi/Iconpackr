...
/**
 * Pichocolatebarsolid icon component for React Native
...
const Pichocolatebarsolid = ({
  ...
  >
    ...
    <path
      ...
      stroke="none"
    />
    <path d="M20 14.1001V9.90012H12.9V14.1001H20Z" fill={color} stroke="none" />
    <path
    ...
    <path
      ...
      stroke="none"
    />
    <path d="M4 9.90012V14.1001H11.1V9.90012H4Z" fill={color} stroke="none" />
  </Svg>
);

export default Pichocolatebarsolid;
