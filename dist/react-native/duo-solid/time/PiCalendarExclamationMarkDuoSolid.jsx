...
/**
 * Picalendarexclamationmarkduosolid icon component for React Native
 ...
 */
const Picalendarexclamationmarkduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M8 2v4m8-4v4m-4 8v-4m0 7.375v.001" />
  </Svg>
);

export default Picalendarexclamationmarkduosolid;
