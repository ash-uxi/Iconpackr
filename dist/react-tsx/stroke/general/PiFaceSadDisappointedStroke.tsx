 ...
 */
interface PiFaceSadDisappointedStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFaceSadDisappointedStroke({
  ...
  ...props
}: PiFaceSadDisappointedStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
