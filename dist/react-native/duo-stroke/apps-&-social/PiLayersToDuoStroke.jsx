...
/**
 * Pilayerstoduostroke icon component for React Native
...
const Pilayerstoduostroke = ({
  ...
  >
    <path
      d="M11.4151 9.16021C10.1045 9.42021 9.15514 10.5827 9.14639 11.9402L9.09576 19.4405C9.0847 21.2422 10.6996 22.6039 12.4395 22.2589L19.6814 20.8233C20.992 20.5639 21.9414 19.4008 21.9501 18.0433L22.0001 10.5433C22.012 8.74146 20.397 7.37959 18.657 7.72459L11.4151 9.16021Z"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pilayerstoduostroke;
