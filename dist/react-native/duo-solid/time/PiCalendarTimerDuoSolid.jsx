...
/**
 * Picalendartimerduosolid icon component for React Native
...
const Picalendartimerduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M8 2v4m8-4v4m-4 4.896V15l2.117 1.059" />
  </Svg>
);

export default Picalendartimerduosolid;
