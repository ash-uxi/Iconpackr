...
/**
 * PiFileBoltContrast icon from the contrast style in files-&-folders category.
 */
interface PiFileBoltContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileBoltContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'file-bolt icon',
  ...props
}: PiFileBoltContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
