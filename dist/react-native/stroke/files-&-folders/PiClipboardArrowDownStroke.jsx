...
/**
 * Piclipboardarrowdownstroke icon component for React Native
 ...
 */
const Piclipboardarrowdownstroke = ({
  color = "#000",
  size = 24,
...
export default Piclipboardarrowdownstroke;
