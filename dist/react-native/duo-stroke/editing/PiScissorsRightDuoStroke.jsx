...
/**
 * Piscissorsrightduostroke icon component for React Native
 ...
 */
const Piscissorsrightduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "scissors right icon",
  style,
  ...props
}) => (
  <Svg
...
export default Piscissorsrightduostroke;
