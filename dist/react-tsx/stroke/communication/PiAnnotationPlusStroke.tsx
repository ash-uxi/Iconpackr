...
/**
 * PiAnnotationPlusStroke icon from the stroke style in communication category.
 */
interface PiAnnotationPlusStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationPlusStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'annotation-plus icon',
  ...props
}: PiAnnotationPlusStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
