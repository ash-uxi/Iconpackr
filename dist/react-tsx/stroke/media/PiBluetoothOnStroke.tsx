...
/**
 * PiBluetoothOnStroke icon from the stroke style in media category.
 */
interface PiBluetoothOnStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBluetoothOnStroke({
  size = 24,
  color,
  className,
