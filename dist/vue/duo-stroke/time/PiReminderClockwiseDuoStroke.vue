 ...
 */
export default {
  name: 'PiReminderClockwiseDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'reminder-clockwise icon'
    }
  }
}
</script>
