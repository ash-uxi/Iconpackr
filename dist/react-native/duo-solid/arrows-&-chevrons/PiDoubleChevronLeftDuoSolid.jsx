...
/**
 * Pidoublechevronleftduosolid icon component for React Native
 ...
 */
const Pidoublechevronleftduosolid = ({
  color = "#000",
  size = 24,
...
export default Pidoublechevronleftduosolid;
