...
/**
 * Piarrowbigdownduosolid icon component for React Native
...
const Piarrowbigdownduosolid = ({
  ...
  >
    <path
      d="M15.999 4.601V4.57C15.999 4.318 15.999 4.072 15.982 3.864C15.9667 3.59654 15.8984 3.3348 15.781 3.094C15.5893 2.71769 15.2833 2.41174 14.907 2.22C14.6661 2.103 14.4044 2.03502 14.137 2.02C13.929 2 13.683 2 13.431 2H10.567C10.315 2 10.069 2 9.86102 2.017C9.59358 2.03233 9.33184 2.10065 9.09102 2.218C8.71472 2.40974 8.40877 2.71569 8.21702 3.092C8.09968 3.33282 8.03136 3.59455 8.01602 3.862C7.99902 4.07 7.99902 4.316 7.99902 4.568V14.527C7.9987 14.7838 8.09717 15.0308 8.27402 15.217C8.45088 15.4032 8.69257 15.5142 8.94902 15.527C10.981 15.627 13.017 15.627 15.049 15.527C15.3055 15.5142 15.5472 15.4032 15.724 15.217C15.9009 15.0308 15.9993 14.7838 15.999 14.527V4.601Z"
      fill={color || "#000"}
      opacity={0.28}
      fillRule="evenodd"
      clipRule="evenodd"
...
export default Piarrowbigdownduosolid;
