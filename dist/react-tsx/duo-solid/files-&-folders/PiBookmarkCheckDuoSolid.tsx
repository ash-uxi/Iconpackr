...
/**
 * PiBookmarkCheckDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiBookmarkCheckDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBookmarkCheckDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'bookmark-check icon',
  ...props
}: PiBookmarkCheckDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
