...
/**
 * PiCarFrontViewBoltStroke icon from the stroke style in automotive category.
 */
interface PiCarFrontViewBoltStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCarFrontViewBoltStroke({
  size = 24,
  color,
  className,
