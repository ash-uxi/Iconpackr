...
/**
 * Pifolderarrowupduostroke icon component for React Native
 ...
 */
const Pifolderarrowupduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      d="M12 17V11M12 11C11.8953 11 11.7906 11.035 11.7043 11.1049C11.066 11.6221 10.4935 12.2164 10 12.8744M12 11C12.1047 11 12.2094 11.035 12.2957 11.1049C12.934 11.6221 13.5065 12.2164 14 12.8744"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pifolderarrowupduostroke;
