...
/**
 * PiPackage02Stroke icon from the stroke style in development category.
 */
interface PiPackage02StrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPackage02Stroke({
  size = 24,
  color,
  className,
  ariaLabel = 'package-02 icon',
  ...props
}: PiPackage02StrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
