...
/**
 * Piai03contrast icon component for React Native
 ...
 */
const Piai03contrast = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "ai03 icon",
  style,
  ...props
}) => (
  <Svg
