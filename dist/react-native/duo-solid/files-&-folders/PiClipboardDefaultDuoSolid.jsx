...
/**
 * Piclipboarddefaultduosolid icon component for React Native
 ...
 */
const Piclipboarddefaultduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M8 4c0-.465 0-.697.051-.888a1.5 1.5 0 0 1 1.06-1.06C9.304 2 9.536 2 10 2h4c.465 0 .697 0 .888.051a1.5 1.5 0 0 1 1.06 1.06C16 3.304 16 3.536 16 4v.038c0 .44-.001.665-.051.85a1.5 1.5 0 0 1-1.06 1.06C14.697 6 14.464 6 14 6h-4c-.465 0-.697 0-.888-.051a1.5 1.5 0 0 1-1.06-1.06C8.001 4.702 8 4.477 8 4.038z" />
  </Svg>
);

export default Piclipboarddefaultduosolid;
