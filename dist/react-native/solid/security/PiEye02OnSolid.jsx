...
/**
 * Pieye02onsolid icon component for React Native
...
const Pieye02onsolid = ({
  ...
  >
    <path
      d="M12 10.5C10.067 10.5 8.5 12.067 8.5 14C8.5 15.933 10.067 17.5 12 17.5C13.933 17.5 15.5 15.933 15.5 14C15.5 12.067 13.933 10.5 12 10.5Z"
      fill={color}
      stroke="none"
    />
    <path
