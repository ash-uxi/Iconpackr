...
/**
 * Picloudarrowdownloadduostroke icon component for React Native
 ...
 */
const Picloudarrowdownloadduostroke = ({
  color = "#000",
  size = 24,
...
export default Picloudarrowdownloadduostroke;
