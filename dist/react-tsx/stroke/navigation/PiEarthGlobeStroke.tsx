...
/**
 * PiEarthGlobeStroke icon from the stroke style in navigation category.
 */
interface PiEarthGlobeStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiEarthGlobeStroke({
  size = 24,
  color,
  className,
