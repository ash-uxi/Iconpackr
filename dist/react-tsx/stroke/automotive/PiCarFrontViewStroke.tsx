...
/**
 * PiCarFrontViewStroke icon from the stroke style in automotive category.
 */
interface PiCarFrontViewStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCarFrontViewStroke({
  size = 24,
  color,
  className,
