...
/**
 * PiAnnotationExclamationDuoSolid icon from the duo-solid style in communication category.
 */
interface PiAnnotationExclamationDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationExclamationDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'annotation-exclamation icon',
  ...props
}: PiAnnotationExclamationDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
