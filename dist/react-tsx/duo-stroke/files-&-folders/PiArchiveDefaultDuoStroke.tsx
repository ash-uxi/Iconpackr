 ...
 */
interface PiArchiveDefaultDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiArchiveDefaultDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'archive-default icon',
  ...props
}: PiArchiveDefaultDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M10 12H14" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
