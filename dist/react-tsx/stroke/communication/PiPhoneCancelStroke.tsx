...
/**
 * PiPhoneCancelStroke icon from the stroke style in communication category.
 */
interface PiPhoneCancelStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhoneCancelStroke({
  size = 24,
  color,
  className,
