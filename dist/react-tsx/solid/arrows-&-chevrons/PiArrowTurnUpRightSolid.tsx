...
/**
 * PiArrowTurnUpRightSolid icon from the solid style in arrows-&-chevrons category.
 */
interface PiArrowTurnUpRightSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiArrowTurnUpRightSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'arrow-turn-up-right icon',
  ...props
}: PiArrowTurnUpRightSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
