<template>
  ...
  <path  fill-rule="evenodd" d="M22.642 20.008a1.6 1.6 0 0 0 0-2.02 13.9 13.9 0 0 0-2.452-2.36 1 1 0 0 0-1.2 1.6q.483.361.927.77H16a1 1 0 0 0 0 2h3.916q-.443.41-.926.772a1 1 0 1 0 1.2 1.6 13.9 13.9 0 0 0 2.452-2.362M5.5 8.5a2 2 0 1 1 4 0 2 2 0 0 1-4 0" clip-rule="evenodd" fill="none"/>
 ...
 */
export default {
  name: 'PiPhotoImageArrowRightDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
