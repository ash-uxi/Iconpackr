...
/**
 * Piphoneoutgoingduostroke icon component for React Native
 ...
 */
const Piphoneoutgoingduostroke = ({
  color = "#000",
  size = 24,
...
export default Piphoneoutgoingduostroke;
