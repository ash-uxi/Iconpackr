...
/**
 * Pibatteryonecellduostroke icon component for React Native
 ...
 */
const Pibatteryonecellduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      fill="none"
    />
    <path d="M6 10V14" stroke={color || "#000"} strokeWidth="2" fill="none" />
  </Svg>
);

export default Pibatteryonecellduostroke;
