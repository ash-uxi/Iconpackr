...
/**
 * Pibatterythreecellduostroke icon component for React Native
 ...
 */
const Pibatterythreecellduostroke = ({
  color = "#000",
  size = 24,
...
export default Pibatterythreecellduostroke;
