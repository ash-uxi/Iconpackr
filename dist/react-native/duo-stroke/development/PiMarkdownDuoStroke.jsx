...
/**
 * Pimarkdownduostroke icon component for React Native
 ...
 */
const Pimarkdownduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "markdown icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    ...
    />
    <path
      d="M6 15V9L8.5 12L11 9V15M14 13.1256C14.4935 13.7836 15.066 14.3779 15.7043 14.8951C15.7906 14.965 15.8953 15 16 15M18 13.1256C17.5065 13.7836 16.934 14.3779 16.2957 14.8951C16.2094 14.965 16.1047 15 16 15M16 15V9"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pimarkdownduostroke;
