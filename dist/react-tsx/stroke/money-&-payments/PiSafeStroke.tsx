...
/**
 * PiSafeStroke icon from the stroke style in money-&-payments category.
 */
interface PiSafeStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSafeStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'safe icon',
