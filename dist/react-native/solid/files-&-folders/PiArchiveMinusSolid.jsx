...
/**
 * Piarchiveminussolid icon component for React Native
 ...
 */
const Piarchiveminussolid = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "archive minus icon",
  style,
  ...props
}) => (
  <Svg
...
export default Piarchiveminussolid;
