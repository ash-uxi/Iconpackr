...
/**
 * PiFolderArrowUpContrast icon from the contrast style in files-&-folders category.
 */
interface PiFolderArrowUpContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowUpContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-up icon',
  ...props
}: PiFolderArrowUpContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
