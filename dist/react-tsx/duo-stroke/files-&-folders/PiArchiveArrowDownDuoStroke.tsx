...
export default function PiArchiveArrowDownDuoStroke({
  ...
  <path d="M9.42896 15.09C10.063 15.936 10.799 16.7 11.619 17.365C11.731 17.455 11.865 17.5 12 17.5M12 17.5C12.1387 17.5002 12.2733 17.4525 12.381 17.365C13.2016 16.6995 13.9372 15.9354 14.571 15.09M12 17.5V11.5" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
