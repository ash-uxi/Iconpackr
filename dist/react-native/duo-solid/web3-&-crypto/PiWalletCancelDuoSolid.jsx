...
/**
 * Piwalletcancelduosolid icon component for React Native
...
const Piwalletcancelduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M14 12h3m.2 9 2.4-2.4m0 0 2.4-2.4m-2.4 2.4-2.4-2.4m2.4 2.4L22 21" />{" "}
    <path
      fill={color || "#000"}
...
export default Piwalletcancelduosolid;
