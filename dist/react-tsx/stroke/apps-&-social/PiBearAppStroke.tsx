...
/**
 * PiBearAppStroke icon from the stroke style in apps-&-social category.
 */
interface PiBearAppStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBearAppStroke({
  size = 24,
  color,
  className,
