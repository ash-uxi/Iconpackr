...
/**
 * Pirsssquareduostroke icon component for React Native
...
const Pirsssquareduostroke = ({
  ...
  >
    ...
    />
    <path
      d="M7 7C9.65216 7 12.1957 8.05357 14.0711 9.92893C15.9464 11.8043 17 14.3478 17 17M7 11.7368C7.69117 11.7368 8.37557 11.873 9.01412 12.1375C9.65268 12.402 10.2329 12.7897 10.7216 13.2784C11.2103 13.7671 11.598 14.3473 11.8625 14.9859C12.127 15.6244 12.2632 16.3088 12.2632 17M7.25614 16.7368H7.26316"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pirsssquareduostroke;
