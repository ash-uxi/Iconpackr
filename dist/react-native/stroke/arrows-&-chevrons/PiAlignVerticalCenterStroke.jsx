...
/**
 * Pialignverticalcenterstroke icon component for React Native
 ...
 */
const Pialignverticalcenterstroke = ({
  color = "#000",
  size = 24,
...
export default Pialignverticalcenterstroke;
