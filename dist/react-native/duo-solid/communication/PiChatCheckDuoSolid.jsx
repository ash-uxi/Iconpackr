...
/**
 * Pichatcheckduosolid icon component for React Native
...
const Pichatcheckduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="m8.5 12.766 2.341 2.339a15 15 0 0 1 4.558-4.936" />
  </Svg>
);

export default Pichatcheckduosolid;
