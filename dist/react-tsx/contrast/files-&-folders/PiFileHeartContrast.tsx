...
/**
 * PiFileHeartContrast icon from the contrast style in files-&-folders category.
 */
interface PiFileHeartContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileHeartContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'file-heart icon',
  ...props
}: PiFileHeartContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
