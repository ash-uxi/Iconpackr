...
/**
 * Pidrawhighlighterduosolid icon component for React Native
 ...
 */
const Pidrawhighlighterduosolid = ({
  color = "#000",
  size = 24,
...
export default Pidrawhighlighterduosolid;
