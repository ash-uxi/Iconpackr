...
/**
 * Pimusicquavernotecontrast icon component for React Native
 ...
 */
const Pimusicquavernotecontrast = ({
  color = "#000",
  size = 24,
  ...
  >
    ...
    <path
      fill={color}
      d="M6 18.998a3 3 0 1 1 6.002-.001A3 3 0 0 1 6 18.998"
      opacity={0.28}
    />
  </Svg>
);

export default Pimusicquavernotecontrast;
