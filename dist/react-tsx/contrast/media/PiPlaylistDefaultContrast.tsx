...
/**
 * PiPlaylistDefaultContrast icon from the contrast style in media category.
 */
interface PiPlaylistDefaultContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistDefaultContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'playlist-default icon',
  ...props
}: PiPlaylistDefaultContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
