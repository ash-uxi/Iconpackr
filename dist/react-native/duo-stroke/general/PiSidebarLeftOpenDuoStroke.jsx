...
/**
 * Pisidebarleftopenduostroke icon component for React Native
 ...
 */
const Pisidebarleftopenduostroke = ({
  color = "#000",
  size = 24,
...
export default Pisidebarleftopenduostroke;
