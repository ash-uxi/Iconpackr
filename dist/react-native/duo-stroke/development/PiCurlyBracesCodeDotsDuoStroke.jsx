...
/**
 * Picurlybracescodedotsduostroke icon component for React Native
 ...
 */
const Picurlybracescodedotsduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "curly braces code dots icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      d="M12.001 12H12M15.001 12H15M9.001 12H9"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Picurlybracescodedotsduostroke;
