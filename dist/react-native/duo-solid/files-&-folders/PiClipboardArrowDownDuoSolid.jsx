...
/**
 * Piclipboardarrowdownduosolid icon component for React Native
 ...
 */
const Piclipboardarrowdownduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M14 15.057a10 10 0 0 1-1.802 1.873A.32.32 0 0 1 12 17m0 0a.32.32 0 0 1-.198-.07A10 10 0 0 1 10 15.057M12 17v-6m-2-5h4c.465 0 .697 0 .888-.051a1.5 1.5 0 0 0 1.06-1.06c.05-.186.052-.411.052-.85V4c0-.465 0-.697-.051-.888a1.5 1.5 0 0 0-1.06-1.06C14.697 2 14.464 2 14 2h-4c-.465 0-.697 0-.888.051a1.5 1.5 0 0 0-1.06 1.06C8 3.304 8 3.536 8 4v.038c0 .44.001.665.051.85a1.5 1.5 0 0 0 1.06 1.06C9.304 6 9.536 6 10 6" />
  </Svg>
);

export default Piclipboardarrowdownduosolid;
