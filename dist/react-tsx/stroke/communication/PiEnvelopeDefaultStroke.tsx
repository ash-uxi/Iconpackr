...
/**
 * PiEnvelopeDefaultStroke icon from the stroke style in communication category.
 */
interface PiEnvelopeDefaultStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiEnvelopeDefaultStroke({
  size = 24,
  color,
  className,
