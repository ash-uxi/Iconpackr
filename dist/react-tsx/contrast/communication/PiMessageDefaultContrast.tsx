...
/**
 * PiMessageDefaultContrast icon from the contrast style in communication category.
 */
interface PiMessageDefaultContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageDefaultContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'message-default icon',
  ...props
}: PiMessageDefaultContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
