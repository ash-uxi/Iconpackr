...
export default function PiMediaSpeed1xDuoStroke({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M13 19L16.5 14.5M16.5 14.5L20 10M16.5 14.5L20 19M16.5 14.5L13 10" stroke={color || "currentColor"} strokeWidth="2" opacity="0.28" fill="none"/>
  <path d="M8.02245 19V5C6.21696 5.44211 4.83732 6.68537 4.01855 8.32289" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
