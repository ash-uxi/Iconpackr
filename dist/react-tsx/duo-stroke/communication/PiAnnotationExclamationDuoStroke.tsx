...
/**
 * PiAnnotationExclamationDuoStroke icon from the duo-stroke style in communication category.
 */
interface PiAnnotationExclamationDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationExclamationDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'annotation-exclamation icon',
  ...props
}: PiAnnotationExclamationDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12.0007 11.5V7.5M11.9927 15H12.0027" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
