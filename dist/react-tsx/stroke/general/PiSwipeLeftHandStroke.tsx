 ...
 */
interface PiSwipeLeftHandStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSwipeLeftHandStroke({
  ...
  ...props
}: PiSwipeLeftHandStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
