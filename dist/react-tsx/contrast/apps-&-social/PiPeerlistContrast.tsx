...
/**
 * PiPeerlistContrast icon from the contrast style in apps-&-social category.
 */
interface PiPeerlistContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPeerlistContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'peerlist icon',
  ...props
}: PiPeerlistContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
