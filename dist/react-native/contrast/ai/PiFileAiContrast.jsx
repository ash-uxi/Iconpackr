...
/**
 * Pifileaicontrast icon component for React Native
...
const Pifileaicontrast = ({
  ...
  >
    ...
    <path
      ...
      opacity={0.28}
    />
    <path d="M7.534 16.812h.01m3.99-7c-.638 1.617-1.34 2.345-3 3 1.66.655 2.362 1.384 3 3 .637-1.616 1.339-2.345 3-3-1.661-.655-2.363-1.383-3-3" />
  </Svg>
);

export default Pifileaicontrast;
