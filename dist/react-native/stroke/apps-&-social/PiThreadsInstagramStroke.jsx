...
/**
 * Pithreadsinstagramstroke icon component for React Native
 ...
 */
const Pithreadsinstagramstroke = ({
  color = "#000",
  size = 24,
...
export default Pithreadsinstagramstroke;
