...
/**
 * Pimultiplecrosscancelsquareduostroke icon component for React Native
 ...
 */
const Pimultiplecrosscancelsquareduostroke = ({
  color = "#000",
  size = 24,
...
export default Pimultiplecrosscancelsquareduostroke;
