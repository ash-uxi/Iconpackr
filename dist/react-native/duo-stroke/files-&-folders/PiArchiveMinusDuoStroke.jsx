...
/**
 * Piarchiveminusduostroke icon component for React Native
...
const Piarchiveminusduostroke = ({
  ...
  >
    ...
    <path
      ...
      fill="none"
    />
    <path d="M9 14.5H15" stroke={color || "#000"} strokeWidth="2" fill="none" />
  </Svg>
);

export default Piarchiveminusduostroke;
