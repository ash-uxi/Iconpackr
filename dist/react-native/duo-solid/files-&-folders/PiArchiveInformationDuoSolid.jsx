...
/**
 * Piarchiveinformationduosolid icon component for React Native
 ...
 */
const Piarchiveinformationduosolid = ({
  color = "#000",
  size = 24,
...
export default Piarchiveinformationduosolid;
