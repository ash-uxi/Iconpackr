...
/**
 * Pimedicinepillscapsulestabletscontrast icon component for React Native
 ...
 */
const Pimedicinepillscapsulestabletscontrast = ({
  color = "#000",
  size = 24,
...
export default Pimedicinepillscapsulestabletscontrast;
