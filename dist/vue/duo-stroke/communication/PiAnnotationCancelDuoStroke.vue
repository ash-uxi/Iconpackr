<template>
  ...
  <path d="M9.5 13.5L12 11M12 11L14.5 8.5M12 11L9.5 8.5M12 11L14.5 13.5" :stroke="color || 'currentColor'" stroke-width="2" fill="none"/>
  </svg>
</template>
 ...
 */
export default {
  name: 'PiAnnotationCancelDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
