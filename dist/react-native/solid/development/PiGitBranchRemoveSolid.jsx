...
/**
 * Pigitbranchremovesolid icon component for React Native
...
const Pigitbranchremovesolid = ({
  ...
  >
    <path
      d="M15 17C14.4477 17 14 17.4477 14 18C14 18.5523 14.4477 19 15 19H21C21.5523 19 22 18.5523 22 18C22 17.4477 21.5523 17 21 17H15Z"
      fill={color}
      stroke="none"
    />
    <path
...
export default Pigitbranchremovesolid;
