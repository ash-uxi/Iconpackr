...
/**
 * Pifoldercheckduostroke icon component for React Native
 ...
 */
const Pifoldercheckduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "folder check icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    ...
    />
    <path
      d="M9 13.6663L11.3412 16.005C12.4672 14.036 14.0256 12.3484 15.8987 11.0693"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pifoldercheckduostroke;
