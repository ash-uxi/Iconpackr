<template>
  <svg
    ...
    v-bind="$attrs"
  >
    <path d="M20 13V18C20 18.5304 19.7893 19.0391 19.4142 19.4142C19.0391 19.7893 18.5304 20 18 20H13" stroke="currentColor" stroke-width="2" fill="none"/>
