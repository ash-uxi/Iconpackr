<template>
  <svg
    ...
    v-bind="$attrs"
  >
    <path fill="currentColor" d="M10 4h4c2.8 0 4.2 0 5.27.545a5 5 0 0 1 2.185 2.185C22 7.8 22 9.2 22 12v.392h-.52A3 3 0 0 0 17 15.002v.62a3.001 3.001 0 0 0-2.377 4.033V20H10c-2.8 0-4.2 0-5.27-.545a5 5 0 0 1-2.185-2.185C2 16.2 2 14.8 2 12s0-4.2.545-5.27A5 5 0 0 1 4.73 4.545C5.8 4 7.2 4 10 4" opacity=".28"/>
 ...
 */
export default {
  name: 'PiEnvelopeArrowDownContrast',
  props: {
    size: {
      type: Number,
      default: 24
