...
/**
 * Pipresentationtrendlineupduosolid icon component for React Native
 ...
 */
const Pipresentationtrendlineupduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M7 13.5a9.04 9.04 0 0 1 3.79-4.583l.248-.149 1.924 3.464.249-.15A9.04 9.04 0 0 0 17 7.5" />
  </Svg>
);

export default Pipresentationtrendlineupduosolid;
