...
/**
 * PiFileSearchStroke icon from the stroke style in files-&-folders category.
 */
interface PiFileSearchStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileSearchStroke({
  size = 24,
  color,
  className,
