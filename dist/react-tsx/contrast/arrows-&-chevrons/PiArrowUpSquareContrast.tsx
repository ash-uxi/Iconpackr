...
/**
 * PiArrowUpSquareContrast icon from the contrast style in arrows-&-chevrons category.
 */
interface PiArrowUpSquareContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiArrowUpSquareContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'arrow-up-square icon',
  ...props
}: PiArrowUpSquareContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M8 11.949a20.3 20.3 0 0 1 3.604-3.807A.63.63 0 0 1 12 8m4 3.949a20.3 20.3 0 0 0-3.604-3.807A.63.63 0 0 0 12 8m0 0v8m0 5c-2.796 0-4.193 0-5.296-.457a6 6 0 0 1-3.247-3.247C3 16.194 3 14.796 3 12s0-4.193.457-5.296a6 6 0 0 1 3.247-3.247C7.807 3 9.204 3 12 3s4.194 0 5.296.457a6 6 0 0 1 3.247 3.247C21 7.807 21 9.204 21 12s0 4.194-.457 5.296a6 6 0 0 1-3.247 3.247C16.194 21 14.796 21 12 21"/>
    </svg>
  );
}
