...
/**
 * PiPlaylistDefaultStroke icon from the stroke style in media category.
 */
interface PiPlaylistDefaultStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistDefaultStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'playlist-default icon',
  ...props
}: PiPlaylistDefaultStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
