...
/**
 * PiCaptionOnDuoSolid icon from the duo-solid style in media category.
 */
interface PiCaptionOnDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCaptionOnDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'caption-on icon',
  ...props
}: PiCaptionOnDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
