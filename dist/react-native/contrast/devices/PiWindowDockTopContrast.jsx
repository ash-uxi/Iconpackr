...
/**
 * Piwindowdocktopcontrast icon component for React Native
...
const Piwindowdocktopcontrast = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path fill={color} d="M17 12V8H7v4z" />
...
export default Piwindowdocktopcontrast;
