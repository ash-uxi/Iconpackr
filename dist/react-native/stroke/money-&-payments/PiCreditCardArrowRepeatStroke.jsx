...
/**
 * Picreditcardarrowrepeatstroke icon component for React Native
 ...
 */
const Picreditcardarrowrepeatstroke = ({
  color = "#000",
  size = 24,
...
export default Picreditcardarrowrepeatstroke;
