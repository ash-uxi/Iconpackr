<template>
  ...
  <path d="M9.47461 16.4244L11.9495 13.9495M11.9495 13.9495L14.4244 11.4746M11.9495 13.9495L9.47461 11.4746M11.9495 13.9495L14.4244 16.4244" :stroke="color || 'currentColor'" stroke-width="2" fill="none"/>
  </svg>
</template>

<script>
/**
 * PiFolderCancelDuoStroke icon from the duo-stroke style in files-&-folders category.
 */
export default {
  name: 'PiFolderCancelDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
