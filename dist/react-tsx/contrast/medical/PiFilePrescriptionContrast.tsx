...
/**
 * PiFilePrescriptionContrast icon from the contrast style in medical category.
 */
interface PiFilePrescriptionContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFilePrescriptionContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'file-prescription icon',
  ...props
}: PiFilePrescriptionContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
