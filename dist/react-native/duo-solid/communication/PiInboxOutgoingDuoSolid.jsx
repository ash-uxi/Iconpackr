...
/**
 * Piinboxoutgoingduosolid icon component for React Native
...
const Piinboxoutgoingduosolid = ({
  ...
  >
    ...
    <path
      fill={color || "#000"}
      d="M12 3c-.328 0-.656.11-.925.328A11 11 0 0 0 9.2 5.274a1 1 0 0 0 1.6 1.2q.098-.13.2-.256V9a1 1 0 1 0 2 0V6.218q.102.126.2.256a1 1 0 0 0 1.6-1.2 11 11 0 0 0-1.875-1.946A1.47 1.47 0 0 0 12 3"
    />{" "}
    <path
...
export default Piinboxoutgoingduosolid;
