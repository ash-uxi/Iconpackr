...
/**
 * PiSquareDotSolid icon from the solid style in general category.
 */
interface PiSquareDotSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSquareDotSolid({
  size = 24,
  color,
  className,
