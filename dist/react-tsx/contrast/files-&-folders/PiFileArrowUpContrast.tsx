...
/**
 * PiFileArrowUpContrast icon from the contrast style in files-&-folders category.
 */
interface PiFileArrowUpContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowUpContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-up icon',
  ...props
}: PiFileArrowUpContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
