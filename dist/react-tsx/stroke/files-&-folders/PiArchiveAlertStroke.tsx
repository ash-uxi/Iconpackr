...
/**
 * PiArchiveAlertStroke icon from the stroke style in files-&-folders category.
 */
interface PiArchiveAlertStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiArchiveAlertStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'archive-alert icon',
  ...props
}: PiArchiveAlertStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12 14.5V11.5M12 17.51V17.5" stroke="currentColor" strokeWidth="2" fill="none"/>
