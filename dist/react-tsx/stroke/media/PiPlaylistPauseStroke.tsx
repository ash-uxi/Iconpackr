...
/**
 * PiPlaylistPauseStroke icon from the stroke style in media category.
 */
interface PiPlaylistPauseStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistPauseStroke({
  size = 24,
  color,
  className,
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M10 18.5V13.5M14 18.5V13.5" stroke="currentColor" strokeWidth="2" fill="none"/>
