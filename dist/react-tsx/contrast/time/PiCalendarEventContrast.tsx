...
/**
 * PiCalendarEventContrast icon from the contrast style in time category.
 */
interface PiCalendarEventContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarEventContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'calendar-event icon',
  ...props
}: PiCalendarEventContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
