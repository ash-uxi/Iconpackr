 ...
 */
export default {
  name: 'PiWindowPictureInPictureDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'window-picture-in-picture icon'
    }
  }
}
</script>
