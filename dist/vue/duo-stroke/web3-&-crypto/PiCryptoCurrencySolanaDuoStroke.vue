 ...
 */
export default {
  name: 'PiCryptoCurrencySolanaDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'crypto-currency-solana icon'
    }
  }
}
</script>
