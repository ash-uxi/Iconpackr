...
/**
 * PiWalletLinkDuoSolid icon from the duo-solid style in web3-&-crypto category.
 */
interface PiWalletLinkDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletLinkDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'wallet-link icon',
  ...props
}: PiWalletLinkDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
