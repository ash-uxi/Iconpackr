...
/**
 * Piimaccontrast icon component for React Native
...
const Piimaccontrast = ({
  ...
  >
    <path
      fill={color}
      d="M19.6 2H4.4c-.84 0-1.26 0-1.581.163a1.5 1.5 0 0 0-.656.656C2 3.139 2 3.559 2 4.4V13h20V4.4c0-.84 0-1.26-.163-1.581a1.5 1.5 0 0 0-.656-.656C20.861 2 20.441 2 19.6 2"
      opacity={0.28}
    />
