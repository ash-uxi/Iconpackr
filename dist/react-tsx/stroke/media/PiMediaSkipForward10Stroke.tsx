...
/**
 * PiMediaSkipForward10Stroke icon from the stroke style in media category.
 */
interface PiMediaSkipForward10StrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMediaSkipForward10Stroke({
  size = 24,
  color,
  className,
  ...
  <path d="M11 1c.722.519 1.37 1.124 1.928 1.802a.31.31 0 0 1 0 .396A10.3 10.3 0 0 1 11 5" fill="none"/>
