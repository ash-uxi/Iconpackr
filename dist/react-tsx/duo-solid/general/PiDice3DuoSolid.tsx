...
/**
 * PiDice3DuoSolid icon from the duo-solid style in general category.
 */
interface PiDice3DuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiDice3DuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'dice-3 icon',
  ...props
}: PiDice3DuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
