...
/**
 * PiFolderShieldStroke icon from the stroke style in files-&-folders category.
 */
interface PiFolderShieldStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderShieldStroke({
  size = 24,
  color,
  className,
