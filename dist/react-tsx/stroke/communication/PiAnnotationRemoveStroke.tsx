...
/**
 * PiAnnotationRemoveStroke icon from the stroke style in communication category.
 */
interface PiAnnotationRemoveStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationRemoveStroke({
  size = 24,
  color,
  className,
