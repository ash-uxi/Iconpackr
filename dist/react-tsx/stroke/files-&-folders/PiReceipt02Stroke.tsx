...
/**
 * PiReceipt02Stroke icon from the stroke style in files-&-folders category.
 */
interface PiReceipt02StrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiReceipt02Stroke({
  size = 24,
  color,
  className,
