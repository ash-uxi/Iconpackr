...
export default function PiGaugeLeftUpDuoStroke({
  ...
  <path d="M8.46509 8.46387L12.5721 11.2679C13.0511 11.5944 13.1171 12.298 12.7071 12.7079C12.297 13.1176 11.5932 13.0512 11.2671 12.5719L8.46509 8.46387Z" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
