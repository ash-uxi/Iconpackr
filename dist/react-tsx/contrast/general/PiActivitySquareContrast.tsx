...
/**
 * PiActivitySquareContrast icon from the contrast style in general category.
 */
interface PiActivitySquareContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiActivitySquareContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'activity-square icon',
  ...props
}: PiActivitySquareContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
