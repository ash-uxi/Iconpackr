...
/**
 * Pibluetoothconnectedstroke icon component for React Native
 ...
 */
const Pibluetoothconnectedstroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "bluetooth connected icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pibluetoothconnectedstroke;
