...
/**
 * Piuserarrowrightduosolid icon component for React Native
 ...
 */
const Piuserarrowrightduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      d="M16.3548 14.0124C16.2376 14.0042 16.1193 14 16 14H8C5.23858 14 3 16.2386 3 19C3 20.6569 4.34315 22 6 22H16.3592C16.2443 21.6752 16.188 21.3368 16.1883 21H15C13.3431 21 12 19.6569 12 18C12 16.3431 13.3431 15 15 15H16.1883C16.188 14.6675 16.2429 14.3334 16.3548 14.0124Z"
      fill={color || "#000"}
      opacity={0.28}
    />{" "}
    <path
...
export default Piuserarrowrightduosolid;
