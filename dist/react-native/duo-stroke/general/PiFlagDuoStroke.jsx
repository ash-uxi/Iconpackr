...
/**
 * Piflagduostroke icon component for React Native
...
const Piflagduostroke = ({
  ...
  >
    <path
      ...
      fill="none"
    />
    <path d="M5 3V21" stroke={color || "#000"} strokeWidth="2" fill="none" />
  </Svg>
);

export default Piflagduostroke;
