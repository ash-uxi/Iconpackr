...
/**
 * Picameraminusstroke icon component for React Native
...
const Picameraminusstroke = ({
  ...
  >
    <path
      ...
      fill="none"
    />
    <path d="M9 13H15" stroke={color} strokeWidth="2" fill="none" />
  </Svg>
);

export default Picameraminusstroke;
