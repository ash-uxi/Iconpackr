...
/**
 * PiCalendarTimerStroke icon from the stroke style in time category.
 */
interface PiCalendarTimerStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarTimerStroke({
  size = 24,
  color,
  className,
