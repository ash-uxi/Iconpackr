...
/**
 * Pilightningthunderelectriconstroke icon component for React Native
 ...
 */
const Pilightningthunderelectriconstroke = ({
  color = "#000",
  size = 24,
...
export default Pilightningthunderelectriconstroke;
