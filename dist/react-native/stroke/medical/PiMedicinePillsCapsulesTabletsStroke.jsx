...
/**
 * Pimedicinepillscapsulestabletsstroke icon component for React Native
 ...
 */
const Pimedicinepillscapsulestabletsstroke = ({
  color = "#000",
  size = 24,
...
export default Pimedicinepillscapsulestabletsstroke;
