...
/**
 * PiFileArrowLeftContrast icon from the contrast style in files-&-folders category.
 */
interface PiFileArrowLeftContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowLeftContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-left icon',
  ...props
}: PiFileArrowLeftContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
