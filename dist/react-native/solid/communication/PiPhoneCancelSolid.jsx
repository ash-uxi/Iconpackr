...
/**
 * Piphonecancelsolid icon component for React Native
 ...
 */
const Piphonecancelsolid = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "phone cancel icon",
  style,
  ...props
}) => (
  <Svg
...
export default Piphonecancelsolid;
