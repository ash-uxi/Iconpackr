 ...
 */
interface PiFolderAiContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderAiContrast({
  ...
  ...props
}: PiFolderAiContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path fill="currentColor" d="M12.5 10.5c.637 1.617 1.34 2.345 3 3-1.66.655-2.363 1.383-3 3-.637-1.617-1.34-2.345-3-3 1.66-.655 2.363-1.383 3-3"/>
