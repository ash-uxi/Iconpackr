...
/**
 * Piwhatsappcontrast icon component for React Native
 ...
 */
const Piwhatsappcontrast = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "whatsapp icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      fill={color}
      d="M21 12a9 9 0 0 1-12.15 8.434c-.319-.12-.478-.18-.596-.2a1.2 1.2 0 0 0-.315-.021c-.12.006-.251.037-.516.099l-1.488.347c-1.121.262-1.682.393-2.076.236a1.35 1.35 0 0 1-.754-.754c-.157-.394-.026-.955.236-2.076l.347-1.488c.062-.265.093-.397.1-.516.006-.12 0-.196-.021-.315-.022-.118-.081-.277-.2-.597A9 9 0 1 1 21 12"
      opacity={0.28}
    />
...
export default Piwhatsappcontrast;
