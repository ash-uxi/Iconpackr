<template>
  ...
  <path d="M9.42896 13.91C10.063 13.064 10.799 12.3 11.619 11.635C11.7266 11.5475 11.8612 11.4998 12 11.5M12 11.5C12.1387 11.4998 12.2733 11.5475 12.381 11.635C13.2016 12.3005 13.9372 13.0646 14.571 13.91M12 11.5V17.5" stroke="currentColor" stroke-width="2" fill="none"/>
  </svg>
</template>
