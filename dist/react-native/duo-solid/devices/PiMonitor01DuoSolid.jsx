...
/**
 * Pimonitor01duosolid icon component for React Native
...
const Pimonitor01duosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M17 22h-5m0 0H7m5 0v-5" opacity={0.28} />{" "}
    <path
      fill={color || "#000"}
...
export default Pimonitor01duosolid;
