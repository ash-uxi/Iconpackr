...
/**
 * Picaptiononduosolid icon component for React Native
...
const Picaptiononduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M10.25 15.5a3 3 0 0 1-3-3V12a3 3 0 0 1 3-3m6.5 6.5a3 3 0 0 1-3-3V12a3 3 0 0 1 3-3" />{" "}
    <path
      fill={color || "#000"}
...
export default Picaptiononduosolid;
