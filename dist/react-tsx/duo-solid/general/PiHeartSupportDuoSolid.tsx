...
/**
 * PiHeartSupportDuoSolid icon from the duo-solid style in general category.
 */
interface PiHeartSupportDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiHeartSupportDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'heart-support icon',
  ...props
}: PiHeartSupportDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
