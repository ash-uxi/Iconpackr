...
/**
 * Pinpmlogosymbolduostroke icon component for React Native
 ...
 */
const Pinpmlogosymbolduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      fill="none"
    />
    <path d="M14 11V20" stroke={color || "#000"} strokeWidth="2" fill="none" />
  </Svg>
);

export default Pinpmlogosymbolduostroke;
