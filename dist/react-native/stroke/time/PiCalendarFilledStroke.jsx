...
/**
 * Picalendarfilledstroke icon component for React Native
 ...
 */
const Picalendarfilledstroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "calendar filled icon",
  style,
  ...props
}) => (
  <Svg
...
export default Picalendarfilledstroke;
