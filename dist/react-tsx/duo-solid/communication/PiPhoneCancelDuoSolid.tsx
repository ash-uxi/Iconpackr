...
/**
 * PiPhoneCancelDuoSolid icon from the duo-solid style in communication category.
 */
interface PiPhoneCancelDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhoneCancelDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'phone-cancel icon',
  ...props
}: PiPhoneCancelDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
