...
/**
 * Piactivitysquareduostroke icon component for React Native
 ...
 */
const Piactivitysquareduostroke = ({
  color = "#000",
  size = 24,
...
export default Piactivitysquareduostroke;
