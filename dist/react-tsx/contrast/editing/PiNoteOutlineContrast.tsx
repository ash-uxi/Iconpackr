...
/**
 * PiNoteOutlineContrast icon from the contrast style in editing category.
 */
interface PiNoteOutlineContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiNoteOutlineContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'note-outline icon',
  ...props
}: PiNoteOutlineContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
