...
/**
 * Pifolderarrowdownduosolid icon component for React Native
 ...
 */
const Pifolderarrowdownduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M12 11v6m0 0a.47.47 0 0 1-.296-.105A10 10 0 0 1 10 15.125M12 17c.105 0 .21-.035.296-.105A10 10 0 0 0 14 15.125" />{" "}
    <path
      fill={color || "#000"}
...
export default Pifolderarrowdownduosolid;
