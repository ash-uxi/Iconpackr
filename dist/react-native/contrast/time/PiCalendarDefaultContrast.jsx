...
/**
 * Picalendardefaultcontrast icon component for React Native
 ...
 */
const Picalendardefaultcontrast = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "calendar default icon",
  style,
  ...props
}) => (
  <Svg
...
export default Picalendardefaultcontrast;
