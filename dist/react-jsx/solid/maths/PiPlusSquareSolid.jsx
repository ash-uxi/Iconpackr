...
/**
 * PiPlusSquareSolid icon from the solid style in maths category.
 ...
 */
export default function PiPlusSquareSolid({ 
  size = 24, 
  color,
  className,
