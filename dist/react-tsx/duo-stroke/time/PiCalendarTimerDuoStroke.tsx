 ...
 */
interface PiCalendarTimerDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarTimerDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'calendar-timer icon',
  ...props
}: PiCalendarTimerDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M16 2V6M8 2V6M12 11V15L14 16" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
