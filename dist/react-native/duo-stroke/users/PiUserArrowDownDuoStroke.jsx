...
/**
 * Piuserarrowdownduostroke icon component for React Native
 ...
 */
const Piuserarrowdownduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      d="M12.4311 21H5C3.89543 21 3 20.1046 3 19C3 16.7909 4.79086 15 7 15H15"
      stroke={color || "#000"}
      strokeWidth="2"
      opacity={0.28}
      fill="none"
...
export default Piuserarrowdownduostroke;
