...
/**
 * Pipresentationtrendlinedownduosolid icon component for React Native
 ...
 */
const Pipresentationtrendlinedownduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M7 7.5a9.04 9.04 0 0 0 3.79 4.583l.248.15 1.924-3.465.249.15A9.04 9.04 0 0 1 17 13.5" />
  </Svg>
);

export default Pipresentationtrendlinedownduosolid;
