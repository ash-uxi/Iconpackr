...
/**
 * PiCalendarEventStroke icon from the stroke style in time category.
 */
interface PiCalendarEventStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarEventStroke({
  size = 24,
  color,
  className,
