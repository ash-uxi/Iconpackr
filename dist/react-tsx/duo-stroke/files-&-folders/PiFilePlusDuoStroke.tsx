 ...
 */
interface PiFilePlusDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFilePlusDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-plus icon',
  ...props
}: PiFilePlusDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
