 ...
 */
interface PiFolderBoltDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderBoltDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-bolt icon',
  ...props
}: PiFolderBoltDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
