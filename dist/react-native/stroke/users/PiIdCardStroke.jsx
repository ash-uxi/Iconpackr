...
/**
 * Piidcardstroke icon component for React Native
...
const Piidcardstroke = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M14 10H18M15 14H18" stroke={color} strokeWidth="2" fill="none" />
    <path
