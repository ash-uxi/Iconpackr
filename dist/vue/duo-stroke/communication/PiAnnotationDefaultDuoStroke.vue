 ...
 */
export default {
  name: 'PiAnnotationDefaultDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'annotation-default icon'
    }
  }
}
</script>
