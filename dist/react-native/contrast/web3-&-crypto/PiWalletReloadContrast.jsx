...
/**
 * Piwalletreloadcontrast icon component for React Native
...
const Piwalletreloadcontrast = ({
  ...
  >
    <path
      fill={color}
      d="M2.38 10.087C2 11.005 2 12.17 2 14.5c0 1.33 0 2.495.38 3.413a5 5 0 0 0 2.707 2.706C6.005 21 7.17 21 9.5 21h1.132a7.001 7.001 0 0 1 10.507-8.199q.404-.17.848-.216c-.026-1.138-.11-1.875-.368-2.498a5 5 0 0 0-2.706-2.706A4 4 0 0 0 18 7.13C17.195 7 16.134 7 14.5 7h-5c-2.33 0-3.495 0-4.413.38a5 5 0 0 0-2.706 2.707"
      opacity={0.28}
    />
...
export default Piwalletreloadcontrast;
