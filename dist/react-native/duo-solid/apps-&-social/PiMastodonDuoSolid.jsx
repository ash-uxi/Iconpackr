...
/**
 * Pimastodonduosolid icon component for React Native
...
const Pimastodonduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M12 11.312V8.386m0 0c0-1.258-.895-2.278-2-2.278s-2 1.02-2 2.278v4.722m4-4.722c0-1.258.895-2.278 2-2.278s2 1.02 2 2.278v4.722" />{" "}
    <path
      fill={color || "#000"}
...
export default Pimastodonduosolid;
