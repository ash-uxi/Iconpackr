...
/**
 * PiFolderPlusContrast icon from the contrast style in files-&-folders category.
 */
interface PiFolderPlusContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderPlusContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-plus icon',
  ...props
}: PiFolderPlusContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
