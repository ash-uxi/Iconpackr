...
/**
 * Pilayoutgridstackleftduostroke icon component for React Native
 ...
 */
const Pilayoutgridstackleftduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "layout grid stack left icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pilayoutgridstackleftduostroke;
