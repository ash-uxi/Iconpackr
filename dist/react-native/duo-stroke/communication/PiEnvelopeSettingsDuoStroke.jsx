...
/**
 * Pienvelopesettingsduostroke icon component for React Native
 ...
 */
const Pienvelopesettingsduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      d="M10.5352 20.0001H10C7.19974 20.0001 5.79961 20.0001 4.73005 19.4552C3.78924 18.9758 3.02433 18.2109 2.54497 17.2701C2 16.2005 2 14.8004 2 12.0001C2 10.0061 2 8.72202 2.19678 7.76172M21.9997 11.3517C21.9975 9.72044 21.9778 8.61366 21.8032 7.76172"
      stroke={color || "#000"}
      strokeWidth="2"
      opacity={0.28}
      fill="none"
...
export default Pienvelopesettingsduostroke;
