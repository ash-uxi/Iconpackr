 ...
 */
interface PiPlaylistPauseDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistPauseDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'playlist-pause icon',
  ...props
}: PiPlaylistPauseDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M10 18.5V13.5M14 18.5V13.5" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
