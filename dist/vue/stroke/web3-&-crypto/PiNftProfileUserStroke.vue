<template>
  <svg
    ...
    v-bind="$attrs"
  >
    <path d="M14 14H10C8.89543 14 8 14.8954 8 16C8 16.5523 8.44771 17 9 17H15C15.5523 17 16 16.5523 16 16C16 14.8954 15.1046 14 14 14Z" stroke="currentColor" stroke-width="2" fill="none"/>
  <path d="M14 9C14 10.1046 13.1046 11 12 11C10.8954 11 10 10.1046 10 9C10 7.89543 10.8954 7 12 7C13.1046 7 14 7.89543 14 9Z" stroke="currentColor" stroke-width="2" fill="none"/>
