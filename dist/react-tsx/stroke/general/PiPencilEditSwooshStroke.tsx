...
/**
 * PiPencilEditSwooshStroke icon from the stroke style in general category.
 */
interface PiPencilEditSwooshStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPencilEditSwooshStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'pencil-edit-swoosh icon',
  ...props
}: PiPencilEditSwooshStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
