...
export default function PiFolderDefaultDuoStroke({ 
  ...
  <path d="M22 12V14.6C22 16.8402 22 17.9603 21.564 18.816C21.1805 19.5686 20.5686 20.1805 19.816 20.564C18.9603 21 17.8402 21 15.6 21H8.4C6.15979 21 5.03968 21 4.18404 20.564C3.43139 20.1805 2.81947 19.5686 2.43597 18.816C2 17.9603 2 16.8402 2 14.6V12" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
