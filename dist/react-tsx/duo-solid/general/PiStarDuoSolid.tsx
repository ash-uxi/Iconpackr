...
/**
 * PiStarDuoSolid icon from the duo-solid style in general category.
 */
interface PiStarDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiStarDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'star icon',
  ...props
}: PiStarDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
