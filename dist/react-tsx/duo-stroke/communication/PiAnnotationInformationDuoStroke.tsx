...
/**
 * PiAnnotationInformationDuoStroke icon from the duo-stroke style in communication category.
 */
interface PiAnnotationInformationDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationInformationDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'annotation-information icon',
  ...props
}: PiAnnotationInformationDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12.0007 10.501V14.501M11.9927 7H12.0027" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
