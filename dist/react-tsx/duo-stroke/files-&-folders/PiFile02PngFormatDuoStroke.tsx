 ...
 */
interface PiFile02PngFormatDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02PngFormatDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-png-format icon',
  ...props
}: PiFile02PngFormatDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
