...
/**
 * Pinavigationslantduostroke icon component for React Native
 ...
 */
const Pinavigationslantduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      d="M13.9386 20.7145C13.6583 21.1596 12.98 21.0449 12.8617 20.5323L11.5139 14.6918C11.2608 13.5953 10.4046 12.739 9.30803 12.486L3.46755 11.1382C2.955 11.0199 2.84026 10.3416 3.2854 10.0613"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pinavigationslantduostroke;
