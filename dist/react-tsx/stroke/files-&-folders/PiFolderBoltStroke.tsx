...
/**
 * PiFolderBoltStroke icon from the stroke style in files-&-folders category.
 */
interface PiFolderBoltStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderBoltStroke({
  size = 24,
  color,
  className,
