...
/**
 * Piplaylistdownloadcontrast icon component for React Native
 ...
 */
const Piplaylistdownloadcontrast = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M15 16.208a15 15 0 0 1-2.556 2.654.7.7 0 0 1-.444.158m-3-2.812a15 15 0 0 0 2.556 2.654c.13.105.287.158.444.158m0 0V13" />
    <path
      fill={color}
...
export default Piplaylistdownloadcontrast;
