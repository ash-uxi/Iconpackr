...
/**
 * PiFolderArrowUpDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFolderArrowUpDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowUpDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-up icon',
  ...props
}: PiFolderArrowUpDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
