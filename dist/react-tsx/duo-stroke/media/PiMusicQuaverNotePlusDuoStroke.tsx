...
export default function PiMusicQuaverNotePlusDuoStroke({
  ...
  <path d="M7 10V7M7 7V4M7 7L4 7M7 7H10" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
  <path d="M8 18.9983C8 17.3405 9.34315 15.9966 11 15.9966C12.6569 15.9966 14 17.3405 14 18.9983C14 20.6561 12.6569 22 11 22C9.34315 22 8 20.6561 8 18.9983Z" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
