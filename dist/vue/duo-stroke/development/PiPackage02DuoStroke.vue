...
<script>
/**
 * PiPackage02DuoStroke icon from the duo-stroke style in development category.
 */
export default {
  name: 'PiPackage02DuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
