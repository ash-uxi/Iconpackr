...
/**
 * Piannotationcheckduosolid icon component for React Native
 ...
 */
const Piannotationcheckduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="m8.5 11.512 2.341 2.34A15 15 0 0 1 15.4 8.914l.101-.069" />{" "}
    <path
      fill={color || "#000"}
...
export default Piannotationcheckduosolid;
