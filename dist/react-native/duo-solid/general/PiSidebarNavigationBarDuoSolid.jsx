...
/**
 * Pisidebarnavigationbarduosolid icon component for React Native
 ...
 */
const Pisidebarnavigationbarduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />{" "}
    <path d="M9 3.01V20.99" opacity={0.28} />
  </Svg>
);

export default Pisidebarnavigationbarduosolid;
