...
/**
 * Picrownwinnerkingduosolid icon component for React Native
 ...
 */
const Picrownwinnerkingduosolid = ({
  color = "#000",
  size = 24,
...
export default Picrownwinnerkingduosolid;
