...
/**
 * Piclipboardarrowdownleftduostroke icon component for React Native
 ...
 */
const Piclipboardarrowdownleftduostroke = ({
  color = "#000",
  size = 24,
...
export default Piclipboardarrowdownleftduostroke;
