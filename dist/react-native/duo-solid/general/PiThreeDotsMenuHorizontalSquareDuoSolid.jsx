...
/**
 * Pithreedotsmenuhorizontalsquareduosolid icon component for React Native
 ...
 */
const Pithreedotsmenuhorizontalsquareduosolid = ({
  color = "#000",
  size = 24,
...
export default Pithreedotsmenuhorizontalsquareduosolid;
