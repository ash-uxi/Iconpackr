...
/**
 * PiResolutionQualityHdStroke icon from the stroke style in media category.
 */
interface PiResolutionQualityHdStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiResolutionQualityHdStroke({
  size = 24,
  color,
  className,
