...
/**
 * Picalendarremoveduosolid icon component for React Native
 ...
 */
const Picalendarremoveduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M8 2v4m8-4v4m-7 8h6" />
  </Svg>
);

export default Picalendarremoveduosolid;
