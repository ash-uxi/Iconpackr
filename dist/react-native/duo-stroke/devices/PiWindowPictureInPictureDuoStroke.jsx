...
/**
 * Piwindowpictureinpictureduostroke icon component for React Native
 ...
 */
const Piwindowpictureinpictureduostroke = ({
  color = "#000",
  size = 24,
...
export default Piwindowpictureinpictureduostroke;
