...
/**
 * PiSparkleAi02Solid icon from the solid style in general category.
 ...
 */
export default function PiSparkleAi02Solid({ 
  size = 24, 
  color,
  className,
