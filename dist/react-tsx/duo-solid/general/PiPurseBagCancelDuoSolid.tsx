...
/**
 * PiPurseBagCancelDuoSolid icon from the duo-solid style in general category.
 */
interface PiPurseBagCancelDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPurseBagCancelDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'purse-bag-cancel icon',
  ...props
}: PiPurseBagCancelDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
