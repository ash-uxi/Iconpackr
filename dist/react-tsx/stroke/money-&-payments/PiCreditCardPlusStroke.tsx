 ...
 */
interface PiCreditCardPlusStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCreditCardPlusStroke({
  ...
  ...props
}: PiCreditCardPlusStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
