...
export default function PiGraphTrendLineDuoStroke({
  ...
  <path d="M7 14L7.61026 12.1692C8.35529 9.93413 11.5295 9.97104 12.2224 12.2228C12.8649 14.311 15.7261 14.5478 16.7032 12.5937L19 8" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
