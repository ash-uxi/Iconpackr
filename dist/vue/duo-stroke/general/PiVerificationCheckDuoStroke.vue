<template>
  ...
  <path d="M9 12.1407L11.0067 14.1453C11.9719 12.4577 13.3076 11.0111 14.9132 9.91476L15 9.85547" :stroke="color || 'currentColor'" stroke-width="2" fill="none"/>
  </svg>
</template>
 ...
 */
export default {
  name: 'PiVerificationCheckDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
