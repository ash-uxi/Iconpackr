...
/**
 * PiFolderPlusDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFolderPlusDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderPlusDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-plus icon',
  ...props
}: PiFolderPlusDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
