...
/**
 * PiMediaSkipBackward10DuoStroke icon from the duo-stroke style in media category.
 */
interface PiMediaSkipBackward10DuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMediaSkipBackward10DuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'media-skip-backward-10 icon',
  ...props
}: PiMediaSkipBackward10DuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M13 1a10.3 10.3 0 0 0-1.928 1.802.31.31 0 0 0 0 .396A10.3 10.3 0 0 0 13 5m-6.5-.314a9.15 9.15 0 1 0 4.687-1.801" opacity=".28" fill="none"/>
    </svg>
  );
}
