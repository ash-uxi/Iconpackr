...
/**
 * PiPeerlistDuoSolid icon from the duo-solid style in apps-&-social category.
 */
interface PiPeerlistDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPeerlistDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'peerlist icon',
  ...props
}: PiPeerlistDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
