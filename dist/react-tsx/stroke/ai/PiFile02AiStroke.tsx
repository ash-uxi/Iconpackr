...
export default function PiFile02AiStroke({
  ...
  <path d="M8 17H8.01M12 10C11.3625 11.6165 10.6609 12.345 9 13C10.6609 13.655 11.3625 14.3835 12 16C12.6375 14.3835 13.3391 13.655 15 13C13.3391 12.345 12.6375 11.6165 12 10Z" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
