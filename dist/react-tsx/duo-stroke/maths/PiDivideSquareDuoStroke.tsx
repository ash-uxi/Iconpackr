 ...
 */
interface PiDivideSquareDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiDivideSquareDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'divide-square icon',
  ...props
}: PiDivideSquareDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
