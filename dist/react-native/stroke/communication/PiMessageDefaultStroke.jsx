...
/**
 * Pimessagedefaultstroke icon component for React Native
...
const Pimessagedefaultstroke = ({
  ...
  >
    <path
      ...
      fill="none"
    />
    <path d="M7 12H14" stroke={color} strokeWidth="2" fill="none" />
    <path d="M7 8H17" stroke={color} strokeWidth="2" fill="none" />
  </Svg>
);

export default Pimessagedefaultstroke;
