...
/**
 * PiChatCheckDuoSolid icon from the duo-solid style in communication category.
 */
interface PiChatCheckDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiChatCheckDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'chat-check icon',
  ...props
}: PiChatCheckDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
