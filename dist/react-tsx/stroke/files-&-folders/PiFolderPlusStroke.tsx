...
/**
 * PiFolderPlusStroke icon from the stroke style in files-&-folders category.
 */
interface PiFolderPlusStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderPlusStroke({
  size = 24,
  color,
  className,
