...
export default function PiYoutubeStroke({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M14.9806 11.1318C15.6524 11.5157 15.6524 12.4843 14.9806 12.8682L10.9961 15.1451C10.3295 15.526 9.5 15.0446 9.5 14.2768L9.5 9.72318C9.5 8.95536 10.3295 8.47399 10.9961 8.85494L14.9806 11.1318Z" stroke="currentColor" strokeWidth="2" fill="none"/>
