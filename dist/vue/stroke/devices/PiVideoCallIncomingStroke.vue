<template>
  ...
  <path d="M6.15076 10.6033C5.97628 11.8247 5.95325 13.0622 6.08166 14.2878C6.09903 14.4535 6.17298 14.6017 6.28402 14.7127M10.3934 14.846C9.17206 15.0204 7.93457 15.0435 6.70897 14.9151C6.54321 14.8977 6.39507 14.8238 6.28402 14.7127M6.28402 14.7127L12 9" stroke="currentColor" stroke-width="2" fill="none"/>
  </svg>
</template>
 ...
 */
export default {
  name: 'PiVideoCallIncomingStroke',
  props: {
    size: {
      type: Number,
      default: 24
