...
/**
 * Pihomewifiduosolid icon component for React Native
...
const Pihomewifiduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M9.716 14.716a4 4 0 0 1 4.569 0m-7.42-2.851a8 8 0 0 1 10.27 0M12 18h.01m8.871-7.243a4 4 0 0 0-.513-1.19c-.265-.414-.634-.763-1.374-1.461l-2.6-2.456c-1.546-1.46-2.32-2.19-3.201-2.466a4 4 0 0 0-2.386 0c-.882.275-1.655 1.006-3.201 2.466l-2.6 2.456c-.74.698-1.11 1.047-1.374 1.46a4 4 0 0 0-.513 1.191" />
  </Svg>
);

export default Pihomewifiduosolid;
