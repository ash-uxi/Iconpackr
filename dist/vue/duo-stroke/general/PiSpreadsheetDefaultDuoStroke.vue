 ...
 */
export default {
  name: 'PiSpreadsheetDefaultDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'spreadsheet-default icon'
    }
  }
}
</script>
