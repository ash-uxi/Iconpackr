...
/**
 * PiBarchartUpStroke icon from the stroke style in chart-&-graph category.
 */
interface PiBarchartUpStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBarchartUpStroke({
  size = 24,
  color,
  className,
