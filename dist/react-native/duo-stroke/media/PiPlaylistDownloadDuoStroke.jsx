...
/**
 * Piplaylistdownloadduostroke icon component for React Native
 ...
 */
const Piplaylistdownloadduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "playlist download icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      d="M15 16.2081C14.2598 17.1951 13.401 18.0864 12.4436 18.8622C12.3141 18.9672 12.157 19.0196 12 19.0196M9 16.2081C9.74024 17.1951 10.599 18.0864 11.5564 18.8622C11.6859 18.9672 11.843 19.0196 12 19.0196M12 19.0196V13"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Piplaylistdownloadduostroke;
