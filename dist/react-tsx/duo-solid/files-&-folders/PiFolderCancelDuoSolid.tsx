...
/**
 * PiFolderCancelDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFolderCancelDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderCancelDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-cancel icon',
  ...props
}: PiFolderCancelDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
