 ...
 */
interface PiMessageCheckDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageCheckDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'message-check icon',
  ...props
}: PiMessageCheckDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M8.5 10.3088L10.8412 12.6475C11.9893 10.6397 13.5934 8.94506 15.5 7.64258" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
