...
/**
 * PiNftBoltMintStroke icon from the stroke style in web3-&-crypto category.
 */
interface PiNftBoltMintStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiNftBoltMintStroke({
  size = 24,
  color,
  className,
