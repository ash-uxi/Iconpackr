...
/**
 * Pifolderarrowdownduostroke icon component for React Native
 ...
 */
const Pifolderarrowdownduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      d="M12 11V17M12 17C11.8953 17 11.7906 16.965 11.7043 16.8951C11.066 16.3779 10.4935 15.7836 10 15.1256M12 17C12.1047 17 12.2094 16.965 12.2957 16.8951C12.934 16.3779 13.5065 15.7836 14 15.1256"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pifolderarrowdownduostroke;
