 ...
 */
interface PiFolderArrowLeftDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowLeftDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-left icon',
  ...props
}: PiFolderArrowLeftDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M15 14H9M9 14C9 14.1047 9.035 14.2094 9.1049 14.2957C9.6221 14.934 10.2164 15.5065 10.8744 16M9 14C9 13.8953 9.035 13.7906 9.1049 13.7043C9.6221 13.066 10.2164 12.4935 10.8744 12" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
