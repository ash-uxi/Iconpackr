...
/**
 * Pifolderquestionmarkstroke icon component for React Native
 ...
 */
const Pifolderquestionmarkstroke = ({
  color = "#000",
  size = 24,
...
export default Pifolderquestionmarkstroke;
