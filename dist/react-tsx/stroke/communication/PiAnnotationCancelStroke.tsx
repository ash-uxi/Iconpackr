...
/**
 * PiAnnotationCancelStroke icon from the stroke style in communication category.
 */
interface PiAnnotationCancelStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationCancelStroke({
  size = 24,
  color,
  className,
