...
/**
 * PiCalendarRangeContrast icon from the contrast style in time category.
 */
interface PiCalendarRangeContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarRangeContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'calendar-range icon',
  ...props
}: PiCalendarRangeContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
