...
export default function PiGraphChartMaximumDuoStroke({ 
  ...
  <path d="M7 17C7.82746 11.8168 10.6479 8 14 8C17.3521 8 20.1725 11.8168 21 17M8 5H8.01M11 5H11.01M17 5H17.01M20 5H20.01M13.99 5H14" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
