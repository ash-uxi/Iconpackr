...
/**
 * Piswaparrowhorizontalsolid icon component for React Native
 ...
 */
const Piswaparrowhorizontalsolid = ({
  color = "#000",
  size = 24,
...
export default Piswaparrowhorizontalsolid;
