...
/**
 * Picreditcardremovestroke icon component for React Native
 ...
 */
const Picreditcardremovestroke = ({
  color = "#000",
  size = 24,
...
export default Picreditcardremovestroke;
