...
/**
 * PiSidebarLeftDottedStroke icon from the stroke style in general category.
 */
interface PiSidebarLeftDottedStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSidebarLeftDottedStroke({
  size = 24,
  color,
  className,
