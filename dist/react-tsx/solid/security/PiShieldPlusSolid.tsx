...
/**
 * PiShieldPlusSolid icon from the solid style in security category.
 */
interface PiShieldPlusSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiShieldPlusSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'shield-plus icon',
  ...props
}: PiShieldPlusSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
