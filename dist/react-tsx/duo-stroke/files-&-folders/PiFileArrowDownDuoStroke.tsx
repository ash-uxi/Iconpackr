 ...
 */
interface PiFileArrowDownDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowDownDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-down icon',
  ...props
}: PiFileArrowDownDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
