...
/**
 * Pilightningthunderelectriconduostroke icon component for React Native
 ...
 */
const Pilightningthunderelectriconduostroke = ({
  color = "#000",
  size = 24,
...
export default Pilightningthunderelectriconduostroke;
