...
/**
 * Pirocketshipduostroke icon component for React Native
 ...
 */
const Pirocketshipduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "rocket ship icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pirocketshipduostroke;
