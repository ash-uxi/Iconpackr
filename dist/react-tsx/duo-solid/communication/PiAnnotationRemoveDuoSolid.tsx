...
/**
 * PiAnnotationRemoveDuoSolid icon from the duo-solid style in communication category.
 */
interface PiAnnotationRemoveDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationRemoveDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'annotation-remove icon',
  ...props
}: PiAnnotationRemoveDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
