...
/**
 * PiWindowDockRightContrast icon from the contrast style in devices category.
 */
interface PiWindowDockRightContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWindowDockRightContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'window-dock-right icon',
  ...props
}: PiWindowDockRightContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
