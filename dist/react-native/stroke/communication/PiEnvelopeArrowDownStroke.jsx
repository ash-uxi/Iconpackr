...
/**
 * Pienvelopearrowdownstroke icon component for React Native
 ...
 */
const Pienvelopearrowdownstroke = ({
  color = "#000",
  size = 24,
...
export default Pienvelopearrowdownstroke;
