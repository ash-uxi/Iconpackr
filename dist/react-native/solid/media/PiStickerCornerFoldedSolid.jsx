...
/**
 * Pistickercornerfoldedsolid icon component for React Native
 ...
 */
const Pistickercornerfoldedsolid = ({
  color = "#000",
  size = 24,
...
export default Pistickercornerfoldedsolid;
