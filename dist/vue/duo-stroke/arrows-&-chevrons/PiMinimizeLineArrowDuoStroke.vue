<template>
  <svg
    ...
    v-bind="$attrs"
  >
    <path d="M12.7072 11.2928L20 4M11.293 12.707L4 20" :stroke="color || 'currentColor'" stroke-width="2" opacity="0.28" fill="none"/>
  <path d="M12.7444 5.59863C12.4439 7.36581 12.3719 9.15103 12.5299 10.9097C12.5434 11.0606 12.6081 11.1939 12.7071 11.2929C12.806 11.3918 12.9394 11.4565 13.0902 11.47C14.8489 11.628 16.6341 11.5561 18.4013 11.2555M11.2555 18.4013C11.5561 16.6341 11.628 14.8489 11.47 13.0902C11.4565 12.9394 11.3918 12.806 11.2929 12.7071C11.1939 12.6081 11.0606 12.5434 10.9097 12.5299C9.15104 12.3719 7.36581 12.4439 5.59863 12.7444" :stroke="color || 'currentColor'" stroke-width="2" fill="none"/>
  </svg>
</template>
 ...
 */
export default {
  name: 'PiMinimizeLineArrowDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'minimize-line-arrow icon'
    }
  }
}
</script>
