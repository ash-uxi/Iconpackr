...
/**
 * Picaptiononstroke icon component for React Native
 ...
 */
const Picaptiononstroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "caption on icon",
  style,
  ...props
}) => (
  <Svg
...
export default Picaptiononstroke;
