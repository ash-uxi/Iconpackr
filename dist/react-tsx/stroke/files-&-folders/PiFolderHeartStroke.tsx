...
/**
 * PiFolderHeartStroke icon from the stroke style in files-&-folders category.
 */
interface PiFolderHeartStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderHeartStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-heart icon',
  ...props
}: PiFolderHeartStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12 16.625C12.35 16.625 15.5 14.9237 15.5 12.5418C15.5 11.3509 14.45 10.515 13.4 10.5002C12.875 10.4928 12.35 10.6704 12 11.1808C11.65 10.6704 11.1159 10.5002 10.6 10.5002C9.55 10.5002 8.5 11.3509 8.5 12.5418C8.5 14.9237 11.65 16.625 12 16.625Z" stroke="currentColor" strokeWidth="2" fill="none"/>
