...
/**
 * Piannotationinformationduosolid icon component for React Native
 ...
 */
const Piannotationinformationduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M12 10.501v4M11.994 7h.01" />{" "}
    <path
      fill={color || "#000"}
...
export default Piannotationinformationduosolid;
