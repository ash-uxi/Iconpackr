...
/**
 * Piannotationplusduosolid icon component for React Native
 ...
 */
const Piannotationplusduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M9 11h3m0 0h3m-3 0V8m0 3v3" />
  </Svg>
);

export default Piannotationplusduosolid;
