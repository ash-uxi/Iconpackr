...
/**
 * Pilightningthunderelectricoffcontrast icon component for React Native
 ...
 */
const Pilightningthunderelectricoffcontrast = ({
  color = "#000",
  size = 24,
...
export default Pilightningthunderelectricoffcontrast;
