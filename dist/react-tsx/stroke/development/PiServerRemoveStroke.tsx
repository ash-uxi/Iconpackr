...
/**
 * PiServerRemoveStroke icon from the stroke style in development category.
 */
interface PiServerRemoveStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiServerRemoveStroke({
  size = 24,
  color,
  className,
