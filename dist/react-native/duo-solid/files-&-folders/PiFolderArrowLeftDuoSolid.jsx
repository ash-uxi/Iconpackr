...
/**
 * Pifolderarrowleftduosolid icon component for React Native
 ...
 */
const Pifolderarrowleftduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M15 14H9m0 0c0 .105.035.21.105.296A10 10 0 0 0 10.875 16M9 14c0-.105.035-.21.105-.296A10 10 0 0 1 10.875 12" />{" "}
    <path
      fill={color || "#000"}
...
export default Pifolderarrowleftduosolid;
