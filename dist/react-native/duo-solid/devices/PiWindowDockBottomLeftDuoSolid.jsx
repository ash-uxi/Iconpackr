...
/**
 * Piwindowdockbottomleftduosolid icon component for React Native
 ...
 */
const Piwindowdockbottomleftduosolid = ({
  color = "#000",
  size = 24,
...
export default Piwindowdockbottomleftduosolid;
