...
export default function PiMouseScrollDownDuoStroke({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M14 9.5C13.5065 10.158 12.934 10.7522 12.2957 11.2694C12.2094 11.3394 12.1047 11.3744 12 11.3744C11.8953 11.3744 11.7906 11.3394 11.7043 11.2694C11.066 10.7522 10.4935 10.158 10 9.5" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
