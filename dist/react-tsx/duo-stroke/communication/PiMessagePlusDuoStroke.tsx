 ...
 */
interface PiMessagePlusDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessagePlusDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'message-plus icon',
  ...props
}: PiMessagePlusDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
