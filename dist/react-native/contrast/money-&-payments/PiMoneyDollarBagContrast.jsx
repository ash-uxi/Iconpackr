...
/**
 * Pimoneydollarbagcontrast icon component for React Native
 ...
 */
const Pimoneydollarbagcontrast = ({
  color = "#000",
  size = 24,
  ...
  >
    ...
    <path
      fill={color}
      d="M8.192 21.765c2.53.313 5.088.313 7.617 0 7.813-.969 5.263-12.746-.922-14.777a5.9 5.9 0 0 0-1.85-.298h-2.073q-.483 0-.945.076C3.194 7.876.008 20.75 8.192 21.765"
      opacity={0.28}
    />
  </Svg>
);

export default Pimoneydollarbagcontrast;
