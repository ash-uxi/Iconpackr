...
export default function PiUserUser03Stroke({ 
  ...
  <path d="M5.86595 21H18.1341C19.1646 21 20 20.1646 20 19.1341C20 16.0501 17.0608 13.8148 14.0889 14.6387L13.393 14.8317C12.4815 15.0843 11.5185 15.0843 10.607 14.8317L9.91111 14.6387C6.9392 13.8148 4 16.0501 4 19.1341C4 20.1646 4.83541 21 5.86595 21Z" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
