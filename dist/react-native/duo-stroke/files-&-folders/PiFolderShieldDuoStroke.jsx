...
/**
 * Pifoldershieldduostroke icon component for React Native
 ...
 */
const Pifoldershieldduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "folder shield icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pifoldershieldduostroke;
