...
export default function PiEnvelopeArrowLeftDuoStroke({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 20.0001H10C7.19974 20.0001 5.79961 20.0001 4.73005 19.4552C3.78924 18.9758 3.02433 18.2109 2.54497 17.2701C2 16.2005 2 14.8004 2 12.0001C2 10.0061 2 8.72202 2.19678 7.76172M21.8032 7.76172C22 8.72202 22 10.0061 22 12.0001C22 13.5239 22 14.6332 21.9122 15.5001" stroke={color || "currentColor"} strokeWidth="2" opacity="0.28" fill="none"/>
