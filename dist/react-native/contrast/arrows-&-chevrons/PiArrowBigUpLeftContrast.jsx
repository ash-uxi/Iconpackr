...
/**
 * Piarrowbigupleftcontrast icon component for React Native
 ...
 */
const Piarrowbigupleftcontrast = ({
  color = "#000",
  size = 24,
...
export default Piarrowbigupleftcontrast;
