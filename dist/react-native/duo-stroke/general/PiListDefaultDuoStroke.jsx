...
/**
 * Pilistdefaultduostroke icon component for React Native
 ...
 */
const Pilistdefaultduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "list default icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pilistdefaultduostroke;
