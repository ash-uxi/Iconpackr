...
/**
 * PiChatPlusDuoSolid icon from the duo-solid style in communication category.
 */
interface PiChatPlusDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiChatPlusDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'chat-plus icon',
  ...props
}: PiChatPlusDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
