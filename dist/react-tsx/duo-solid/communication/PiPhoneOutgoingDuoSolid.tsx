...
/**
 * PiPhoneOutgoingDuoSolid icon from the duo-solid style in communication category.
 */
interface PiPhoneOutgoingDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhoneOutgoingDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'phone-outgoing icon',
  ...props
}: PiPhoneOutgoingDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
