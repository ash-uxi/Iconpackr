...
/**
 * Piwalletarrowupduosolid icon component for React Native
...
const Piwalletarrowupduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M14 12h3m.428 6.412c.635-.846 1.371-1.61 2.192-2.275a.6.6 0 0 1 .38-.135m2.571 2.41a12.9 12.9 0 0 0-2.19-2.275.6.6 0 0 0-.381-.135m0 0v6" />{" "}
    <path
      fill={color || "#000"}
...
export default Piwalletarrowupduosolid;
