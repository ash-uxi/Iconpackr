...
/**
 * Piairplaneliftoffduostroke icon component for React Native
 ...
 */
const Piairplaneliftoffduostroke = ({
  color = "#000",
  size = 24,
...
export default Piairplaneliftoffduostroke;
