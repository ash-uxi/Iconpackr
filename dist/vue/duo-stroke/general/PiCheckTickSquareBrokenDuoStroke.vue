 ...
 */
export default {
  name: 'PiCheckTickSquareBrokenDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'check-tick-square-broken icon'
    }
  }
}
</script>
