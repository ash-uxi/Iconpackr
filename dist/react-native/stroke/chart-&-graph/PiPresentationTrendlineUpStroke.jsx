...
/**
 * Pipresentationtrendlineupstroke icon component for React Native
 ...
 */
const Pipresentationtrendlineupstroke = ({
  color = "#000",
  size = 24,
...
export default Pipresentationtrendlineupstroke;
