...
/**
 * PiAnnotationPlusDuoSolid icon from the duo-solid style in communication category.
 */
interface PiAnnotationPlusDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationPlusDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'annotation-plus icon',
  ...props
}: PiAnnotationPlusDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
