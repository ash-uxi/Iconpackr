...
/**
 * Pifile02heartduostroke icon component for React Native
...
const Pifile02heartduostroke = ({
  ...
  >
    <path
      d="M12 17.625C12.35 17.625 15.5 15.9237 15.5 13.5418C15.5 12.3509 14.45 11.515 13.4 11.5002C12.875 11.4928 12.35 11.6704 12 12.1808C11.65 11.6704 11.1159 11.5002 10.6 11.5002C9.55 11.5002 8.5 12.3509 8.5 13.5418C8.5 15.9237 11.65 17.625 12 17.625Z"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pifile02heartduostroke;
