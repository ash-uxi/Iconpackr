...
/**
 * PiAnnotationInformationDuoSolid icon from the duo-solid style in communication category.
 */
interface PiAnnotationInformationDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationInformationDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'annotation-information icon',
  ...props
}: PiAnnotationInformationDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
