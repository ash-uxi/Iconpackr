 ...
 */
interface PiCheckTickCircleBrokenStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCheckTickCircleBrokenStroke({
  ...
  ...props
}: PiCheckTickCircleBrokenStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
