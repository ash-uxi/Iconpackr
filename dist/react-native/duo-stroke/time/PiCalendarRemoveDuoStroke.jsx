...
/**
 * Picalendarremoveduostroke icon component for React Native
 ...
 */
const Picalendarremoveduostroke = ({
  color = "#000",
  size = 24,
...
export default Picalendarremoveduostroke;
