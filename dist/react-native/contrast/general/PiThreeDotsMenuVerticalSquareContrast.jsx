...
/**
 * Pithreedotsmenuverticalsquarecontrast icon component for React Native
 ...
 */
const Pithreedotsmenuverticalsquarecontrast = ({
  color = "#000",
  size = 24,
...
export default Pithreedotsmenuverticalsquarecontrast;
