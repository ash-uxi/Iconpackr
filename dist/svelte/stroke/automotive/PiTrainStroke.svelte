<script>
  ...
  export let ariaLabel = 'train icon';
</script>
...
<svg
  ...
  {...$$restProps}
>
  <path d="M12 3V13" stroke="currentColor" stroke-width="2" fill="none"/>
  <path d="M16 16H17" stroke="currentColor" stroke-width="2" fill="none"/>
  <path d="M16 19L18 22" stroke="currentColor" stroke-width="2" fill="none"/>
  ...
  <path d="M8 19L6 22" stroke="currentColor" stroke-width="2" fill="none"/>
</svg>
