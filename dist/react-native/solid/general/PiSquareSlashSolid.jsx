...
/**
 * Pisquareslashsolid icon component for React Native
 ...
 */
const Pisquareslashsolid = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "square slash icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pisquareslashsolid;
