...
/**
 * Piarrowturnrightdowncontrast icon component for React Native
 ...
 */
const Piarrowturnrightdowncontrast = ({
  color = "#000",
  size = 24,
  ...
  >
    ...
    <path
      fill={color}
      d="M20 15.142a25.2 25.2 0 0 1-4.505 4.684.79.79 0 0 1-.99 0A25.2 25.2 0 0 1 10 15.142c.935.16 1.402.24 1.87.302a24 24 0 0 0 6.26 0c.468-.062.935-.142 1.87-.302"
      opacity={0.28}
    />
  </Svg>
);

export default Piarrowturnrightdowncontrast;
