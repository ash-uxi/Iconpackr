<template>
  ...
  <path d="M9 13.6663L11.3412 16.005C12.4672 14.036 14.0256 12.3484 15.8987 11.0693" :stroke="color || 'currentColor'" stroke-width="2" fill="none"/>
  </svg>
</template>

<script>
/**
 * PiFolderCheckDuoStroke icon from the duo-stroke style in files-&-folders category.
 */
export default {
  name: 'PiFolderCheckDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
