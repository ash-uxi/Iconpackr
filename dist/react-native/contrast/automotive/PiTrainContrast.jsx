...
/**
 * Pitraincontrast icon component for React Native
...
const Pitraincontrast = ({
  ...
  >
    ...
    <path
      fill={color}
      d="M7.2 19h9.6c1.12 0 1.68 0 2.108-.218a2 2 0 0 0 .874-.874C20 17.48 20 16.92 20 15.8V13H4v2.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874C5.52 19 6.08 19 7.2 19"
      opacity={0.28}
    />
    <path d="m8 19-2 3" />
  </Svg>
...
export default Pitraincontrast;
