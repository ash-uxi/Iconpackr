...
/**
 * PiCameraCheckDuoStroke icon from the duo-stroke style in devices category.
 */
interface PiCameraCheckDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCameraCheckDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'camera-check icon',
  ...props
}: PiCameraCheckDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
