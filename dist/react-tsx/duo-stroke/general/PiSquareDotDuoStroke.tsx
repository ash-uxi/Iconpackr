 ...
 */
interface PiSquareDotDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSquareDotDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'square-dot icon',
  ...props
}: PiSquareDotDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
