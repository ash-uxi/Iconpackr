...
/**
 * PiFileArrowRightContrast icon from the contrast style in files-&-folders category.
 */
interface PiFileArrowRightContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowRightContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-right icon',
  ...props
}: PiFileArrowRightContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
