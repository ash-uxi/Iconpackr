...
/**
 * Picameradefaultstroke icon component for React Native
 ...
 */
const Picameradefaultstroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "camera default icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      d="M12.0001 16C13.657 16 15.0001 14.6569 15.0001 13C15.0001 11.3431 13.657 10 12.0001 10C10.3433 10 9.00012 11.3431 9.00012 13C9.00012 14.6569 10.3433 16 12.0001 16Z"
      stroke={color}
      strokeWidth="2"
      fill="none"
    />
    <path
      ...
      fill="none"
    />
    <path d="M17.0001 10V10.01" stroke={color} strokeWidth="2" fill="none" />
  </Svg>
);

export default Picameradefaultstroke;
