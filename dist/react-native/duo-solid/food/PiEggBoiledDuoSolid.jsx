...
/**
 * Pieggboiledduosolid icon component for React Native
...
const Pieggboiledduosolid = ({
  ...
  >
    ...
    />{" "}
    <path
      d="M7.5 14C7.5 11.5147 9.51472 9.5 12 9.5C14.4853 9.5 16.5 11.5147 16.5 14C16.5 16.4853 14.4853 18.5 12 18.5C9.51472 18.5 7.5 16.4853 7.5 14Z"
      fill={color || "#000"}
      fillRule="evenodd"
      clipRule="evenodd"
    />
...
export default Pieggboiledduosolid;
