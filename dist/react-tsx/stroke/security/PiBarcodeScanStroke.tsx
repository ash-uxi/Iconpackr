...
/**
 * PiBarcodeScanStroke icon from the stroke style in security category.
 */
interface PiBarcodeScanStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBarcodeScanStroke({
  size = 24,
  color,
  className,
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M16 9V15M12 13V9M8 15V9" stroke="currentColor" strokeWidth="2" fill="none"/>
