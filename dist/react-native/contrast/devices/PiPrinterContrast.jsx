...
/**
 * Piprintercontrast icon component for React Native
...
const Piprintercontrast = ({
  ...
  >
    <path
      fill={color}
      d="M15.6 6H8.4c-.946 0-1.692 0-2.303.033-.836.045-1.419.151-1.913.403a4 4 0 0 0-1.748 1.748C2 9.04 2 10.16 2 12.4v.8c0 1.68 0 2.52.327 3.162a3 3 0 0 0 1.311 1.311c.552.281 1.25.32 2.505.326l.194-.678c.238-.832.356-1.248.6-1.557a2 2 0 0 1 .815-.615C8.116 15 8.55 15 9.414 15h5.172c.865 0 1.298 0 1.662.149.32.13.602.343.816.615.243.309.361.725.6 1.557l.193.678c1.254-.005 1.953-.045 2.505-.326a3 3 0 0 0 1.311-1.311C22 15.72 22 14.88 22 13.2v-.8c0-2.24 0-3.36-.436-4.216a4 4 0 0 0-1.748-1.748c-.494-.252-1.077-.358-1.913-.403C17.293 6 16.546 6 15.6 6"
      opacity={0.2}
    />
