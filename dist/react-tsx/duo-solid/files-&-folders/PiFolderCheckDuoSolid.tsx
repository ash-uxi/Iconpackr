...
/**
 * PiFolderCheckDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFolderCheckDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderCheckDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-check icon',
  ...props
}: PiFolderCheckDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
