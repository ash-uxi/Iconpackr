...
/**
 * Pigrid02duosolid icon component for React Native
...
const Pigrid02duosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M21 9h-6m0 0H9m6 0v6m0-6V3M9 9H3m6 0v6m0-6V3m6 18v-6m0 0h6m-6 0H9m0 0H3m6 0v6" />{" "}
    <path
      fill={color || "#000"}
...
export default Pigrid02duosolid;
