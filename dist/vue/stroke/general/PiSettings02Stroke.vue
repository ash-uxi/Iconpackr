<template>
  ...
  <path d="M10.9909 12C10.9909 11.4477 11.4478 11 12 11C12.5523 11 13.0092 11.4477 13.0092 12C13.0092 12.5523 12.5523 13 12 13C11.4478 13 10.9909 12.5523 10.9909 12Z" stroke="currentColor" stroke-width="2" fill="none"/>
  </svg>
</template>
