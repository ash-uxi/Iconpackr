...
/**
 * PiClipboardTextStroke icon from the stroke style in files-&-folders category.
 */
interface PiClipboardTextStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardTextStroke({
  size = 24,
  color,
  className,
