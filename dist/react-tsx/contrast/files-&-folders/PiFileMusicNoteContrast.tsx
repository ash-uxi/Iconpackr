...
/**
 * PiFileMusicNoteContrast icon from the contrast style in files-&-folders category.
 */
interface PiFileMusicNoteContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileMusicNoteContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'file-music-note icon',
  ...props
}: PiFileMusicNoteContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
