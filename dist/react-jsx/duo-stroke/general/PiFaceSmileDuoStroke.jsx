...
export default function PiFaceSmileDuoStroke({ 
  ...
  <path d="M9 9.99951L9 10.9995M15 9.99951V10.9995M8.4292 14.4995C9.33666 15.4252 10.6012 15.9995 11.9999 15.9995C13.3986 15.9995 14.6632 15.4252 15.5706 14.4995" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
