...
export default function PiCreditCardSolid({
  ...
  ...props
}: PiCreditCardSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
