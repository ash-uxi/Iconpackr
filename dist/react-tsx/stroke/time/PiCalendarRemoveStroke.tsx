...
/**
 * PiCalendarRemoveStroke icon from the stroke style in time category.
 */
interface PiCalendarRemoveStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarRemoveStroke({
  size = 24,
  color,
  className,
