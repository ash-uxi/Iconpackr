...
/**
 * PiSidebarLeftCloseContrast icon from the contrast style in general category.
 */
interface PiSidebarLeftCloseContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSidebarLeftCloseContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'sidebar-left-close icon',
  ...props
}: PiSidebarLeftCloseContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
