...
/**
 * Picartonstroke icon component for React Native
 ...
 */
const Picartonstroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "carton icon",
  style,
  ...props
}) => (
  <Svg
