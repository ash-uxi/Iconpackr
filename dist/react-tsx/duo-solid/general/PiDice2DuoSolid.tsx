...
/**
 * PiDice2DuoSolid icon from the duo-solid style in general category.
 */
interface PiDice2DuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiDice2DuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'dice-2 icon',
  ...props
}: PiDice2DuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
