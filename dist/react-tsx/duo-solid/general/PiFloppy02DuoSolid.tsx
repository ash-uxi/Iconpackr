...
/**
 * PiFloppy02DuoSolid icon from the duo-solid style in general category.
 */
interface PiFloppy02DuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFloppy02DuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'floppy-02 icon',
  ...props
}: PiFloppy02DuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
