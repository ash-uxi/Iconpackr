...
/**
 * PiSquareSlashSolid icon from the solid style in general category.
 */
interface PiSquareSlashSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSquareSlashSolid({
  size = 24,
  color,
  className,
