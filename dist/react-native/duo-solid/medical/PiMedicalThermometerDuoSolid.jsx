...
/**
 * Pimedicalthermometerduosolid icon component for React Native
 ...
 */
const Pimedicalthermometerduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="m11.15 13.85 1.188 1.187m1.54-3.916 1.188 1.188M16.5 8.5l1.188 1.188" />{" "}
    <path
      fill={color || "#000"}
      ...
      opacity={0.28}
    />{" "}
    <path d="m5.5 18.5 2.191-.157m-2.191.158.157-2.192c.064-.88.095-1.321.217-1.733a4 4 0 0 1 .472-1.035c.233-.362.545-.674 1.17-1.299l8.373-8.374M5.5 18.501 3 21" />
  </Svg>
);

export default Pimedicalthermometerduosolid;
