...
/**
 * Pifolderarrowrightstroke icon component for React Native
 ...
 */
const Pifolderarrowrightstroke = ({
  color = "#000",
  size = 24,
...
export default Pifolderarrowrightstroke;
