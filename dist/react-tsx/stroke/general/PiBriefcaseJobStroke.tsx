...
/**
 * PiBriefcaseJobStroke icon from the stroke style in general category.
 */
interface PiBriefcaseJobStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBriefcaseJobStroke({
  size = 24,
  color,
  className,
