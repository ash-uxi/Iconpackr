...
export default function PiPhotoImageArrowDownDuoStroke({
  ...
  <path  fillRule="evenodd" d="M17.99 22.64a1.6 1.6 0 0 0 2.02 0 13.9 13.9 0 0 0 2.361-2.451 1 1 0 1 0-1.6-1.2q-.362.482-.771.926V16a1 1 0 0 0-2 0v3.916q-.41-.443-.771-.926a1 1 0 0 0-1.6 1.2 13.9 13.9 0 0 0 2.361 2.452M5.5 8.5a2 2 0 1 1 4 0 2 2 0 0 1-4 0" clipRule="evenodd" fill="none"/>
