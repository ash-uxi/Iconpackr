 ...
 */
interface PiThermometerAddStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiThermometerAddStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'thermometer-add icon',
  ...props
}: PiThermometerAddStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M4.99999 9.99998V6.99999M4.99999 6.99999V4M4.99999 6.99999H2M4.99999 6.99999H7.99999" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
