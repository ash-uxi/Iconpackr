 ...
 */
interface PiFileMusicNoteDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileMusicNoteDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-music-note icon',
  ...props
}: PiFileMusicNoteDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
