...
/**
 * Pimediaskipbackward10duostroke icon component for React Native
 ...
 */
const Pimediaskipbackward10duostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "media skip backward10 icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pimediaskipbackward10duostroke;
