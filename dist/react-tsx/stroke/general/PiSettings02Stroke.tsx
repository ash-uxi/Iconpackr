 ...
 */
interface PiSettings02StrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSettings02Stroke({
  ...
  ...props
}: PiSettings02StrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
