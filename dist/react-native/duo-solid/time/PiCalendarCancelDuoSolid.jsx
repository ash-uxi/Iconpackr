...
/**
 * Picalendarcancelduosolid icon component for React Native
 ...
 */
const Picalendarcancelduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M16 2v4M8 2v4m1.5 10.5L12 14m0 0 2.5-2.5M12 14l-2.5-2.5M12 14l2.5 2.5" />
  </Svg>
);

export default Picalendarcancelduosolid;
