...
/**
 * Pipursebagaddduosolid icon component for React Native
...
const Pipursebagaddduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M12 17v-3m0 0v-3m0 3H9m3 0h3" />{" "}
    <path
      fill={color || "#000"}
...
export default Pipursebagaddduosolid;
