...
/**
 * Piterminalconsolesquareduosolid icon component for React Native
 ...
 */
const Piterminalconsolesquareduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="m7 12 2-2-2-2m5 4h3" />
  </Svg>
);

export default Piterminalconsolesquareduosolid;
