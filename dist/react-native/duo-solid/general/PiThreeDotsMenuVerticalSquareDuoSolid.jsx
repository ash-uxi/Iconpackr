...
/**
 * Pithreedotsmenuverticalsquareduosolid icon component for React Native
 ...
 */
const Pithreedotsmenuverticalsquareduosolid = ({
  color = "#000",
  size = 24,
