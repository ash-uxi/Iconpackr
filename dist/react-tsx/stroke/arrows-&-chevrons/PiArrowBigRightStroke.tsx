 ...
 */
interface PiArrowBigRightStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiArrowBigRightStroke({
  ...
  ...props
}: PiArrowBigRightStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
