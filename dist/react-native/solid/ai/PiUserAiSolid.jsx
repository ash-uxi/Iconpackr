...
/**
 * Piuseraisolid icon component for React Native
...
const Piuseraisolid = ({
  ...
  >
    ...
    />
    <path
      d="M8 14H14.3722C14.2537 14.0603 14.0998 14.1301 13.8993 14.2092C12.7532 14.6612 12 15.768 12 17C12 17.5271 12.1379 18.0313 12.3854 18.4711C11.5523 19.0041 11 19.9376 11 21C11 21.3506 11.0602 21.6872 11.1707 22H6C4.34315 22 3 20.6569 3 19C3 16.2386 5.23858 14 8 14Z"
      fill={color}
      stroke="none"
    />
  </Svg>
