...
/**
 * PiMessageSearchContrast icon from the contrast style in communication category.
 */
interface PiMessageSearchContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageSearchContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'message-search icon',
  ...props
}: PiMessageSearchContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M15.107 13.247 13.44 11.58m0 0a2.663 2.663 0 1 0-3.766-3.766 2.663 2.663 0 0 0 3.766 3.766"/>
