...
/**
 * Piinboxincomingduostroke icon component for React Native
 ...
 */
const Piinboxincomingduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "inbox incoming icon",
  style,
  ...props
}) => (
  <Svg
...
export default Piinboxincomingduostroke;
