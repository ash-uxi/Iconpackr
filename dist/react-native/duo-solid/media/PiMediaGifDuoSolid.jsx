...
/**
 * Pimediagifduosolid icon component for React Native
...
const Pimediagifduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M9.5 8.75H8a2 2 0 0 0-2 2v2.5a2 2 0 0 0 2 2h1.5V12h-.713m4.06-3.25v6.5m5.195-6.5h-1a1 1 0 0 0-1 1v2.256m0 0v3.244m0-3.244h2" />
  </Svg>
);

export default Pimediagifduosolid;
