...
/**
 * PiWalletArrowLeftDuoSolid icon from the duo-solid style in web3-&-crypto category.
 */
interface PiWalletArrowLeftDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletArrowLeftDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'wallet-arrow-left icon',
  ...props
}: PiWalletArrowLeftDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
