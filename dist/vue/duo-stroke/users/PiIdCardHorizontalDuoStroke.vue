...
<script>
/**
 * PiIdCardHorizontalDuoStroke icon from the duo-stroke style in users category.
 */
export default {
  name: 'PiIdCardHorizontalDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
