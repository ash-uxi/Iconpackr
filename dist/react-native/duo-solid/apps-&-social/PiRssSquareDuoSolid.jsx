...
/**
 * Pirsssquareduosolid icon component for React Native
...
const Pirsssquareduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M7 7a10 10 0 0 1 10 10M7 11.737A5.263 5.263 0 0 1 12.263 17m-5.007-.263h.007" />
  </Svg>
);

export default Pirsssquareduosolid;
