...
/**
 * Piarchivedefaultduostroke icon component for React Native
 ...
 */
const Piarchivedefaultduostroke = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M10 12H14" stroke={color || "#000"} strokeWidth="2" fill="none" />
    <path
...
export default Piarchivedefaultduostroke;
