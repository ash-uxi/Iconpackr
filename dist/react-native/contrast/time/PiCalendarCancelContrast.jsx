...
/**
 * Picalendarcancelcontrast icon component for React Native
 ...
 */
const Picalendarcancelcontrast = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "calendar cancel icon",
  style,
  ...props
}) => (
  <Svg
...
export default Picalendarcancelcontrast;
