 ...
 */
export default {
  name: 'PiSidebarNavigationBarDuoSolid',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'sidebar-navigation-bar icon'
    }
  }
}
</script>
