...
/**
 * Pipresentationtrendlinedownstroke icon component for React Native
 ...
 */
const Pipresentationtrendlinedownstroke = ({
  color = "#000",
  size = 24,
...
export default Pipresentationtrendlinedownstroke;
