 ...
 */
interface PiPackage02DuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPackage02DuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'package-02 icon',
  ...props
}: PiPackage02DuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
