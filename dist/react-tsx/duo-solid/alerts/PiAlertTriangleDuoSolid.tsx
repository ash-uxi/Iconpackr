...
/**
 * PiAlertTriangleDuoSolid icon from the duo-solid style in alerts category.
 */
interface PiAlertTriangleDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAlertTriangleDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'alert-triangle icon',
  ...props
}: PiAlertTriangleDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
