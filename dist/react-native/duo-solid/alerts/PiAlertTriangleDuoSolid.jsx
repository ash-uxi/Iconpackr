...
/**
 * Pialerttriangleduosolid icon component for React Native
...
const Pialerttriangleduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M12 13V9m0 7.375v.001" />
  </Svg>
);

export default Pialerttriangleduosolid;
