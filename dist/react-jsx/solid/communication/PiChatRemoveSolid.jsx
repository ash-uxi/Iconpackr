...
/**
 * PiChatRemoveSolid icon from the solid style in communication category.
 ...
 */
export default function PiChatRemoveSolid({ 
  size = 24, 
  color,
  className,
