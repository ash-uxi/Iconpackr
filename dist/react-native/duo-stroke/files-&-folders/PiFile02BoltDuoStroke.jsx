...
/**
 * Pifile02boltduostroke icon component for React Native
 ...
 */
const Pifile02boltduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "file02 bolt icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pifile02boltduostroke;
