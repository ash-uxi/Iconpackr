...
/**
 * PiPurseBagRemoveStroke icon from the stroke style in general category.
 */
interface PiPurseBagRemoveStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPurseBagRemoveStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'purse-bag-remove icon',
  ...props
}: PiPurseBagRemoveStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
