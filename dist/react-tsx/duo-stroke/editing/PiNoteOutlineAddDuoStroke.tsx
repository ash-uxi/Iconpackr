 ...
 */
interface PiNoteOutlineAddDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiNoteOutlineAddDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'note-outline-add icon',
  ...props
}: PiNoteOutlineAddDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
