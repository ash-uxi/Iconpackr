...
/**
 * Pikeyboardwirelessstroke icon component for React Native
 ...
 */
const Pikeyboardwirelessstroke = ({
  color = "#000",
  size = 24,
...
export default Pikeyboardwirelessstroke;
