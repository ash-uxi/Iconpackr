...
export default function PiGaugeUpDuoStroke({ 
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 7.00049L12.9227 11.8873C13.0318 12.4655 12.5884 13.0005 12 13.0005C11.4116 13.0005 10.9682 12.4655 11.0774 11.8873L12 7.00049Z" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
