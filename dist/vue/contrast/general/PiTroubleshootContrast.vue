<template>
  <svg
    ...
    v-bind="$attrs"
  >
    <path fill="currentColor" fill-rule="evenodd" d="M18.364 18.364A8.97 8.97 0 0 0 21 12a8.97 8.97 0 0 0-2.636-6.364A8.97 8.97 0 0 0 12 3a8.97 8.97 0 0 0-6.364 2.636A8.97 8.97 0 0 0 3 12a8.97 8.97 0 0 0 2.636 6.364A8.97 8.97 0 0 0 12 21a8.97 8.97 0 0 0 6.364-2.636M9.879 9.879A3 3 0 0 1 12 9c.828 0 1.58.337 2.121.879.542.542.879 1.293.879 2.121s-.337 1.58-.879 2.121A3 3 0 0 1 12 15c-.828 0-1.58-.337-2.121-.879A3 3 0 0 1 9 12c0-.828.337-1.58.879-2.121" clip-rule="evenodd" opacity=".28"/>
