...
/**
 * Piplaylistsearchduostroke icon component for React Native
 ...
 */
const Piplaylistsearchduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "playlist search icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      d="M15.1071 19.2133L13.4393 17.5455M13.4393 17.5455C13.9212 17.0635 14.2193 16.3977 14.2193 15.6623C14.2193 14.1914 13.0269 12.999 11.5561 12.999C10.0852 12.999 8.89282 14.1914 8.89282 15.6623C8.89282 17.1331 10.0852 18.3255 11.5561 18.3255C12.2915 18.3255 12.9573 18.0274 13.4393 17.5455Z"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Piplaylistsearchduostroke;
