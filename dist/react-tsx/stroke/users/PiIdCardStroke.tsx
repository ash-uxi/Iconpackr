 ...
 */
interface PiIdCardStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiIdCardStroke({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M14 10H18M15 14H18" stroke="currentColor" strokeWidth="2" fill="none"/>
  ...
  <path d="M7 15H10C10.5523 15 11 14.5523 11 14V10C11 9.44772 10.5523 9 10 9H7C6.44772 9 6 9.44772 6 10L6 14C6 14.5523 6.44772 15 7 15Z" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
