...
export default function PiLockOpenDuoStroke({ 
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path  fillRule="evenodd" d="M10.07 14c0-1.034.796-2 1.93-2s1.928.966 1.928 2A2.04 2.04 0 0 1 13 15.714V17a1 1 0 1 1-2 0v-1.286A2.04 2.04 0 0 1 10.07 14" clipRule="evenodd" fill="none"/>
