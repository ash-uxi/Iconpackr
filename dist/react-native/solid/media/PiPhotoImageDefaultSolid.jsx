...
/**
 * Piphotoimagedefaultsolid icon component for React Native
 ...
 */
const Piphotoimagedefaultsolid = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "photo image default icon",
  style,
  ...props
}) => (
  <Svg
...
export default Piphotoimagedefaultsolid;
