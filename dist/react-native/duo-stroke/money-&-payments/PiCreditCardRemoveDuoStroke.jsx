...
/**
 * Picreditcardremoveduostroke icon component for React Native
 ...
 */
const Picreditcardremoveduostroke = ({
  color = "#000",
  size = 24,
...
export default Picreditcardremoveduostroke;
