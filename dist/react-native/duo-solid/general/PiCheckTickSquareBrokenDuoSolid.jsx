...
/**
 * Picheckticksquarebrokenduosolid icon component for React Native
 ...
 */
const Picheckticksquarebrokenduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="m21.035 5.403-.793.541a25.64 25.64 0 0 0-7.799 8.447l-.359.629L8.61 11" />
  </Svg>
);

export default Picheckticksquarebrokenduosolid;
