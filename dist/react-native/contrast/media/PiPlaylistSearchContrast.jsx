...
/**
 * Piplaylistsearchcontrast icon component for React Native
 ...
 */
const Piplaylistsearchcontrast = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="m15.107 19.213-1.668-1.668m0 0a2.663 2.663 0 1 0-3.767-3.766 2.663 2.663 0 0 0 3.767 3.767" />
    <path
      fill={color}
...
export default Piplaylistsearchcontrast;
