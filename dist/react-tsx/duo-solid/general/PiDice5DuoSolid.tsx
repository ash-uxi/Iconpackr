...
/**
 * PiDice5DuoSolid icon from the duo-solid style in general category.
 */
interface PiDice5DuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiDice5DuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'dice-5 icon',
  ...props
}: PiDice5DuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
