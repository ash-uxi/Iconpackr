<template>
  ...
  <path d="M7 12H14" :stroke="color || 'currentColor'" stroke-width="2" fill="none"/>
  <path d="M7 8H17" :stroke="color || 'currentColor'" stroke-width="2" fill="none"/>
  </svg>
</template>
 ...
 */
export default {
  name: 'PiMessageDefaultDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
