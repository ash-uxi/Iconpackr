...
/**
 * Pikeyboardwirelessduostroke icon component for React Native
 ...
 */
const Pikeyboardwirelessduostroke = ({
  color = "#000",
  size = 24,
...
export default Pikeyboardwirelessduostroke;
