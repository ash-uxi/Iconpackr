 ...
 */
interface PiFolderCheckDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderCheckDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-check icon',
  ...props
}: PiFolderCheckDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M9 13.6663L11.3412 16.005C12.4672 14.036 14.0256 12.3484 15.8987 11.0693" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
