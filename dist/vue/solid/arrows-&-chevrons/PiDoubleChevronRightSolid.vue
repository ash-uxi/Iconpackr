 ...
 */
export default {
  name: 'PiDoubleChevronRightSolid',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'double-chevron-right icon'
    }
  }
}
</script>
