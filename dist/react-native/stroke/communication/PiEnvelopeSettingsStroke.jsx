...
/**
 * Pienvelopesettingsstroke icon component for React Native
 ...
 */
const Pienvelopesettingsstroke = ({
  color = "#000",
  size = 24,
...
export default Pienvelopesettingsstroke;
