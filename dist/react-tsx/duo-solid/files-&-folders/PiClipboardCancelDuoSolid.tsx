...
/**
 * PiClipboardCancelDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiClipboardCancelDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardCancelDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'clipboard-cancel icon',
  ...props
}: PiClipboardCancelDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
