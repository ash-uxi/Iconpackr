...
/**
 * PiKanbanBoardDuoSolid icon from the duo-solid style in general category.
 */
interface PiKanbanBoardDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiKanbanBoardDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'kanban-board icon',
  ...props
}: PiKanbanBoardDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
