...
/**
 * PiSpeakerOffStroke icon from the stroke style in devices category.
 */
interface PiSpeakerOffStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSpeakerOffStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'speaker-off icon',
  ...props
}: PiSpeakerOffStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
