...
/**
 * PiMessageUserContrast icon from the contrast style in communication category.
 */
interface PiMessageUserContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageUserContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'message-user icon',
  ...props
}: PiMessageUserContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M13 7.697a1 1 0 1 1-2 0 1 1 0 0 1 2 0M13.25 11.126h-2.5c-.69 0-1.25.56-1.25 1.25 0 .345.28.625.625.625h3.75c.345 0 .625-.28.625-.625 0-.69-.56-1.25-1.25-1.25"/>
