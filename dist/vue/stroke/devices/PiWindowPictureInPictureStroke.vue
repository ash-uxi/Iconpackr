<template>
  ...
  <path d="M21 9.21634V7C21 5.34315 19.6569 4 18 4H6C4.34315 4 3 5.34315 3 7V17C3 18.6569 4.34315 20 6 20H8.22023" stroke="currentColor" stroke-width="2" fill="none"/>
  </svg>
</template>
 ...
 */
export default {
  name: 'PiWindowPictureInPictureStroke',
  props: {
    size: {
      type: Number,
      default: 24
