...
/**
 * Piclipboardarrowupstroke icon component for React Native
 ...
 */
const Piclipboardarrowupstroke = ({
  color = "#000",
  size = 24,
...
export default Piclipboardarrowupstroke;
