 ...
 */
interface PiHomeHLineDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiHomeHLineDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'home-h-line icon',
  ...props
}: PiHomeHLineDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
