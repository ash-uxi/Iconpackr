...
/**
 * Pinftplusduostroke icon component for React Native
...
const Pinftplusduostroke = ({
  ...
  >
    ...
    <path
      fillRule="evenodd"
      d="M17.989 15a1 1 0 0 1 1 1v2h2a1 1 0 0 1 0 2h-2v2a1 1 0 0 1-2 0v-2h-2a1 1 0 1 1 0-2h2v-2a1 1 0 0 1 1-1"
      clipRule="evenodd"
      fill="none"
    />
    <path
      d="M19.791 10h-.818c-.875 0-1.382 0-1.82.038-4.86.422-8.72 4.25-9.147 9.09-.015.17-.024.35-.03.558q.192.095.396.162c.173.057.375.096.675.12.25.02.545.027.924.03a9 9 0 0 1 .028-.695c.34-3.862 3.425-6.933 7.328-7.273.34-.03.754-.03 1.71-.03h1.462a3 3 0 0 0-.1-.72c-.089-.305-.255-.64-.608-1.28"
      fill="none"
    />
    <path
      fillRule="evenodd"
...
export default Pinftplusduostroke;
