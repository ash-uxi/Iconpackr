...
/**
 * Picalendarinformationstroke icon component for React Native
 ...
 */
const Picalendarinformationstroke = ({
  color = "#000",
  size = 24,
...
export default Picalendarinformationstroke;
