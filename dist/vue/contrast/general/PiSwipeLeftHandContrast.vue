<template>
  ...
  <path fill="currentColor" d="m8.763 20.205-5.788-5.207a.79.79 0 0 1 .004-1.18 3.16 3.16 0 0 1 3.884-.243l1.767 1.21-2.588-9.66A2 2 0 1 1 9.905 4.09l1.553 5.796 4.852-.47c3.558-.345 4.734 3.472 4.452 6.37-.496 5.103-8.24 7.801-12 4.419" opacity=".28"/>
  </svg>
</template>
