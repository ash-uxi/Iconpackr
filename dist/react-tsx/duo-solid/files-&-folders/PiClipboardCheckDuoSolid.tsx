...
/**
 * PiClipboardCheckDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiClipboardCheckDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardCheckDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'clipboard-check icon',
  ...props
}: PiClipboardCheckDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
