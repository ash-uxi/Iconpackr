...
/**
 * Pinotificationbellcancelstroke icon component for React Native
 ...
 */
const Pinotificationbellcancelstroke = ({
  color = "#000",
  size = 24,
...
export default Pinotificationbellcancelstroke;
