...
/**
 * Pipointercursordefaultduosolid icon component for React Native
 ...
 */
const Pipointercursordefaultduosolid = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M10.172 3.823c-2.793-.698-4.189-1.047-5.162-.666A3.27 3.27 0 0 0 3.157 5.01c-.381.973-.032 2.37.666 5.162" />{" "}
    <path
      fill={color || "#000"}
...
export default Pipointercursordefaultduosolid;
