 ...
 */
export default {
  name: 'PiWalletArrowRightDuoStroke',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'wallet-arrow-right icon'
    }
  }
}
</script>
