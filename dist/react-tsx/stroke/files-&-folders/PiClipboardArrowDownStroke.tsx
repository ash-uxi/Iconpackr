...
/**
 * PiClipboardArrowDownStroke icon from the stroke style in files-&-folders category.
 */
interface PiClipboardArrowDownStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardArrowDownStroke({
  size = 24,
  color,
  className,
