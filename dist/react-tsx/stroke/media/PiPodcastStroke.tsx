...
/**
 * PiPodcastStroke icon from the stroke style in media category.
 */
interface PiPodcastStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPodcastStroke({
  size = 24,
  color,
  className,
