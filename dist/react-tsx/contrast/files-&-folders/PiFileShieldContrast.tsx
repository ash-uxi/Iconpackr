...
/**
 * PiFileShieldContrast icon from the contrast style in files-&-folders category.
 */
interface PiFileShieldContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileShieldContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'file-shield icon',
  ...props
}: PiFileShieldContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
