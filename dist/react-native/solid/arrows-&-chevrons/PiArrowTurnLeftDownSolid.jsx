...
/**
 * Piarrowturnleftdownsolid icon component for React Native
 ...
 */
const Piarrowturnleftdownsolid = ({
  color = "#000",
  size = 24,
...
export default Piarrowturnleftdownsolid;
