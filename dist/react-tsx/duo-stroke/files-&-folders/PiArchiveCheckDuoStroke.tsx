 ...
 */
interface PiArchiveCheckDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiArchiveCheckDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'archive-check icon',
  ...props
}: PiArchiveCheckDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M8.55005 14.597L10.892 16.936C12.0179 14.967 13.5761 13.2793 15.449 12" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
