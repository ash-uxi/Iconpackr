...
/**
 * PiChatCancelDuoSolid icon from the duo-solid style in communication category.
 */
interface PiChatCancelDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiChatCancelDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'chat-cancel icon',
  ...props
}: PiChatCancelDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
