...
/**
 * Piwindowdockrightcontrast icon component for React Native
 ...
 */
const Piwindowdockrightcontrast = ({
  color = "#000",
  size = 24,
  ...
  <Svg
    ...
    {...props}
  >
    <path fill={color} d="M13 8h4v8h-4z" />
...
export default Piwindowdockrightcontrast;
