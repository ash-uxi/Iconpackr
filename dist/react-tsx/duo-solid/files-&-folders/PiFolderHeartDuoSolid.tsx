...
/**
 * PiFolderHeartDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiFolderHeartDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderHeartDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-heart icon',
  ...props
}: PiFolderHeartDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
