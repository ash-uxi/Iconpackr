...
/**
 * Pinotificationbellremovestroke icon component for React Native
 ...
 */
const Pinotificationbellremovestroke = ({
  color = "#000",
  size = 24,
...
export default Pinotificationbellremovestroke;
