...
/**
 * Pifoldercheckduosolid icon component for React Native
...
const Pifoldercheckduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="m9 13.666 2.341 2.339a15 15 0 0 1 4.558-4.936" />{" "}
    <path
      fill={color || "#000"}
...
export default Pifoldercheckduosolid;
