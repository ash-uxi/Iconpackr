...
/**
 * PiPhoneRemoveDuoStroke icon from the duo-stroke style in communication category.
 */
interface PiPhoneRemoveDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhoneRemoveDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'phone-remove icon',
  ...props
}: PiPhoneRemoveDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
