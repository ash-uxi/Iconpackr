...
/**
 * PiFolderArrowLeftContrast icon from the contrast style in files-&-folders category.
 */
interface PiFolderArrowLeftContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowLeftContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-left icon',
  ...props
}: PiFolderArrowLeftContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
