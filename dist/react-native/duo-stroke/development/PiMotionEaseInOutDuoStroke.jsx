...
/**
 * Pimotioneaseinoutduostroke icon component for React Native
 ...
 */
const Pimotioneaseinoutduostroke = ({
  color = "#000",
  size = 24,
...
export default Pimotioneaseinoutduostroke;
