...
/**
 * PiMonitor02DuoStroke icon from the duo-stroke style in devices category.
 */
interface PiMonitor02DuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMonitor02DuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'monitor-02 icon',
  ...props
}: PiMonitor02DuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
