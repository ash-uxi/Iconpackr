...
export default function PiArchiveCancelDuoStroke({
  ...
  <path d="M9.5249 16.95L11.9999 14.475M11.9999 14.475L14.4749 12M11.9999 14.475L9.5249 12M11.9999 14.475L14.4749 16.95" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
