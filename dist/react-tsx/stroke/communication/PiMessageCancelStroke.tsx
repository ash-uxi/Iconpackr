...
/**
 * PiMessageCancelStroke icon from the stroke style in communication category.
 */
interface PiMessageCancelStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageCancelStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'message-cancel icon',
  ...props
}: PiMessageCancelStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path d="M9.52513 12.4527L12 9.9778M12 9.9778L14.4749 7.50293M12 9.9778L9.52513 7.50293M12 9.9778L14.4749 12.4527" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
