...
/**
 * Pifileexclamationmarkstroke icon component for React Native
 ...
 */
const Pifileexclamationmarkstroke = ({
  color = "#000",
  size = 24,
...
export default Pifileexclamationmarkstroke;
