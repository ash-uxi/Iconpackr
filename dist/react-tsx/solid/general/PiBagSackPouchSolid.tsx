...
/**
 * PiBagSackPouchSolid icon from the solid style in general category.
 */
interface PiBagSackPouchSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBagSackPouchSolid({
  size = 24,
  color,
  className,
