 ...
 */
interface PiCubeDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCubeDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'cube icon',
  ...props
}: PiCubeDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
