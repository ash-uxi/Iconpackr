 ...
 */
interface PiStoreAltContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiStoreAltContrast({
  ...
  ...props
}: PiStoreAltContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
  ...
  <path fill="currentColor" d="M21.432 7.322c.117 1.172.338 2.343.338 3.523a3.256 3.256 0 1 1-6.512 0 3.256 3.256 0 1 1-6.512 0 3.256 3.256 0 1 1-6.512 0c0-1.18.217-2.351.334-3.523.124-1.243.135-2.629 1.117-3.53C4.682 2.873 6.077 3 7.344 3h9.312c1.268 0 2.662-.126 3.66.791.98.902.992 2.288 1.116 3.531" opacity=".28"/>
    </svg>
  );
}
