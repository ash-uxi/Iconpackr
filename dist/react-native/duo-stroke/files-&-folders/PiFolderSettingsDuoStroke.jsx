...
/**
 * Pifoldersettingsduostroke icon component for React Native
 ...
 */
const Pifoldersettingsduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "folder settings icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pifoldersettingsduostroke;
