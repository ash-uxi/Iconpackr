...
/**
 * PiPencilEditSwooshSolid icon from the solid style in general category.
 ...
 */
export default function PiPencilEditSwooshSolid({ 
  size = 24, 
  color,
  className,
