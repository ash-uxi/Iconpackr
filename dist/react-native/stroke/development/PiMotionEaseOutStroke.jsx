...
/**
 * Pimotioneaseoutstroke icon component for React Native
...
const Pimotioneaseoutstroke = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="M17 7C10 7 7 17 7 17" stroke={color} strokeWidth="2" fill="none" />
    <path
...
export default Pimotioneaseoutstroke;
