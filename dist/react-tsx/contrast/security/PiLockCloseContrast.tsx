...
/**
 * PiLockCloseContrast icon from the contrast style in security category.
 */
interface PiLockCloseContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiLockCloseContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'lock-close icon',
  ...props
}: PiLockCloseContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
