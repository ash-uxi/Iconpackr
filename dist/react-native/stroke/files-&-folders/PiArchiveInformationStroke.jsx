...
/**
 * Piarchiveinformationstroke icon component for React Native
 ...
 */
const Piarchiveinformationstroke = ({
  color = "#000",
  size = 24,
...
export default Piarchiveinformationstroke;
