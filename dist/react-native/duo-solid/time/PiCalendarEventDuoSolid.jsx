...
/**
 * Picalendareventduosolid icon component for React Native
...
const Picalendareventduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M20.96 10H3.04M8 2v4m8-4v4m-9 8h1v1H7z" />
  </Svg>
);

export default Picalendareventduosolid;
