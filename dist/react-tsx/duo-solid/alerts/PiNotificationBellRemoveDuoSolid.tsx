...
/**
 * PiNotificationBellRemoveDuoSolid icon from the duo-solid style in alerts category.
 */
interface PiNotificationBellRemoveDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiNotificationBellRemoveDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'notification-bell-remove icon',
  ...props
}: PiNotificationBellRemoveDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
