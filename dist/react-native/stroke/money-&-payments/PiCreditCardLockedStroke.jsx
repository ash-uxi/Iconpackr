...
/**
 * Picreditcardlockedstroke icon component for React Native
 ...
 */
const Picreditcardlockedstroke = ({
  color = "#000",
  size = 24,
...
export default Picreditcardlockedstroke;
