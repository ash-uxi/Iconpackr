...
export default function PiTimerRemoveStroke({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M9 14H15M12 2V6M12 6C7.58172 6 4 9.58172 4 14C4 18.4183 7.58172 22 12 22C16.4183 22 20 18.4183 20 14C20 9.58172 16.4183 6 12 6ZM10 2H14M19.3662 5.32178L20.4269 6.38244" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
