<template>
  ...
  <path fill="currentColor" d="M20 10.4v5.2c0 .996 0 1.771-.038 2.4h-1.19a3 3 0 0 0-4.613-1.412 13 13 0 0 0-2.43 2.338l-.001.001A3.32 3.32 0 0 0 11.154 22H10.4c-2.24 0-3.36 0-4.216-.436a4 4 0 0 1-1.748-1.748C4 18.96 4 17.84 4 15.6v-5.2c0-2.24 0-3.36.436-4.216a4 4 0 0 1 1.748-1.748c.475-.242 1.032-.35 1.816-.398 0 .44.001.665.051.85a1.5 1.5 0 0 0 1.06 1.06C9.304 6 9.536 6 10 6h4c.465 0 .697 0 .888-.051a1.5 1.5 0 0 0 1.06-1.06c.05-.186.052-.411.052-.85.784.047 1.34.155 1.816.397a4 4 0 0 1 1.748 1.748C20 7.04 20 8.16 20 10.4" opacity=".28"/>
  </svg>
</template>
 ...
 */
export default {
  name: 'PiClipboardArrowDownLeftContrast',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'clipboard-arrow-down-left icon'
    }
  }
}
</script>
