...
/**
 * Piplaylistuploadduostroke icon component for React Native
 ...
 */
const Piplaylistuploadduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "playlist upload icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      d="M15 15.8115C14.2598 14.8245 13.401 13.9331 12.4436 13.1573C12.3141 13.0524 12.157 12.9999 12 12.9999M9 15.8115C9.74024 14.8245 10.599 13.9331 11.5564 13.1573C11.6859 13.0524 11.843 12.9999 12 12.9999M12 12.9999V19.0195"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Piplaylistuploadduostroke;
