...
/**
 * Pinotificationbelladdsolid icon component for React Native
 ...
 */
const Pinotificationbelladdsolid = ({
  color = "#000",
  size = 24,
...
export default Pinotificationbelladdsolid;
