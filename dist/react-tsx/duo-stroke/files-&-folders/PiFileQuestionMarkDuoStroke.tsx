 ...
 */
interface PiFileQuestionMarkDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileQuestionMarkDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'file-question-mark icon',
  ...props
}: PiFileQuestionMarkDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
