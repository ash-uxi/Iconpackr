...
/**
 * Pibatterythreecellduosolid icon component for React Native
 ...
 */
const Pibatterythreecellduosolid = ({
  color = "#000",
  size = 24,
...
export default Pibatterythreecellduosolid;
