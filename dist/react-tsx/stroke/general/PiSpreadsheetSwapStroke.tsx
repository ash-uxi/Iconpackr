...
/**
 * PiSpreadsheetSwapStroke icon from the stroke style in general category.
 */
interface PiSpreadsheetSwapStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSpreadsheetSwapStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'spreadsheet-swap icon',
  ...props
}: PiSpreadsheetSwapStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
