...
export default function PiWashingMachineDuoStroke({
  ...
  <path d="M7 5H9M14 5H14.01M17 5H17.01M16 15C16 17.2091 14.2091 19 12 19C9.79086 19 8 17.2091 8 15C8 12.7909 9.79086 11 12 11C14.2091 11 16 12.7909 16 15Z" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
