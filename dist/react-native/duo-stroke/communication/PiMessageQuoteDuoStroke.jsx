...
/**
 * Pimessagequoteduostroke icon component for React Native
 ...
 */
const Pimessagequoteduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "message quote icon",
  style,
  ...props
}) => (
  <Svg
  ...
  >
    <path
      d="M14.5 10.5H16C16.5523 10.5 17 10.9477 17 11.5C17 12.0523 16.5523 12.5 16 12.5H15.5C14.6716 12.5 14 11.8284 14 11V9.9C14 8.57452 15.0745 7.5 16.4 7.5"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
    ...
    />
    <path
      d="M7.5 10.5H9C9.55228 10.5 10 10.9477 10 11.5C10 12.0523 9.55228 12.5 9 12.5H8.5C7.67157 12.5 7 11.8284 7 11V9.9C7 8.57452 8.07452 7.5 9.4 7.5"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pimessagequoteduostroke;
