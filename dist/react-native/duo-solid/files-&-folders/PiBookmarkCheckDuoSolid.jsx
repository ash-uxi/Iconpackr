...
/**
 * Pibookmarkcheckduosolid icon component for React Native
...
const Pibookmarkcheckduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="m9 10.259 2.036 2.034A13 13 0 0 1 15 8" />
  </Svg>
);

export default Pibookmarkcheckduosolid;
