...
/**
 * Piearthglobetimezonestroke icon component for React Native
 ...
 */
const Piearthglobetimezonestroke = ({
  color = "#000",
  size = 24,
...
export default Piearthglobetimezonestroke;
