...
/**
 * Piannotationcancelduosolid icon component for React Native
 ...
 */
const Piannotationcancelduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M9.5 13.5 12 11m0 0 2.5-2.5M12 11 9.5 8.5M12 11l2.5 2.5" />
  </Svg>
);

export default Piannotationcancelduosolid;
