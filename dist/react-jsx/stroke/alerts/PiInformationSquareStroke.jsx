...
export default function PiInformationSquareStroke({ 
  ...
  <path d="M8.78149 9.71853C8.78149 8.21713 9.99862 7 11.5 7C13.0014 7 14.2186 8.21713 14.2186 9.71853C14.2186 10.6748 13.7248 11.5157 12.9784 12.0003C12.2544 12.4704 11.5 13.1368 11.5 14M11.5 17H11.501" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
