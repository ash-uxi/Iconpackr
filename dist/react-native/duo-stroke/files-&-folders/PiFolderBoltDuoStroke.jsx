...
/**
 * Pifolderboltduostroke icon component for React Native
...
const Pifolderboltduostroke = ({
  ...
  >
    <path
      d="M12.0001 10L10.1981 12.4026C9.824 12.9014 9.63696 13.1508 9.65006 13.3368C9.66142 13.4981 9.75008 13.6439 9.88804 13.7282C10.0471 13.8255 10.3546 13.7742 10.9696 13.6717L13.0305 13.3283C13.6455 13.2258 13.953 13.1745 14.1121 13.2718C14.25 13.3561 14.3387 13.5019 14.35 13.6632C14.3632 13.8492 14.1761 14.0986 13.802 14.5974L12.0001 17"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pifolderboltduostroke;
