...
/**
 * Pigitpullrequestdraftstroke icon component for React Native
 ...
 */
const Pigitpullrequestdraftstroke = ({
  color = "#000",
  size = 24,
...
export default Pigitpullrequestdraftstroke;
