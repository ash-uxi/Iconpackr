...
/**
 * Pinotificationbelladdduosolid icon component for React Native
 ...
 */
const Pinotificationbelladdduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    ...
    />{" "}
    <path
      d="M13 8C13 7.44772 12.5523 7 12 7C11.4477 7 11 7.44772 11 8V10H9C8.44772 10 8 10.4477 8 11C8 11.5523 8.44772 12 9 12L11 12V14C11 14.5523 11.4477 15 12 15C12.5523 15 13 14.5523 13 14V12H15C15.5523 12 16 11.5523 16 11C16 10.4477 15.5523 10 15 10H13V8Z"
      fill={color || "#000"}
    />{" "}
    <path
...
export default Pinotificationbelladdduosolid;
