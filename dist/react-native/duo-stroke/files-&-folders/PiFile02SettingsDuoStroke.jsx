...
/**
 * Pifile02settingsduostroke icon component for React Native
 ...
 */
const Pifile02settingsduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      d="M11.3438 22H8C5.79086 22 4 20.2091 4 18V6C4 3.79086 5.79086 2 8 2H11"
      stroke={color || "#000"}
      strokeWidth="2"
      opacity={0.28}
      fill="none"
...
export default Pifile02settingsduostroke;
