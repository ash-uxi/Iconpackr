 ...
 */
interface PiExternalLinkCircleStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiExternalLinkCircleStroke({
  ...
  ...props
}: PiExternalLinkCircleStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
