...
/**
 * PiWalletRefreshDuoStroke icon from the duo-stroke style in web3-&-crypto category.
 */
interface PiWalletRefreshDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletRefreshDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'wallet-refresh icon',
  ...props
}: PiWalletRefreshDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
