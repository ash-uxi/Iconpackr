...
/**
 * Picalendardefaultduosolid icon component for React Native
 ...
 */
const Picalendardefaultduosolid = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M20.96 10H3.04M8 2v4m8-4v4" />
  </Svg>
);

export default Picalendardefaultduosolid;
