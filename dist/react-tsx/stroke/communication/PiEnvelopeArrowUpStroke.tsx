 ...
 */
interface PiEnvelopeArrowUpStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiEnvelopeArrowUpStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'envelope-arrow-up icon',
  ...props
}: PiEnvelopeArrowUpStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
