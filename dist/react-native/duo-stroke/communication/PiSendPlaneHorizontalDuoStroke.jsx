...
/**
 * Pisendplanehorizontalduostroke icon component for React Native
 ...
 */
const Pisendplanehorizontalduostroke = ({
  color = "#000",
  size = 24,
  ...
  >
    <path
      d="M4.93359 12H9.83485M12.9999 17.9747C14.8525 17.0663 16.6538 16.051 18.3947 14.9332C19.5259 14.2069 20.9999 13.5581 20.9999 11.9998C20.9999 10.4415 19.5259 9.79274 18.3947 9.06644C16.6538 7.9486 14.8525 6.93331 12.9999 6.0249"
      stroke={color || "#000"}
      strokeWidth="2"
      fill="none"
    />
...
export default Pisendplanehorizontalduostroke;
