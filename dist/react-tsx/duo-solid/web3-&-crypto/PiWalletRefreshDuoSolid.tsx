...
/**
 * PiWalletRefreshDuoSolid icon from the duo-solid style in web3-&-crypto category.
 */
interface PiWalletRefreshDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletRefreshDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'wallet-refresh icon',
  ...props
}: PiWalletRefreshDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
