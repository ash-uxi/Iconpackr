 ...
 */
interface PiCalendarCheckDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarCheckDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'calendar-check icon',
  ...props
}: PiCalendarCheckDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M16 2V6M8 2V6M8.75 13.922L10.924 16.0937C11.99 14.2295 13.4794 12.6553 15.25 11.4463" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
