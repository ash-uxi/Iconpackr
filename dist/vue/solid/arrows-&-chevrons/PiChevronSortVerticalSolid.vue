 ...
 */
export default {
  name: 'PiChevronSortVerticalSolid',
  props: {
    size: {
      type: Number,
      default: 24
    ...
    ariaLabel: {
      type: String,
      default: 'chevron-sort-vertical icon'
    }
  }
}
</script>
