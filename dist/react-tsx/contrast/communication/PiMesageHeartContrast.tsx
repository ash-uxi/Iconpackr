...
/**
 * PiMesageHeartContrast icon from the contrast style in communication category.
 */
interface PiMesageHeartContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMesageHeartContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'mesage-heart icon',
  ...props
}: PiMesageHeartContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12 13.563c.35 0 3.5-1.702 3.5-4.084 0-1.19-1.05-2.027-2.1-2.041-.525-.008-1.05.17-1.4.68-.35-.51-.884-.68-1.4-.68-1.05 0-2.1.85-2.1 2.041 0 2.382 3.15 4.084 3.5 4.084"/>
