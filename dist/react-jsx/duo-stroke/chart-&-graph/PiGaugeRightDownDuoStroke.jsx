...
export default function PiGaugeRightDownDuoStroke({ 
  ...
  <path d="M15.5353 15.5362L11.4273 12.7331C10.9413 12.4015 10.8766 11.7097 11.2926 11.2936C11.7087 10.8776 12.4005 10.9423 12.7322 11.4283L15.5353 15.5362Z" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
    </svg>
  );
}
