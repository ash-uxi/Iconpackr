...
/**
 * PiFolderHeartContrast icon from the contrast style in files-&-folders category.
 */
interface PiFolderHeartContrastProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderHeartContrast({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-heart icon',
  ...props
}: PiFolderHeartContrastProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12 16.625c.35 0 3.5-1.701 3.5-4.083 0-1.191-1.05-2.027-2.1-2.042-.525-.007-1.05.17-1.4.68-.35-.51-.884-.68-1.4-.68-1.05 0-2.1.85-2.1 2.042 0 2.382 3.15 4.083 3.5 4.083"/>
