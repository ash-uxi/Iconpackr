...
/**
 * PiBookmarkAddDuoSolid icon from the duo-solid style in files-&-folders category.
 */
interface PiBookmarkAddDuoSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBookmarkAddDuoSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'bookmark-add icon',
  ...props
}: PiBookmarkAddDuoSolidProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
