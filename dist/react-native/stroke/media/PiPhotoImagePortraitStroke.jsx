...
/**
 * Piphotoimageportraitstroke icon component for React Native
 ...
 */
const Piphotoimageportraitstroke = ({
  color = "#000",
  size = 24,
...
export default Piphotoimageportraitstroke;
