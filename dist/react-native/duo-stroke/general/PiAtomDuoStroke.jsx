...
/**
 * Piatomduostroke icon component for React Native
 ...
 */
const Piatomduostroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "atom icon",
  style,
  ...props
}) => (
  <Svg
...
export default Piatomduostroke;
