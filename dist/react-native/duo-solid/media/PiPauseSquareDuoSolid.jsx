...
/**
 * Pipausesquareduosolid icon component for React Native
...
const Pipausesquareduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M9.417 8.9v6.2m5.166-6.2v6.2" />
  </Svg>
);

export default Pipausesquareduosolid;
