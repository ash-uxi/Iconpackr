...
/**
 * PiFolderArrowLeftStroke icon from the stroke style in files-&-folders category.
 */
interface PiFolderArrowLeftStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowLeftStroke({
  size = 24,
  color,
  className,
