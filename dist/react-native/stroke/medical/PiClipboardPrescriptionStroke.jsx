...
/**
 * Piclipboardprescriptionstroke icon component for React Native
 ...
 */
const Piclipboardprescriptionstroke = ({
  color = "#000",
  size = 24,
...
export default Piclipboardprescriptionstroke;
