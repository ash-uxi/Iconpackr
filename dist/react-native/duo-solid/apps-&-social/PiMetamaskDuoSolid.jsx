...
/**
 * Pimetamaskduosolid icon component for React Native
...
const Pimetamaskduosolid = ({
  ...
  >
    <path
      ...
      opacity={0.28}
    />{" "}
    <path d="M9.5 12c0 .545-.455 1-1 1s-1-.455-1-1 .455-1 1-1 1 .455 1 1m7 0c0 .545-.455 1-1 1s-1-.455-1-1 .455-1 1-1 1 .455 1 1" />
  </Svg>
);

export default Pimetamaskduosolid;
