 ...
 */
interface PiIdCardHorizontalDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiIdCardHorizontalDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'id-card-horizontal icon',
  ...props
}: PiIdCardHorizontalDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
