...
/**
 * PiCalendarRemoveSolid icon from the solid style in time category.
 */
interface PiCalendarRemoveSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarRemoveSolid({
  size = 24,
  color,
  className,
