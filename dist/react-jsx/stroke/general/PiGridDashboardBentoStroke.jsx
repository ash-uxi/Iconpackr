...
/**
 * PiGridDashboardBentoStroke icon from the stroke style in general category.
 ...
 */
export default function PiGridDashboardBentoStroke({ 
  size = 24, 
  color,
  className,
