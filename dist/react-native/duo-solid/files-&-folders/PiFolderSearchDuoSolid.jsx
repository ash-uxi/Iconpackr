...
/**
 * Pifoldersearchduosolid icon component for React Native
...
const Pifoldersearchduosolid = ({
  ...
  <Svg
    ...
    {...props}
  >
    <path d="m15.5 16.5-1.379-1.379m0 0A2.998 2.998 0 0 0 12 10c-1.659 0-3 1.341-3 3a2.998 2.998 0 0 0 5.121 2.121" />{" "}
    <path
      fill={color || "#000"}
...
export default Pifoldersearchduosolid;
