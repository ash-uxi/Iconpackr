...
/**
 * PiCalendarOffStroke icon from the stroke style in time category.
 */
interface PiCalendarOffStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarOffStroke({
  size = 24,
  color,
  className,
