...
/**
 * Pifolderarrowdownstroke icon component for React Native
 ...
 */
const Pifolderarrowdownstroke = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "folder arrow down icon",
  style,
  ...props
}) => (
  <Svg
...
export default Pifolderarrowdownstroke;
