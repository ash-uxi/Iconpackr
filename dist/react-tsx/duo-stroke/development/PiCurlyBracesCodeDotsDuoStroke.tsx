 ...
 */
interface PiCurlyBracesCodeDotsDuoStrokeProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCurlyBracesCodeDotsDuoStroke({
  size = 24,
  color,
  className,
  ariaLabel = 'curly-braces-code-dots icon',
  ...props
}: PiCurlyBracesCodeDotsDuoStrokeProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12.001 12H12M15.001 12H15M9.001 12H9" stroke={color || "currentColor"} strokeWidth="2" fill="none"/>
