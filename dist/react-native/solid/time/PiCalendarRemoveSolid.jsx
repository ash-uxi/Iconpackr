...
/**
 * Picalendarremovesolid icon component for React Native
 ...
 */
const Picalendarremovesolid = ({
  color = "#000",
  size = 24,
  accessibilityLabel = "calendar remove icon",
  style,
  ...props
}) => (
  <Svg
...
export default Picalendarremovesolid;
